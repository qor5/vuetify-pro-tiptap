import { VCard as mr, VCardText as mi, VToolbar as gr, VDivider as gi, VSpacer as yi, VThemeProvider as Tf, VInput as m1, VCardTitle as g1, VBtn as yr, VIcon as un, VTooltip as Mf, VMenu as ts, VList as wa, VSheet as y1, VTextField as ka, VListItem as Ef, VListItemTitle as Lf, VForm as ns, VFileInput as b1, VCheckbox as rs, VDialog as xa, VTabs as v1, VTab as w1, VWindow as k1, VWindowItem as x1, VCardActions as Sa, VCardSubtitle as S1 } from "vuetify/components";
import { defineComponent as te, markRaw as Of, h as zn, ref as Y, getCurrentInstance as is, watchEffect as $n, nextTick as Hf, unref as T, onBeforeUnmount as Ca, customRef as C1, provide as Zi, reactive as Jr, render as Vc, computed as W, watch as _t, inject as A1, getCurrentScope as T1, onScopeDispose as M1, onMounted as Aa, withDirectives as Rf, createBlock as F, openBlock as R, withCtx as E, createVNode as H, createElementBlock as de, Fragment as Le, renderList as Ze, resolveDynamicComponent as Xr, mergeProps as er, createSlots as Ta, vShow as Vf, createCommentVNode as $e, useAttrs as E1, onUnmounted as L1, normalizeClass as dt, renderSlot as ut, createTextVNode as Dt, toDisplayString as Ae, normalizeProps as Nc, guardReactiveProps as Ic, normalizeStyle as tr, createElementVNode as De, resolveComponent as Nf, withModifiers as If } from "vue";
...
function _f(t, e, n) {
  for (let r = 0; ; r++) {
    ...
    if (i.isText && i.text != o.text) {
      ...
      for (; s[a] == l[a]; a++)
        n++;
      return a && a < s.length && a < l.length && zf(s.charCodeAt(a - 1)) && Pf(s.charCodeAt(a)) && n--, n;
    }
    if (i.content.size || o.content.size) {
      let s = _f(i.content, o.content, n + 1);
      if (s != null)
        return s;
    }
    n += i.nodeSize;
  ...
  for (let i = t.childCount, o = e.childCount; ; ) {
    ...
    if (s.isText && s.text != l.text) {
      ...
      for (; d > 0 && f > 0 && c[d - 1] == u[f - 1]; )
        d--, f--, n--, r--;
      return d && f && d < c.length && zf(c.charCodeAt(d - 1)) && Pf(c.charCodeAt(d)) && (n++, r++), { a: n, b: r };
    }
    if (s.content.size || l.content.size) {
      let c = Df(s.content, l.content, n - 1, r - 1);
      if (c)
        return c;
    }
    n -= a, r -= a;
...
class L {
  ...
  */
  insertAt(e, n) {
    let r = Bf(this.content, e + this.openStart, n, this.openStart + 1, this.openEnd + 1);
  ...
  */
  removeBetween(e, n) {
    return new L($f(this.content, e + this.openStart, n + this.openStart), this.openStart, this.openEnd);
  }
  /**
  ...
  */
  static fromJSON(e, n) {
    ...
    return new L(A.fromJSON(e, n.content), r, i);
  }
  /**
...
function $f(t, e, n) {
  ...
  if (r != s)
    throw new RangeError("Removing non-flat range");
  return t.replaceChild(r, o.copy($f(o.content, e - i - 1, n - i - 1)));
}
function Bf(t, e, n, r, i, o) {
  ...
  let c = Bf(a.content, e - l - 1, n, s == 0 ? r - 1 : 0, s == t.childCount - 1 ? i - 1 : 0, a);
...
function Ff(t, e, n, r) {
  ...
  if (i == e.index(r) && r < t.depth - n.openStart) {
    ...
    if (!n.openStart && !n.openEnd && t.depth == r && e.depth == r) {
      ...
      let { start: s, end: l } = H1(n, t);
      return Tn(o, Wf(t, s, l, e, r));
    }
...
function Wf(t, e, n, r, i) {
  ...
  return Rr(null, t, i, l), o && s && e.index(i) == n.index(i) ? (Uf(o, s), An(Tn(o, Wf(t, e, n, r, i + 1)), l)) : (o && An(Tn(o, lo(t, e, i + 1)), l), Rr(e, n, i, l), s && An(Tn(s, lo(n, r, i + 1)), l)), Rr(r, null, i, l), new A(l);
}
function lo(t, e, n) {
  let r = [];
...
const V1 = 12, _c = /* @__PURE__ */ new WeakMap();
class ao {
  /**
...
let tn = class Sl {
  ...
  */
  hasMarkup(e, n, r) {
    return this.type == e && so(this.attrs, n || e.defaultAttrs || N1) && ie.sameSet(this.marks, r || ie.none);
  }
  /**
  ...
  */
  replace(e, n, r) {
    return O1(this.resolve(e), this.resolve(n), r);
  }
  /**
...
function $1(t) {
  if (t.eat("(")) {
    ...
    let e = z1(t, t.next).map((n) => (t.inline == null ? t.inline = n.isInline : t.inline != n.isInline && t.err("Mixing inline and block content"), { type: "name", value: n }));
...
let zc = class Yf {
  ...
  */
  constructor(e, n, r) {
    this.name = e, this.schema = n, this.spec = r, this.markSet = null, this.groups = r.group ? r.group.split(" ") : [], this.attrs = Zf(e, r.attrs), this.defaultAttrs = Gf(this.attrs), this.contentMatch = null, this.inlineContent = null, this.isBlock = !(r.inline || e == "text"), this.isText = e == "text";
  }
  /**
  ...
  */
  static compile(e, n) {
    ...
    e.forEach((o, s) => r[o] = new Yf(o, n, s));
...
class j1 {
  constructor(e, n, r) {
    this.hasDefault = Object.prototype.hasOwnProperty.call(r, "default"), this.default = r.default, this.validate = typeof r.validate == "string" ? W1(e, n, r.validate) : r.validate;
  }
  get isRequired() {
...
class ss {
  ...
  */
  constructor(e, n, r, i) {
    this.name = e, this.rank = n, this.schema = r, this.spec = i, this.attrs = Zf(e, i.attrs), this.excluded = null;
    let o = Gf(this.attrs);
  ...
  */
  create(e = null) {
    return !e && this.instance ? this.instance : new ie(this, Jf(this.attrs, e));
  }
  /**
  @internal
  */
...
class nn {
  ...
  */
  parseSlice(e, n = {}) {
    ...
    return r.addAll(e, ie.none, n.from, n.to), L.maxOpen(r.finish());
  }
  /**
  @internal
  */
  matchTag(e, n, r) {
    for (let i = r ? this.tags.indexOf(r) + 1 : 0; i < this.tags.length; i++) {
      let o = this.tags[i];
      if (X1(e, o.tag) && (o.namespace === void 0 || e.namespaceURI == o.namespace) && (!o.context || n.matchesContext(o.context))) {
        if (o.getAttrs) {
          let s = o.getAttrs(e);
          if (s === !1)
            continue;
...
class Mi {
  ...
  inlineContext(e) {
    return this.type ? this.type.inlineContent : this.content.length ? this.content[0].isInline : e.parentNode && !eh.hasOwnProperty(e.parentNode.nodeName.toLowerCase());
  }
}
class Fc {
  constructor(e, n, r) {
...
`);
  ...
  addElement(e, n, r) {
    ...
    th.hasOwnProperty(s) && this.parser.normalizeLists && J1(e);
    let a = this.options.ruleFromNode && this.options.ruleFromNode(e) || (l = this.parser.matchTag(e, this, r));
    e: if (a ? a.ignore : G1.hasOwnProperty(s))
      this.findInside(e), this.ignoreFallback(e, n);
    else if (!a || a.skip || a.closeParent) {
      a && a.closeParent ? this.open = Math.max(0, this.open - 1) : a && a.skip.nodeType && (e = a.skip);
      let c, u = this.needsBlock;
      if (eh.hasOwnProperty(s))
...
function Z1(t) {
  let e = Kc.get(t);
  return e === void 0 && Kc.set(t, e = Y1(t)), e;
}
function Y1(t) {
  let e = null;
  function n(r) {
...
const nh = 65535, rh = Math.pow(2, 16);
function Q1(t, e) {
  return t + e * rh;
}
function qc(t) {
  ...
  _map(e, n, r) {
    ...
    for (let l = 0; l < this.ranges.length; l += 3) {
      ...
      if (e <= d) {
        ...
        if (r)
          return h;
        let p = e == (n < 0 ? a : d) ? null : Q1(l / 3, e - a), m = e == a ? oh : e == d ? ih : Qi;
        return (n < 0 ? e != a : e != d) && (m |= sh), new Al(h, m, p);
      }
      i += u - c;
    }
...
class Qt extends Re {
  ...
  */
  ...
  apply(e) {
    let n = e.slice(this.from, this.to), r = e.resolve(this.from), i = r.node(r.sharedDepth(this.to)), o = new L(Ea(n.content, (s, l) => !s.isAtom || !l.type.allowsMarkType(this.mark.type) ? s : s.mark(this.mark.addToSet(s.marks)), i), n.openStart, n.openEnd);
...
class Qe extends Re {
  ...
  */
  ...
  apply(e) {
    let n = e.slice(this.from, this.to), r = new L(Ea(n.content, (i) => i.mark(this.mark.removeFromSet(i.marks)), e), n.openStart, n.openEnd);
...
class en extends Re {
  ...
  */
  ...
  apply(e) {
    ...
    return ge.fromReplace(e, this.pos, this.pos + 1, new L(A.from(r), 0, n.isLeaf ? 0 : 1));
  }
  invert(e) {
    let n = e.nodeAt(this.pos);
    if (n) {
...
class me extends Re {
  ...
  */
  static fromJSON(e, n) {
    ...
    return new me(n.from, n.to, L.fromJSON(e, n.slice), !!n.structure);
  }
}
me.MAP_BIAS = 1;
...
class we extends Re {
  ...
  */
  static fromJSON(e, n) {
    ...
    return new we(n.from, n.to, n.gapFrom, n.gapTo, L.fromJSON(e, n.slice), n.insert, !!n.structure);
  }
}
  ...
  t.doc.nodesBetween(e, n, (a, c, u) => {
    ...
    if (!r.isInSet(d) && u.type.allowsMarkType(r.type)) {
      ...
      for (let m = 0; m < d.length; m++)
        d[m].isInSet(p) || (s && s.to == f && s.mark.eq(d[m]) ? s.to = h : i.push(s = new Qe(f, h, d[m])));
  ...
  for (let a = 0; a < o.childCount; a++) {
    ...
    if (!d)
      ...
      if (i && c.isText && n.whitespace != "pre") {
        let f, h = /\r?\n|\r/g, p;
        for (; f = h.exec(c.text); )
          p || (p = new L(A.from(n.schema.text(" ", n.allowedMarks(c.marks))), 0, 0)), s.push(new me(l + f.index, l + f.index + f[0].length, p));
      }
    }
    l = u;
  }
...
function br(t) {
  ...
  for (let r = t.depth, i = 0, o = 0; ; --r) {
    ...
    if (r < t.depth && s.canReplace(l, a, n))
      return r;
    if (r == 0 || s.type.spec.isolating || !ry(s, l, a))
      break;
...
function iy(t, e, n) {
  let { $from: r, $to: i, depth: o } = e, s = r.before(o + 1), l = i.after(o + 1), a = s, c = l, u = A.empty, d = 0;
  ...
  t.step(new we(a, c, s, l, new L(u.append(f), d, h), u.size - d, !0));
}
function Oa(t, e, n = null, r = t) {
  let i = oy(t, e), o = i && sy(r, e);
...
function ly(t, e, n) {
  ...
  t.step(new we(i, o, i, o, new L(r, 0, 0), n.length, !0));
}
function ay(t, e, n, r, i) {
  ...
  t.doc.nodesBetween(e, n, (s, l) => {
    ...
    if (s.isTextblock && !s.hasMarkup(r, a) && cy(t.doc, t.mapping.slice(o).map(l), r)) {
      let c = null;
      if (r.schema.linebreakReplacement) {
        let h = r.whitespace == "pre", p = !!r.contentMatch.matchType(r.schema.linebreakReplacement);
        h && !p ? c = !1 : !h && p && (c = !0);
      }
      c === !1 && ah(t, s, l, o), La(t, t.mapping.slice(o).map(l, 1), r, void 0, c === null);
      let u = t.mapping.slice(o), d = u.map(l, 1), f = u.map(l + s.nodeSize, 1);
      return t.step(new we(d, f, d + 1, f - 1, new L(A.from(r.create(a, null, s.marks)), 0, 0), 1, !0)), c === !0 && lh(t, s, l, o), !1;
    }
  });
}
function lh(t, e, n, r) {
...
function dy(t, e, n, r, i) {
  ...
  t.step(new we(e, e + o.nodeSize, e + 1, e + o.nodeSize - 1, new L(A.from(s), 0, 0), 1, !0));
}
...
function uy(t, e, n = 1, r) {
  ...
  t.step(new me(e, e, new L(o.append(s), n, n), !0));
}
function hn(t, e) {
...
function ch(t, e) {
  return !!(t && e && !t.isLeaf && fy(t, e));
}
function ls(t, e, n = -1) {
  let r = t.resolve(e);
  for (let i = r.depth; ; i--) {
    let o, s, l = r.index(i);
    if (i == r.depth ? (o = r.nodeBefore, s = r.nodeAfter) : n > 0 ? (o = r.node(i + 1), l++, s = r.node(i).maybeChild(l)) : (o = r.node(i).maybeChild(l - 1), s = r.node(i + 1)), o && !o.isTextblock && ch(o, s) && r.node(i).canReplace(l, l + 1))
      return e;
    if (i == 0)
      break;
...
function as(t, e, n = e, r = L.empty) {
  if (e == n && !r.size)
    return null;
  let i = t.resolve(e), o = t.resolve(n);
  return uh(i, o, r) ? new me(e, n, r) : new my(i, o, r).fit();
}
function uh(t, e, n) {
...
class my {
    ...
    for (let n = 1; n <= 2; n++)
      for (let r = n == 1 ? e : this.unplaced.openStart; r >= 0; r--) {
        ...
        for (let l = this.depth; l >= 0; l--) {
          ...
          if (n == 1 && (s ? c.matchType(s.type) || (d = c.fillBefore(A.from(s), !1)) : o && a.compatibleContent(o.type)))
  ...
  dropNode() {
    ...
    if (i.childCount <= 1 && n > 0) {
      ...
      this.unplaced = new L(Mr(e, n - 1, 1), n - 1, o ? n - 1 : r);
    } else
      this.unplaced = new L(Mr(e, n, 1), n, r);
  }
  ...
  placeNodes({ sliceDepth: e, frontierDepth: n, parent: r, inject: i, wrap: o }) {
    ...
    for (; c < l.childCount; ) {
      ...
      if (!g)
        break;
      c++, (c > 1 || a == 0 || m.content.size) && (d = g, u.push(fh(m.mark(f.allowedMarks(m.marks)), c == 1 ? a : 0, c == l.childCount ? h : -1)));
    }
    let p = c == l.childCount;
    p || (h = -1), this.placed = Er(this.placed, n, A.from(u)), this.frontier[n].match = d, p && h < 0 && r && r.type == this.frontier[this.depth].type && this.frontier.length > 1 && this.closeFrontierNode();
    for (let m = 0, g = l; m < h; m++) {
      let y = g.lastChild;
      this.frontier.push({ type: y.type, match: y.contentMatchAt(y.childCount) }), g = y.content;
    }
    this.unplaced = p ? e == 0 ? L.empty : new L(Mr(s.content, e - 1, 1), e - 1, h < 0 ? s.openEnd : e - 1) : new L(Mr(s.content, e, c), s.openStart, s.openEnd);
  }
  mustMoveInline() {
  ...
  findCloseLevel(e) {
    e: for (let n = Math.min(this.depth, e.depth); n >= 0; n--) {
      ...
      if (s) {
        for (let l = n - 1; l >= 0; l--) {
          let { match: a, type: c } = this.frontier[l], u = Ps(e, l, c, a, !0);
          if (!u || u.childCount)
            continue e;
        }
...
function fh(t, e, n) {
  if (e <= 0)
    return t;
  let r = t.content;
  return e > 1 && (r = r.replaceChild(0, fh(r.firstChild, e - 1, r.childCount == 1 ? n - 1 : 0))), e > 0 && (r = t.type.contentMatch.fillBefore(r).append(r), n <= 0 && (r = r.append(t.type.contentMatch.matchFragment(r).fillBefore(A.empty, !0)))), t.copy(r);
}
function Ps(t, e, n, r, i) {
  ...
  return l && !gy(n, o.content, s) ? l : null;
}
function gy(t, e, n) {
    ...
    if (p)
      for (let m = 0; m < s.length; m++) {
        ...
        if (b.canReplaceWith(v, v, p.type, p.marks))
          return t.replace(i.before(g), y ? o.after(g) : n, new L(hh(r.content, 0, r.openStart, h), h, r.openEnd));
      }
  }
...
function hh(t, e, n, r, i) {
  if (e < n) {
    let o = t.firstChild;
    t = t.replaceChild(0, o.copy(hh(o.content, e + 1, n, r, o)));
  }
  if (e > r) {
...
function vy(t, e, n, r) {
  if (!r.isInline && e == n && t.doc.resolve(e).parent.content.size) {
    let i = py(t.doc, e, r.type);
    i != null && (e = n = i);
  }
  t.replaceRange(e, n, new L(A.from(r), 0, 0));
}
function wy(t, e, n) {
...
class nr extends Re {
  ...
  */
  ...
  apply(e) {
    ...
    return ge.fromReplace(e, this.pos, this.pos + 1, new L(A.from(i), 0, n.isLeaf ? 0 : 1));
  }
  getMap() {
    return Be.empty;
  }
...
class Ha {
  ...
  */
  replaceWith(e, n, r) {
    return this.replace(e, n, new L(A.from(r), 0, 0));
  }
  /**
  ...
  */
  split(e, n = 1, r) {
    return uy(this, e, n, r), this;
  }
  /**
  Add the given mark to the inline content between `from` and `to`.
  */
  addMark(e, n, r) {
    return ty(this, e, n, r), this;
  }
  /**
...
class $ {
  ...
  */
  constructor(e, n, r) {
    this.$anchor = e, this.$head = n, this.ranges = r || [new mh(e.min(n), e.max(n))];
  }
  /**
  ...
  */
  replace(e, n = L.empty) {
    ...
    for (let l = 0; l < s.length; l++) {
      ...
      e.replaceRange(u.map(a.pos), u.map(c.pos), l ? L.empty : n), l == 0 && Zc(e, o, (r ? r.isInline : i && i.isTextblock) ? -1 : 1);
    }
  }
  /**
  ...
  */
  replaceWith(e, n) {
    ...
    for (let o = 0; o < i.length; o++) {
      ...
      o ? e.deleteRange(c, u) : (e.replaceRangeWith(c, u, n), Zc(e, r, n.isInline ? -1 : 1));
    }
  }
  /**
...
class $s {
  constructor(e, n) {
    this.schema = e, this.plugins = [], this.pluginsByKey = /* @__PURE__ */ Object.create(null), this.fields = Sy.slice(), n && n.forEach((r) => {
...
function gh(t, e, n) {
  for (let r in t) {
    let i = t[r];
    i instanceof Function ? i = i.bind(e) : r == "handleDOMEvents" && (i = gh(i, e, {})), n[r] = i;
  }
  return n;
}
class re {
  ...
  */
  constructor(e) {
    this.spec = e, this.props = {}, e.props && gh(e.props, this, this.props), this.key = e.key ? e.key.key : yh("plugin");
  }
  /**
...
const vh = (t, e, n) => {
  ...
  if (r.parent.content.size == 0 && (lr(o, "end") || z.isSelectable(o)))
    for (let s = r.depth; ; s--) {
      let l = as(t.doc, r.before(s), r.after(s), L.empty);
...
function wh(t, e, n) {
  ...
  let c = as(t.doc, o, a, L.empty);
  if (!c || c.from != o || c instanceof me && c.slice.size >= a - o)
    return !1;
  if (n) {
    let u = t.tr.step(c);
    u.setSelection(N.create(u.doc, o)), n(u.scrollIntoView());
  }
  return !0;
}
function lr(t, e, n = !1) {
...
const Sh = (t, e, n) => {
  ...
  if (r.parent.content.size == 0 && (lr(o, "start") || z.isSelectable(o))) {
    let s = as(t.doc, r.before(), r.after(), L.empty);
...
function Oy(t) {
  return (e, n) => {
    ...
    let u = e.tr;
    (e.selection instanceof N || e.selection instanceof Ue) && u.deleteSelection();
    let d = u.mapping.map(r.pos), f = Rt(u.doc, d, o.length, o);
    if (f || (o[0] = l ? { type: l } : null, f = Rt(u.doc, d, o.length, o)), !f)
      return !1;
...
function Eh(t, e, n, r) {
  ...
  if (c && (s = (l = i.contentMatchAt(i.childCount)).findWrapping(o.type)) && l.matchType(s[0] || o.type).validEnd) {
    if (n) {
      ...
      p = A.from(i.copy(p));
      let m = t.tr.step(new we(e.pos - 1, h, e.pos, h, new L(p, 1, 0), s.length, !0)), g = m.doc.resolve(h + 2 * s.length);
      g.nodeAfter && g.nodeAfter.type == i.type && hn(m.doc, g.pos) && m.join(g.pos), n(m.scrollIntoView());
    }
    return !0;
  }
  let u = o.type.spec.isolating || r > 0 && a ? null : $.findFrom(e, 1), d = u && u.$from.blockRange(u.$to), f = d && br(d);
  if (f != null && f >= e.depth)
    ...
    if (h.canReplace(h.childCount, h.childCount, m.content)) {
      if (n) {
        ...
        for (let v = p.length - 1; v >= 0; v--)
          y = A.from(p[v].copy(y));
        let b = t.tr.step(new we(e.pos - p.length, e.pos + o.nodeSize, e.pos + g, e.pos + o.nodeSize - g, new L(y, p.length, 0), 0, !0));
        n(b.scrollIntoView());
      }
      return !0;
    }
...
function Dy(t, e = null) {
  return function(n, r) {
    ...
    if (!s)
      return !1;
    let l = r ? n.tr : null;
    return Py(l, s, t, e) ? (r && r(l.scrollIntoView()), !0) : !1;
  };
}
function Py(t, e, n, r = null) {
  ...
  let l = Oa(o, n, r, e);
  return l ? (t && zy(t, e, l, i, n), !0) : !1;
}
function zy(t, e, n, r, i) {
  let o = A.empty;
  for (let u = n.length - 1; u >= 0; u--)
    o = A.from(n[u].type.create(n[u].attrs, o));
  t.step(new we(e.start - (r ? 2 : 0), e.end, e.start, e.end, new L(o, 0, 0), n.length, !0));
  let s = 0;
  for (let u = 0; u < n.length; u++)
    n[u].type == i && (s = u + 1);
  let l = n.length - s, a = e.start + n.length - (r ? 2 : 0), c = e.parent;
  for (let u = e.startIndex, d = e.endIndex, f = !0; u < d; u++, f = !1)
    !f && Rt(t.doc, a, l) && (t.split(a, l), a += 2 * l), a += c.child(u).nodeSize;
  return t;
}
function $y(t) {
  return function(e, n) {
    let { $from: r, $to: i } = e.selection, o = r.blockRange(i, (s) => s.childCount > 0 && s.firstChild.type == t);
    return o ? n ? r.node(o.depth - 1).type == t ? By(e, n, t, o) : Fy(e, n, o) : !0 : !1;
  };
}
function By(t, e, n, r) {
  let i = t.tr, o = r.end, s = r.$to.end(r.depth);
  o < s && (i.step(new we(o - 1, s, o, s, new L(A.from(n.create(null, r.parent.copy())), 1, 0), 1, !0)), r = new ao(i.doc.resolve(r.$from.pos), i.doc.resolve(s), r.depth));
  const l = br(r);
  if (l == null)
    return !1;
  i.lift(r, l);
...
function Fy(t, e, n) {
  ...
  if (!c.canReplace(u + (l ? 0 : 1), u + 1, s.content.append(a ? A.empty : A.from(i))))
    return !1;
  let d = o.pos, f = d + s.nodeSize;
  return r.step(new we(d - (l ? 1 : 0), f + (a ? 1 : 0), d + 1, f - 1, new L((l ? A.empty : A.from(i.copy(A.empty))).append(a ? A.empty : A.from(i.copy(A.empty))), l ? 0 : 1, a ? 0 : 1), l ? 0 : 1)), e(r.scrollIntoView()), !0;
}
function Uy(t) {
  return function(e, n) {
    ...
    if (a.type != t)
      return !1;
    if (n) {
      let c = a.lastChild && a.lastChild.type == l.type, u = A.from(c ? t.create() : null), d = new L(A.from(t.create(null, A.from(l.type.create(null, u)))), c ? 3 : 1, 0), f = o.start, h = o.end;
...
function nd(t, e, n, r, i) {
  for (var o; ; ) {
    ...
    if (e == (i < 0 ? 0 : Ge(t))) {
      let s = t.parentNode;
      if (!s || s.nodeType != 1 || bi(t) || jy.test(t.nodeName) || t.contentEditable == "false")
        return !1;
      e = Se(t) + (i < 0 ? 0 : 1), t = s;
...
const ft = typeof navigator < "u" ? navigator : null, rd = typeof document < "u" ? document : null, pn = ft && ft.userAgent || "", El = /Edge\/(\d+)/.exec(pn), Oh = /MSIE \d/.exec(pn), Ll = /Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(pn), Pe = !!(Oh || Ll || El), rn = Oh ? document.documentMode : Ll ? +Ll[1] : El ? +El[1] : 0, Je = !Pe && /gecko\/(\d+)/i.test(pn);
Je && +(/Firefox\/(\d+)/.exec(pn) || [0, 0])[1];
const Ol = !Pe && /Chrome\/(\d+)/.exec(pn), Te = !!Ol, Hh = Ol ? +Ol[1] : 0, Oe = !Pe && !!ft && /Apple Computer/.test(ft.vendor), cr = Oe && (/Mobile\/\w+/.test(pn) || !!ft && ft.maxTouchPoints > 2), qe = cr || (ft ? /Mac/.test(ft.platform) : !1), Rh = ft ? /Win/.test(ft.platform) : !1, Lt = /Android \d/.test(pn), vi = !!rd && "webkitFontSmoothing" in rd.documentElement.style, Zy = vi ? +(/\bAppleWebKit\/(\d+)/.exec(navigator.userAgent) || [0, 0])[1] : 0;
function Yy(t) {
...
function id(t, e, n) {
  ...
  for (let s = n || t.dom; s; ) {
    ...
    let l = s, a = l == o.body, c = a ? Yy(o) : Qy(l), u = 0, d = 0;
...
function e0(t) {
  ...
  return { refDOM: r, refTop: i, stack: Vh(t.dom) };
}
function Vh(t) {
...
function t0({ refDOM: t, refTop: e, stack: n }) {
...
function Ih(t, e) {
  ...
  return !n && a && (n = a, i = c, r = 0), n && n.nodeType == 3 ? r0(n, i) : !n || r && n.nodeType == 1 ? { node: t, offset: o } : Ih(n, i);
}
function r0(t, e) {
...
function o0(t, e, n) {
  let { node: r, offset: i } = Ih(e, n), o = -1;
...
function l0(t, e) {
  ...
  if (s = i0(s, e), r) {
    ...
    let c;
    vi && i && r.nodeType == 1 && (c = r.childNodes[i - 1]).nodeType == 1 && c.contentEditable == "false" && c.getBoundingClientRect().top >= e.top && i--, r == t.dom && i == r.childNodes.length - 1 && r.lastChild.nodeType == 1 && e.top > r.lastChild.getBoundingClientRect().bottom ? l = t.state.doc.content.size : (i == 0 || r.nodeType != 1 || r.childNodes[i - 1].nodeName != "BR") && (l = s0(t, r, i, e));
  }
  l == null && (l = o0(t, s, e));
...
function Dh(t, e, n) {
  ...
  if (r.nodeType == 3)
    if (s && (a0.test(r.nodeValue) || (n < 0 ? !i : i == r.nodeValue.length))) {
      ...
      return n < 0 && !i ? (c++, u = -1) : n >= 0 && i == r.nodeValue.length ? (a--, u = 1) : n < 0 ? a-- : c++, Cr(Kt(Et(r, a, c), u), u < 0);
    }
...
function u0(t, e, n) {
  ...
  return l ? !d0.test(r.parent.textContent) || !l.modify ? n == "left" || n == "backward" ? o : s : Ph(t, e, () => {
...
function f0(t, e, n) {
  return od == e && sd == n ? ld : (od = e, sd = n, ld = n == "up" || n == "down" ? c0(t, e, n) : u0(t, e, n));
}
...
`), d && p == h.nodeValue.length)
    ...
    if (!(i || d && Oe) && Rn(l.node, l.offset, u.anchorNode, u.anchorOffset) && Rn(a.node, a.offset, u.focusNode, u.focusOffset))
      return;
    let f = !1;
    if ((c.extend || e == n) && !(d && Je)) {
...
class sn extends wi {
  ...
  static create(e, n, r, i, o, s) {
    ...
    } else u || ({ dom: u, contentDOM: d } = fn.renderSpec(document, n.type.spec.toDOM(n), null, n.attrs));
    !d && !n.isText && u.nodeName != "BR" && (u.hasAttribute("contenteditable") || (u.contentEditable = "false"), n.type.spec.draggable && (u.draggable = !0));
    let f = u;
    return u = Uh(u, r, n), c ? a = new p0(e, n, r, i, u, d || null, f, c) : n.isText ? new us(e, n, r, i, u, f) : new sn(e, n, r, i, u, d || null, f);
  }
  parseRule(e) {
  ...
  // `this.children`.
  updateChildren(e, n) {
    let r = this.node.inlineContent, i = n, o = e.composing ? this.localCompositionInfo(e, n) : null, s = o && o.pos > -1 ? o : null, l = o && o.pos < 0, a = new g0(this, s && s.node, e);
    ...
    }), a.syncToMarks([], r, e, 0), this.node.isTextblock && a.addTextblockHacks(), a.destroyRest(), (a.changed || this.dirty == kn) && (s && this.protectLocalComposition(e, s), Bh(this.contentDOM, this.children, e), cr && w0(this.dom));
  }
  localCompositionInfo(e, n) {
    ...
    if (this.node.inlineContent) {
      let s = o.nodeValue, l = k0(this.node.content, s, r - n, i - n);
  ...
  updateOuterDeco(e) {
    ...
    this.dom = Fh(this.dom, this.nodeDOM, Rl(this.outerDeco, this.node, n), Rl(e, this.node, n)), this.dom != r && (r.pmViewDesc = void 0, this.dom.pmViewDesc = this), this.outerDeco = e;
  }
...
function Bh(t, e, n) {
  ...
  for (let o = 0; o < e.length; o++) {
    ...
    if (s instanceof on) {
      ...
      Bh(s.contentDOM, s.children, n), r = a ? a.nextSibling : t.firstChild;
    }
  }
  for (; r; )
    r = dd(r), i = !0;
...
function Uh(t, e, n) {
  return Fh(t, t, xn, Rl(e, n, t.nodeType != 1));
}
function uo(t, e) {
  if (t.length != e.length)
    return !1;
...
class g0 {
  constructor(e, n, r) {
    this.lock = n, this.view = r, this.index = 0, this.stack = [], this.changed = !1, this.top = e, this.preMatch = y0(e.node.content, e);
  }
  ...
  syncToMarks(e, n, r, i) {
    ...
    for (; s < e.length; ) {
      ...
      if (a < 0 && this.index < this.top.children.length) {
        ...
        u instanceof on && u.dirty != et && u.mark.type == e[s].type && u.spec.update && !this.isLocked(u.dom) && u.spec.update(e[s]) && (u.mark = e[s], a = this.index, this.changed = !0);
      }
      if (a > -1)
        a > this.index && (this.changed = !0, this.destroyBetween(this.index, a)), this.top = this.top.children[this.index];
      else {
        let u = on.create(this.top, e[s], n, r);
  ...
  updateNextNode(e, n, r, i, o, s) {
    for (let l = this.index; l < this.top.children.length; l++) {
      ...
      if (a instanceof sn) {
        ...
        if (c != null && c != o)
          return !1;
        let u = a.dom, d, f = this.isLocked(u) && !(e.isText && a.node && a.node.isText && a.nodeDOM.nodeValue == e.text && a.dirty != et && uo(n, a.outerDeco));
        if (!f && a.update(e, n, r, i))
          return this.destroyBetween(this.index, l), a.dom != u && (this.changed = !0), this.index++, !0;
        if (!f && (d = this.recreateWrapper(a, e, n, r, i, s)))
          return this.destroyBetween(this.index, l), this.top.children[this.index] = d, d.contentDOM && (d.dirty = kn, d.updateChildren(i, s + 1), d.dirty = Xe), this.changed = !0, this.index++, !0;
        break;
      }
    }
    return !1;
...
function za(t, e = null) {
  ...
  if (ds(n)) {
    for (a = s; i && !i.node; )
      i = i.parent;
    let d = i.node;
    if (i && d.isAtom && z.isSelectable(d) && i.parent && !(d.isInline && Gy(n.focusNode, n.focusOffset, i.dom))) {
      let f = i.posBefore;
...
function Vt(t, e = !1) {
  ...
  if (t.domObserver.disconnectSelection(), t.cursorWrapper)
    ...
    ud && !(n instanceof N) && (n.$from.parent.inlineContent || (s = fd(t, n.from)), !n.empty && !n.$from.parent.inlineContent && (l = fd(t, n.to))), t.docView.setSelection(i, o, t, e), ud && (s && hd(s), l && hd(l)), n.visible ? t.dom.classList.remove("ProseMirror-hideselection") : (t.dom.classList.add("ProseMirror-hideselection"), "onselectionchange" in document && x0(t));
  }
  t.domObserver.setCurSelection(), t.domObserver.connectSelection();
}
const ud = Oe || Te && Hh < 63;
function fd(t, e) {
...
function Il(t, e, n) {
  if (e.nodeType != 3) {
    let o, s;
    (s = M0(e, n)) ? (e = s, n = 0) : (o = E0(e, n)) && (e = o, n = o.nodeValue.length);
  }
...
function yd(t, e) {
  ...
  if (!(Te || Rh) && n.parent.inlineContent) {
...
function Ba(t, e) {
  ...
  let s = t.someProp("clipboardSerializer") || fn.fromSchema(t.state.schema), l = Qh(), a = l.createElement("div");
  a.appendChild(s.serializeFragment(r, { document: l }));
  let c = a.firstChild, u, d = 0;
  for (; c && c.nodeType == 1 && (u = Yh[c.nodeName.toLowerCase()]); ) {
...
function Gh(t, e, n, r, i) {
  ...
  if (a) {
    if (t.someProp("transformPastedText", (f) => {
      ...
      return l = new L(A.from(t.state.schema.text(e.replace(/\r\n?/g, `
`))), 0, 0), t.someProp("transformPasted", (f) => {
  ...
  if (l || (l = (t.someProp("clipboardParser") || t.someProp("domParser") || nn.fromSchema(t.state.schema)).parseSlice(s, {
    ...
    context: i,
    ruleFromNode(f) {
      return f.nodeName == "BR" && !f.nextSibling && f.parentNode && !R0.test(f.parentNode.nodeName) ? { ignore: !0 } : null;
    }
  })), u)
    l = D0(kd(l, +u[1], +u[2]), u[4]);
  else if (l = L.maxOpen(V0(l.content, i), !0), l.openStart || l.openEnd) {
    let d = 0, f = 0;
...
const R0 = /^(a|abbr|acronym|b|cite|code|del|em|i|ins|kbd|label|output|q|ruby|s|samp|span|strong|sub|sup|time|u|tt|var)$/i;
function V0(t, e) {
  if (t.childCount < 2)
    return t;
  for (let n = e.depth; n >= 0; n--) {
    ...
    if (t.forEach((l) => {
      ...
      if (!a)
        return s = null;
      if (c = s.length && o.length && Xh(a, o, l, s[s.length - 1], 0))
        s[s.length - 1] = c;
      else {
        s.length && (s[s.length - 1] = Zh(s[s.length - 1], o.length));
        let u = Jh(l, a);
...
function Xh(t, e, n, r, i) {
  if (i < t.length && i < e.length && t[i] == e[i]) {
    ...
    if (r.contentMatchAt(r.childCount).matchType(i == t.length - 1 ? n.type : t[i + 1]))
      return r.copy(r.content.append(A.from(Jh(n, t, i + 1))));
  }
}
function Zh(t, e) {
  if (e == 0)
    return t;
  let n = t.content.replaceChild(t.childCount - 1, Zh(t.lastChild, e - 1)), r = t.contentMatchAt(t.childCount).fillBefore(A.empty, !0);
...
function kd(t, e, n) {
  return e < t.openStart && (t = new L(_l(t.content, -1, e, t.openStart, 0, t.openEnd), e, t.openEnd)), n < t.openEnd && (t = new L(_l(t.content, 1, n, t.openEnd, 0, 0), t.openStart, n)), t;
}
const Yh = {
  thead: ["table"],
  tbody: ["table"],
...
function I0(t) {
  ...
  let n = Qh(), r = n.body, i = /<([a-z][^>\s]+)/i.exec(t), o;
  if ((o = i && Yh[i[1].toLowerCase()]) && (t = o.map((s) => "<" + s + ">").join("") + t + o.map((s) => "</" + s + ">").reverse().join("")), r.innerHTML = N0(t), o)
    for (let s = 0; s < o.length; s++)
...
const Ve = {}, Ne = {}, P0 = { touchstart: !0, touchmove: !0 };
class z0 {
  constructor() {
...
function $0(t) {
  for (let e in Ve) {
    ...
    t.dom.addEventListener(e, t.input.eventHandlers[e] = (r) => {
      F0(t, r) && !Fa(t, r) && (t.editable || !(r.type in Ne)) && n(t, r);
...
Ne.keydown = (t, e) => {
  let n = e;
  if (t.input.shiftKey = n.keyCode == 16 || n.shiftKey, !rp(t) && (t.input.lastKeyCode = n.keyCode, t.input.lastKeyCodeTime = Date.now(), !(Lt && Te && n.keyCode == 13)))
    ...
    } else t.someProp("handleKeyDown", (r) => r(t, n)) || H0(t, n) ? n.preventDefault() : Ot(t, "key");
};
Ne.keyup = (t, e) => {
...
Ne.keypress = (t, e) => {
  let n = e;
  if (rp(t) || !n.charCode || n.ctrlKey && !n.altKey || qe && n.metaKey)
    return;
...
function q0(t, e, n, r, i) {
  return Ua(t, "handleClickOn", e, n, r) || t.someProp("handleClick", (o) => o(t, e, r)) || (i ? K0(t, n) : j0(t, n));
}
function G0(t, e, n, r) {
  return Ua(t, "handleDoubleClickOn", e, n, r) || t.someProp("handleDoubleClick", (i) => i(t, e, r));
}
function J0(t, e, n, r) {
  return Ua(t, "handleTripleClickOn", e, n, r) || t.someProp("handleTripleClick", (i) => i(t, e, r)) || X0(t, n, r);
}
function X0(t, e, n) {
  if (n.button != 0)
    return !1;
  let r = ep(t, e, !0), i = t.state.doc;
  return r ? (xi(t, r), r instanceof N && i.eq(t.state.doc) && (t.input.mouseDown = new Y0(t, r)), !0) : !1;
}
function ep(t, e, n) {
  let r = t.state.doc;
  if (e == -1)
...
const tp = qe ? "metaKey" : "ctrlKey";
Ve.mousedown = (t, e) => {
  let n = e;
  t.input.shiftKey = n.shiftKey;
  let r = Wa(t), i = Date.now(), o = "singleClick";
  i - t.input.lastClick.time < 500 && W0(n, t.input.lastClick) && !n[tp] && t.input.lastClick.button == n.button && (t.input.lastClick.type == "singleClick" ? o = "doubleClick" : t.input.lastClick.type == "doubleClick" && (o = "tripleClick")), t.input.lastClick = { time: i, x: n.clientX, y: n.clientY, type: o, button: n.button }, t.input.mouseDown && t.input.mouseDown.done();
  let s = t.posAtCoords(ki(n));
  s && (o == "singleClick" ? t.input.mouseDown = new Z0(t, s, n, !!r) : (o == "doubleClick" ? G0 : J0)(t, s.pos, s.inside, n) ? n.preventDefault() : Ot(t, "pointer"));
};
class np {
  constructor(e) {
...
class Z0 extends np {
  constructor(e, n, r, i) {
    super(e), this.pos = n, this.event = r, this.flushed = i, this.delayedSelectionSync = !1, this.startDoc = e.state.doc, this.selectNode = !!r[tp], this.allowDefault = r.shiftKey;
    let o, s;
    if (n.inside > -1)
  ...
  up(e) {
    if (this.done(), !this.view.dom.contains(e.target))
      return;
    let n = this.pos;
    this.view.state.doc != this.startDoc && (n = this.view.posAtCoords(ki(e))), this.updateAllowDefault(e), this.allowDefault || !n ? Ot(this.view, "pointer") : q0(this.view, n.pos, n.inside, e, this.selectNode) ? e.preventDefault() : e.button == 0 && (this.flushed || // Safari ignores clicks on draggable elements
...
class Y0 extends np {
  ...
  move(e) {
    ...
    let n = this.view.posAtCoords(ki(e)), r = n && ep(this.view, n.inside, !1);
    if (!r)
      return;
...
Ne.compositionstart = Ne.compositionupdate = (t) => {
  if (!t.composing) {
    ...
    if (e.selection instanceof N && (e.storedMarks || !n.textOffset && n.parentOffset && n.nodeBefore.marks.some((r) => r.type.spec.inclusive === !1) || Te && Rh && eb(t)))
...
function tb(t) {
  ...
  if (!e.focusNode)
    return null;
  let n = Ky(e.focusNode, e.focusOffset), r = qy(e.focusNode, e.focusOffset);
  if (n && r && n != r) {
...
function ho(t, e = !1) {
  if (!(Lt && t.domObserver.flushingSoon >= 0)) {
    if (t.domObserver.forceFlush(), op(t), e || t.docView && t.docView.dirty) {
...
const ni = Pe && rn < 15 || cr && Zy < 604;
Ve.copy = Ne.cut = (t, e) => {
  let n = e, r = t.state.selection, i = n.type == "cut";
  if (r.empty)
    return;
  let o = ni ? null : n.clipboardData, s = r.content(), { dom: l, text: a } = Ba(t, s);
  o ? (n.preventDefault(), o.clearData(), o.setData("text/html", l.innerHTML), o.setData("text/plain", a)) : nb(t, l), i && t.dispatch(t.state.tr.deleteSelection().scrollIntoView().setMeta("uiEvent", "cut"));
};
function rb(t) {
...
function ri(t, e, n, r, i) {
  let o = Gh(t, e, n, r, t.state.selection.$from);
  if (t.someProp("handlePaste", (a) => a(t, i, o || L.empty)))
    return !0;
  if (!o)
    return !1;
  let s = rb(o), l = s ? t.state.tr.replaceSelectionWith(s, r) : t.state.tr.replaceSelection(o);
...
Ne.paste = (t, e) => {
  ...
  r && ri(t, sp(r), r.getData("text/html"), i, n) ? n.preventDefault() : ib(t, n);
};
class lp {
  constructor(e, n, r) {
...
Ve.dragstart = (t, e) => {
  ...
  let l = (s || t.state.selection).content(), { dom: a, text: c, slice: u } = Ba(t, l);
  (!n.dataTransfer.files.length || !Te || Hh > 120) && n.dataTransfer.clearData(), n.dataTransfer.setData(ni ? "Text" : "text/html", a.innerHTML), n.dataTransfer.effectAllowed = "copyMove", ni || n.dataTransfer.setData("text/plain", c), t.dragging = new lp(u, ap(t, n), s);
};
Ve.dragend = (t) => {
  let e = t.dragging;
  window.setTimeout(() => {
...
function sb(t, e, n) {
  ...
  o ? t.someProp("transformPasted", (h) => {
    o = h(o, t, !1);
  }) : o = Gh(t, sp(e.dataTransfer), ni ? null : e.dataTransfer.getData("text/html"), !1, i);
  let s = !!(n && ap(t, e));
  if (t.someProp("handleDrop", (h) => h(t, e, o || L.empty, s))) {
    e.preventDefault();
    return;
  }
  if (!o)
    return;
  e.preventDefault();
  let l = o ? dh(t.state.doc, i.pos, o) : i.pos;
  l == null && (l = i.pos);
  let a = t.state.tr;
  if (s) {
    let { node: h } = n;
...
class Z {
  ...
  */
  mapInner(e, n, r, i, o) {
    ...
    return this.children.length ? lb(this.children, s || [], e, n, r, i, o) : s ? new Z(s.sort(En), Gn) : Ee;
  }
  /**
    ...
    e.forEach((l, a) => {
      ...
      if (u = dp(n, l, c)) {
        for (i || (i = this.children.slice()); o < i.length && i[o] < a; )
          o += 3;
        i[o] == a ? i[o + 2] = i[o + 2].addInner(l, u, c + 1) : i.splice(o, 0, a, a + l.nodeSize, mo(u, l, c + 1, Mn)), o += 3;
      }
    });
    let s = cp(o ? up(n) : n, -r);
    for (let l = 0; l < s.length; l++)
    ...
    n.maps[c].forEach((f, h, p, m) => {
      ...
      for (let y = 0; y < l.length; y += 3) {
        ...
        if (b < 0 || f > b + u - d)
          continue;
        let v = l[y] + u - d;
        h >= v ? l[y + 1] = f <= v ? -2 : -1 : f >= u && g && (l[y] += g, l[y + 1] += g);
      }
      d += g;
    }), u = n.maps[c].map(u, -1);
  }
  ...
  for (let c = 0; c < l.length; c += 3)
    if (l[c + 1] < 0) {
      ...
      if (g && m == d && m + g.nodeSize == h) {
        let y = l[c + 2].mapInner(n, g, u + 1, t[c] + o + 1, s);
        y != Ee ? (l[c] = d, l[c + 1] = h, l[c + 2] = y) : (l[c + 1] = -2, a = !0);
      } else
        a = !0;
    }
  if (a) {
    let c = ab(l, t, e, n, i, o, s), u = mo(c, r, 0, s);
    e = u.local;
...
class fb {
  constructor(e, n) {
    this.view = e, this.handleDOMChange = n, this.queue = [], this.flushingSoon = -1, this.observer = null, this.currentSelection = new ub(), this.onCharData = null, this.suppressingSelectionUpdates = !1, this.lastChangedTextNode = null, this.observer = window.MutationObserver && new window.MutationObserver((r) => {
      for (let i = 0; i < r.length; i++)
        this.queue.push(r[i]);
  ...
  start() {
    this.observer && (this.observer.takeRecords(), this.observer.observe(this.view.dom, cb)), this.onCharData && this.view.dom.addEventListener("DOMCharacterDataModified", this.onCharData), this.connectSelection();
  }
  stop() {
    if (this.observer) {
  ...
  flush() {
    ...
    if (a.some((u) => u.nodeName == "BR") && (e.input.lastKeyCode == 8 || e.input.lastKeyCode == 46 || Te && (e.composing || e.input.compositionEndedAt > Date.now() - 50) && n.some((u) => u.type == "childList" && u.removedNodes.length))) {
      for (let u of a)
      ...
      if (u.length == 2) {
        ...
        for (let f of u) {
          let h = f.parentNode;
          h && h.nodeName == "LI" && (!d || mb(e, d) != h) && f.remove();
        }
      }
    }
    let c = null;
    o < 0 && i && e.input.lastFocus > Date.now() - 200 && Math.max(e.input.lastTouch, e.input.lastClick.time) < Date.now() - 300 && ds(r) && (c = za(e)) && c.eq($.near(e.state.doc.resolve(0), 1)) ? (e.input.lastFocus = 0, Vt(e), this.currentSelection.set(r), e.scrollToSelection()) : (o > -1 || i) && (o > -1 && (e.docView.markDirty(o, s), hb(e)), e.input.badSafariComposition && (e.input.badSafariComposition = !1, gb(e, a)), this.handleDOMChange(o, s, l, a), e.docView && e.docView.dirty ? e.updateState(e.state) : this.currentSelection.eq(r) || Vt(e), this.currentSelection.set(r));
  }
...
function yb(t, e, n, r) {
  let { node: i, fromOffset: o, toOffset: s, from: l, to: a } = t.docView.parseRange(e, n), c = t.domSelectionRange(), u, d = c.anchorNode;
  if (d && t.dom.contains(d.nodeType == 1 ? d : d.parentNode) && (u = [{ node: d, offset: c.anchorOffset }], ds(c) || u.push({ node: c.focusNode, offset: c.focusOffset })), Te && t.input.lastKeyCode === 8)
    for (let y = s; y > o; y--) {
      let b = i.childNodes[y - 1], v = b.pmViewDesc;
      if (b.nodeName == "BR" && !v) {
        s = y;
        break;
      }
...
const bb = (t) => (e) => {
  ...
  if (e.nodeName == "BR" && e.parentNode) {
    ...
    return { ignore: !0 };
  return null;
}, vb = /^(a|abbr|acronym|b|bd[io]|big|br|button|cite|code|data(list)?|del|dfn|em|i|img|ins|kbd|label|map|mark|meter|output|q|ruby|s|samp|small|span|strong|su[bp]|time|u|tt|var)$/i;
function wb(t, e, n, r, i) {
  ...
  if (t.input.compositionPendingChanges = 0, e < 0) {
    ...
    if (C && !t.state.selection.eq(C)) {
      if (Te && Lt && t.input.lastKeyCode === 13 && Date.now() - 100 < t.input.lastKeyCodeTime && t.someProp("handleKeyDown", (_) => _(t, vn(13, "Enter"))))
        return;
      let O = t.state.tr.setSelection(C);
      S == "pointer" ? O.setMeta("pointer", !0) : S == "key" && O.scrollIntoView(), o && O.setMeta("composition", o), t.dispatch(O);
    }
    return;
  }
  let s = t.state.doc.resolve(e), l = s.sharedDepth(n);
  e = s.before(l + 1), n = t.state.doc.resolve(n).after(l + 1);
  let a = t.state.selection, c = yb(t, e, n, i), u = t.state.doc, d = u.slice(c.from, c.to), f, h;
  ...
  let p = Sb(d.content, c.doc.content, c.from, f, h);
  if (p && t.input.domChangeCount++, (cr && t.input.lastIOSEnter > Date.now() - 225 || Lt) && i.some((S) => S.nodeType == 1 && !vb.test(S.nodeName)) && (!p || p.endA >= p.endB) && t.someProp("handleKeyDown", (S) => S(t, vn(13, "Enter")))) {
  ...
  if (t.state.selection.anchor > p.start && xb(u, p.start, p.endA, m, g) && t.someProp("handleKeyDown", (S) => S(t, vn(8, "Backspace")))) {
  ...
  let v = p.start, k = p.endA, x = (S) => {
    let C = S || t.state.tr.replace(v, k, c.doc.slice(p.start - c.from, p.endB - c.from));
    if (c.sel) {
      let O = Td(t, C.doc, c.sel);
      O && !(Te && t.composing && O.empty && (p.start != p.endB || t.input.lastChromeDelete < Date.now() - 100) && (O.head == v || O.head == C.mapping.map(k) - 1) || Pe && O.empty && O.head == v) && C.setSelection(O);
    }
  ...
  if (b)
    if (m.pos == g.pos) {
      ...
      let S = x(t.state.tr.delete(v, k)), C = u.resolve(p.start).marksAcross(u.resolve(p.endA));
      C && S.ensureMarks(C), t.dispatch(S);
    } else if (
      // Adding or removing a mark
      p.endA == p.endB && (w = kb(m.parent.content.cut(m.parentOffset, g.parentOffset), y.parent.content.cut(y.parentOffset, p.endA - y.start())))
    ) {
      let S = x(t.state.tr);
      w.type == "add" ? S.addMark(v, k, w.mark) : S.removeMark(v, k, w.mark), t.dispatch(S);
    } else if (m.parent.child(m.index()).isText && m.index() == g.index() - (g.textOffset ? 0 : 1)) {
      let S = m.parent.textBetween(m.parentOffset, g.parentOffset), C = () => x(t.state.tr.insertText(S, v, k));
      t.someProp("handleTextInput", (O) => O(t, v, k, S, C)) || t.dispatch(C());
    } else
      t.dispatch(x());
  else
    t.dispatch(x());
...
class fp {
  ...
  */
  ...
  updateStateInner(e, n) {
    ...
    e.storedMarks && this.composing && (op(this), s = !0), this.state = e;
    ...
    if (l || this._props.plugins != n.plugins || this._props.nodeViews != n.nodeViews) {
      let h = Od(this);
      Ab(h, this.nodeViews) && (this.nodeViews = h, o = !0);
    }
    (l || n.handleDOMEvents != this._props.handleDOMEvents) && Dl(this), this.editable = Ld(this), Ed(this);
    let a = js(this), c = Md(this), u = i.plugins != e.plugins && !i.doc.eq(e.doc) ? "reset" : e.scrollToSelection > i.scrollToSelection ? "to selection" : "preserve", d = o || !this.docView.matchesNode(e.doc, c, a);
    (d || !e.selection.eq(i.selection)) && (s = !0);
    let f = u == "preserve" && s && this.dom.style.overflowAnchor == null && e0(this);
    if (s) {
      this.domObserver.stop();
      let h = d && (Pe || Te) && !this.composing && !i.selection.empty && !e.selection.empty && Cb(i.selection, e.selection);
      if (d) {
        let m = Te ? this.trackWrites = this.domSelectionRange().focusNode : null;
        this.composing && (this.input.compositionNode = tb(this)), (o || !this.docView.update(e.doc, c, a, this)) && (this.docView.updateOuterDeco(c), this.docView.destroy(), this.docView = cd(e.doc, c, a, this.dom, this)), m && (!this.trackWrites || !this.dom.contains(this.trackWrites)) && (h = !0);
      }
      let p = this.input.mouseDown;
      h || !(p && this.domObserver.currentSelection.eq(this.domSelectionRange()) && C0(this) && p.delaySelUpdate()) ? Vt(this, h) : (jh(this, e.selection), this.domObserver.setCurSelection()), this.domObserver.start();
    }
    this.updatePluginViews(i), !((r = this.dragging) === null || r === void 0) && r.node && !i.doc.eq(e.doc) && this.updateDraggedNode(this.dragging, i), u == "reset" ? this.dom.scrollTop = 0 : u == "to selection" ? this.scrollToSelection() : f && t0(f);
  }
  /**
  @internal
  */
  ...
  updateDraggedNode(e, n) {
    ...
    this.dragging = new lp(e.slice, e.move, i < 0 ? void 0 : z.create(this.state.doc, i));
  }
  someProp(e, n) {
  ...
  */
  focus() {
    this.domObserver.stop(), this.editable && n0(this.dom), Vt(this), this.domObserver.start();
  }
  /**
  ...
  */
  destroy() {
    this.docView && (B0(this), this.destroyPluginViews(), this.mounted ? (this.docView.update(this.state.doc, [], js(this), this), this.dom.textContent = "") : this.dom.parentNode && this.dom.parentNode.removeChild(this.dom), this.docView.destroy(), this.docView = null, Wy());
  }
  /**
  ...
  */
  domSelectionRange() {
    ...
    return e ? Oe && this.root.nodeType === 11 && Jy(this.dom.ownerDocument) == this.dom && pb(this, e) || e : { focusNode: null, focusOffset: 0, anchorNode: null, anchorOffset: 0 };
  }
  /**
  @internal
  */
...
fp.prototype.dispatch = function(t) {
...
var cn = {
  ...
  221: "}",
  222: '"'
}, Tb = typeof navigator < "u" && /Mac/.test(navigator.platform), Mb = typeof navigator < "u" && /MSIE \d|Trident\/(?:[7-9]|\d{2,})\..*rv:(\d+)/.exec(navigator.userAgent);
...
function Eb(t) {
  var e = Tb && t.metaKey && t.shiftKey && !t.ctrlKey && !t.altKey || Mb && t.shiftKey && t.key && t.key.length == 1 || t.key == "Unidentified", n = !e && t.key || (t.shiftKey ? go : cn)[t.keyCode] || t.key || "Unidentified";
  return n == "Esc" && (n = "Escape"), n == "Del" && (n = "Delete"), n == "Left" && (n = "ArrowLeft"), n == "Up" && (n = "ArrowUp"), n == "Right" && (n = "ArrowRight"), n == "Down" && (n = "ArrowDown"), n;
}
const Lb = typeof navigator < "u" && /Mac|iP(hone|[oa]d)/.test(navigator.platform), Ob = typeof navigator < "u" && /Win/.test(navigator.platform);
function Hb(t) {
...
function qa(t) {
  ...
  return function(n, r) {
    ...
    if (i.length == 1 && i != " ") {
      ...
      !(Ob && r.ctrlKey && r.altKey) && (o = cn[r.keyCode]) && o != i) {
        let l = e[Gs(o, r)];
        if (l && l(n.state, n.dispatch, n))
          return !0;
      }
...
var Nb = Object.defineProperty, Ga = (t, e) => {
  for (var n in e)
    Nb(t, n, { get: e[n], enumerable: !0 });
};
function fs(t) {
...
var rr = class hp {
  ...
  createChain(e, n = !0) {
    const { rawCommands: r, editor: i, state: o } = this, { view: s } = i, l = [], a = !!e, c = e || o.tr, u = () => (!a && n && !c.getMeta("preventDispatch") && !this.hasCustomState && s.dispatch(c), l.every((f) => f === !0)), d = {
      ...Object.fromEntries(
  ...
  createCan(e) {
    ...
    return {
      ...Object.fromEntries(
        Object.entries(n).map(([a, c]) => [a, (...u) => c(...u)({ ...s, dispatch: void 0 })])
      ),
...
Ga(pp, {
  ...
  selectParentNode: () => xv,
  selectTextblockEnd: () => Sv,
  selectTextblockStart: () => Cv,
  setContent: () => Av,
  setMark: () => jv,
  setMeta: () => Kv,
  setNode: () => qv,
  ...
  unsetAllMarks: () => sw,
  unsetMark: () => lw,
  unsetTextDirection: () => aw,
  updateAttributes: () => cw,
  updateDecorations: () => uw,
  wrapIn: () => fw,
  wrapInList: () => hw
});
var Ib = () => ({ editor: t, view: e }) => (requestAnimationFrame(() => {
  var n;
  t.isDestroyed || (e.dom.blur(), (n = window?.getSelection()) == null || n.removeAllRanges());
}), !0), _b = (t = !0) => ({ commands: e }) => e.setContent("", { emitUpdate: t }), Db = () => ({ state: t, tr: e, dispatch: n }) => {
...
}, Pb = (t) => (e) => t(e), zb = () => ({ state: t, dispatch: e }) => Th(t, e), $b = (t, e) => ({ editor: n, tr: r }) => {
...
var Fb = (t) => ({ tr: e, state: n, dispatch: r }) => {
...
var Jb = (t, e) => ({ tr: n, state: r, dispatch: i }) => {
  const o = $t(t, r.schema), { doc: s, selection: l } = n, { $from: a, from: c, to: u } = l;
  if (i) {
    const d = hs(a, o, e);
    if (d && d.from <= c && d.to >= u) {
      const f = N.create(s, d.from, d.to);
      n.setSelection(f);
    }
  }
  return !0;
...
var Yb = (t = null, e = {}) => ({ editor: n, view: r, tr: i, dispatch: o }) => {
  e = {
    scrollIntoView: !0,
    ...e
  };
  const s = () => {
    (oi() || zl()) && r.dom.focus(), Zb() && !oi() && !zl() && r.dom.focus({ preventScroll: !0 }), requestAnimationFrame(() => {
...
}, Qb = (t, e) => (n) => t.every((r, i) => e(r, { ...n, index: i })), ev = (t, e) => ({ tr: n, commands: r }) => r.insertContentAt(
  ...
  for (let n = e.length - 1; n >= 0; n -= 1) {
    const r = e[n];
    r.nodeType === 3 && r.nodeValue && /^(\n\s\s|\n)$/.test(r.nodeValue) ? t.removeChild(r) : r.nodeType === 1 && gp(r);
  }
  return t;
};
function Oi(t) {
...
var tv = (t, e, n) => ({ tr: r, dispatch: i, editor: o }) => {
  var s;
  if (i) {
    n = {
    ...
    let m;
    if (f)
      Array.isArray(e) ? m = e.map((g) => g.text || "").join("") : yp(e) ? m = p.map((g) => {
        var y;
        return (y = g.text) != null ? y : "";
      }).join("") : typeof e == "object" && e && e.text ? m = e.text : m = e, r.insertText(m, u, d);
    else {
      m = A.from(p);
      const g = r.doc.resolve(u), y = g.node(), b = g.parentOffset === 0, v = y.isText || y.isTextblock, k = y.content.size > 0;
      b && v && k && h && (u = Math.max(0, u - 1)), r.replaceWith(u, d, p);
    }
    n.updateSelection && vp(r, r.steps.length - 1, -1), n.applyInputRules && r.setMeta("applyInputRules", { from: u, text: m }), n.applyPasteRules && r.setMeta("applyPasteRules", { from: u, text: m });
  }
  return !0;
};
function wp(t) {
...
var nv = (t = {}) => ({ tr: e, dispatch: n, editor: r }) => {
  ...
  if (s) {
    ...
    f = c.createAndFill(d);
  return f ? (n && (e.insert(a.pos, f), l && vp(e, e.steps.length - 1, -1)), !0) : !1;
}, rv = () => ({ state: t, dispatch: e }) => Ty(t, e), iv = () => ({ state: t, dispatch: e }) => My(t, e), ov = () => ({ state: t, dispatch: e }) => vh(t, e), sv = () => ({ state: t, dispatch: e }) => Sh(t, e), lv = () => ({ state: t, dispatch: e, tr: n }) => {
  try {
...
}, cv = () => ({ state: t, dispatch: e }) => Cy(t, e), dv = () => ({ state: t, dispatch: e }) => Ay(t, e);
function kp() {
...
var fv = (t) => ({ editor: e, view: n, tr: r, dispatch: i }) => {
  const o = uv(t).split(/-(?!$)/), s = o.find((c) => !["Alt", "Ctrl", "Meta", "Shift"].includes(c)), l = new KeyboardEvent("keydown", {
    key: s === "Space" ? " " : s,
...
function Pt(t, e, n = {}) {
  ...
  const a = i - r, c = l.filter((d) => s ? s.name === d.node.type.name : !0).filter((d) => yo(d.node.attrs, n, { strict: !1 }));
  return o ? !!c.length : c.reduce((d, f) => d + f.to - f.from, 0) >= a;
}
var hv = (t, e = {}) => ({ state: n, dispatch: r }) => {
  const i = ye(t, n.schema);
  return Pt(n, i, e) ? Ey(n, r) : !1;
}, pv = () => ({ state: t, dispatch: e }) => Mh(t, e), mv = (t) => ({ state: e, dispatch: n }) => {
  const r = ye(t, e.schema);
  return $y(r)(e, n);
}, gv = () => ({ state: t, dispatch: e }) => Ah(t, e);
function ms(t, e) {
...
var yv = (t, e) => ({ tr: n, state: r, dispatch: i }) => {
  let o = null, s = null;
  const l = ms(
  ...
  return n.selection.ranges.forEach((c) => {
    r.doc.nodesBetween(c.$from.pos, c.$to.pos, (u, d) => {
      o && o === u.type && (a = !0, i && n.setNodeMarkup(d, void 0, Nd(u.attrs, e))), s && u.marks.length && u.marks.forEach((f) => {
...
}, bv = () => ({ tr: t, dispatch: e }) => (e && t.scrollIntoView(), !0), vv = () => ({ tr: t, dispatch: e }) => {
  if (e) {
    const n = new Ue(t.doc);
    t.setSelection(n);
  }
  return !0;
}, wv = () => ({ state: t, dispatch: e }) => kh(t, e), kv = () => ({ state: t, dispatch: e }) => Ch(t, e), xv = () => ({ state: t, dispatch: e }) => Ry(t, e), Sv = () => ({ state: t, dispatch: e }) => Iy(t, e), Cv = () => ({ state: t, dispatch: e }) => Ny(t, e);
function $l(t, e, n = {}, r = {}) {
  return dr(t, e, {
    slice: !1,
    parseOptions: n,
...
var Av = (t, { errorOnInvalidContent: e, emitUpdate: n = !0, parseOptions: r = {} } = {}) => ({ editor: i, tr: o, dispatch: s, commands: l }) => {
  const { doc: a } = o;
  if (r.preserveWhitespace !== "full") {
    ...
    if (s) {
      const u = bp(c) ? c.content : [c];
      o.replaceWith(0, a.content.size, u).setMeta("preventUpdate", !n);
    }
    return !0;
  }
...
function Q(t, e = void 0, ...n) {
  return Cp(t) ? e ? t.bind(e)(...n) : t(...n) : t;
}
function Mv(t = {}) {
  ...
  return "style" in t ? t : {
    ...
    getAttrs: (n) => {
      ...
      const i = e.reduce((o, s) => {
        const l = s.attribute.parseHTML ? s.attribute.parseHTML(n) : Lv(n.getAttribute(s.name));
        return l == null ? o : {
          ...o,
          [s.name]: l
        };
...
function Dd(t) {
  return Object.fromEntries(
    // @ts-ignore
    Object.entries(t).filter(([e, n]) => e === "attrs" && Mv(n) ? !1 : n != null)
  );
}
function Pd(t) {
  var e, n;
...
function Tp(t, e) {
  var n;
  const r = Ap(t), { nodeExtensions: i, markExtensions: o } = ur(t), s = (n = i.find((c) => D(c, "topNode"))) == null ? void 0 : n.name, l = Object.fromEntries(
    i.map((c) => {
      const u = r.filter(
        (y) => y.type === c.name
      ), d = {
        ...
        attrs: Object.fromEntries(u.map(Pd))
      }), p = Q(
        D(c, "parseHTML", d)
      );
      p && (h.parseDOM = p.map(
...
function Ya(t) {
  const e = _r(Xa(t)), n = Ov(e.map((r) => r.name));
...
function Lp(t, e) {
  ...
  return n === "node" ? Rv(t, e) : n === "mark" ? xp(t, e) : {};
}
function Vv(t, e = JSON.stringify) {
  const n = {};
  return t.filter((r) => {
    const i = e(r);
...
function Bl(t, e, n = {}) {
  ...
  if (r)
    return !!(t.storedMarks || t.selection.$from.marks()).filter((d) => o ? o.name === d.type.name : !0).find((d) => yo(d.attrs, n, { strict: !1 }));
  let s = 0;
  const l = [];
  if (i.forEach(({ $from: d, $to: f }) => {
    ...
    return !1;
  const a = l.filter((d) => o ? o.name === d.mark.type.name : !0).filter((d) => yo(d.mark.attrs, n, { strict: !1 })).reduce((d, f) => d + f.to - f.from, 0), c = l.filter((d) => o ? d.mark.type !== o && d.mark.type.excludes(o) : !0).reduce((d, f) => d + f.to - f.from, 0);
  return (a > 0 ? a + c : a) >= s;
}
function Pv(t, e, n = {}) {
  if (!e)
...
function Vp(t, e, n) {
  const i = t.state.doc.content.size, o = Ht(e, 0, i), s = Ht(n, 0, i), l = t.coordsAtPos(o), a = t.coordsAtPos(s, -1), c = Math.min(l.top, a.top), u = Math.max(l.bottom, a.bottom), d = Math.min(l.left, a.left), f = Math.max(l.right, a.right), h = f - d, p = u - c, y = {
    top: c,
    bottom: u,
    left: d,
    right: f,
...
var jv = (t, e = {}) => ({ tr: n, state: r, dispatch: i }) => {
  ...
  return Wv(r, n, a);
}, Kv = (t, e) => ({ tr: n }) => (n.setMeta(t, e), !0), qv = (t, e = {}) => ({ state: n, dispatch: r, chain: i }) => {
  ...
  if (n) {
    const { doc: r } = e, { from: i, to: o } = typeof t == "number" ? { from: t, to: t } : t, s = N.atStart(r).from, l = N.atEnd(r).to, a = Ht(i, s, l), c = Ht(o, s, l), u = N.create(r, a, c);
    e.setSelection(u);
  }
  return !0;
}, Zv = (t) => ({ state: e, dispatch: n }) => {
  const r = ye(t, e.schema);
  return Uy(r)(e, n);
};
function $d(t, e) {
...
var Yv = ({ keepMarks: t = !0 } = {}) => ({ tr: e, state: n, dispatch: r, editor: i }) => {
  const { selection: o, doc: s } = e, { $from: l, $to: a } = o, c = i.extensionManager.attributes, u = eo(
    c,
    l.node().type.name,
    l.node().attrs
  );
  ...
  if (!l.parent.isBlock)
    return !1;
  const d = a.parentOffset === a.parent.content.size, f = l.depth === 0 ? void 0 : wp(l.node(-1).contentMatchAt(l.indexAfter(-1)));
  let h = d && f ? [
    {
      type: f,
      attrs: u
  ...
  if (!h && !p && Rt(e.doc, e.mapping.map(l.pos), 1, f ? [{ type: f }] : void 0) && (p = !0, h = f ? [
    ...
    if (p && (o instanceof N && e.deleteSelection(), e.split(e.mapping.map(l.pos), 1, h), f && !d && !l.parentOffset && l.parent.type !== f)) {
  ...
  return p;
}, Qv = (t, e = {}) => ({ tr: n, state: r, dispatch: i, editor: o }) => {
  var s;
  const l = ye(t, r.schema), { $from: a, $to: c } = r.selection, u = r.selection.node;
  ...
  if (a.parent.content.size === 0 && a.node(-1).childCount === a.indexAfter(-1)) {
    ...
    if (i) {
      ...
      const v = (
        ...
        ...e
      }, x = ((s = l.contentMatch.defaultType) == null ? void 0 : s.createAndFill(k)) || void 0;
      y = y.append(A.from(l.createAndFill(null, x) || void 0));
      const w = a.before(a.depth - (b - 1));
      n.replace(w, a.after(-v), new L(y, 4 - b, 0));
      let S = -1;
      n.doc.nodesBetween(w, n.doc.content.size, (C, O) => {
        if (S > -1)
          return !1;
        C.isTextblock && C.content.size === 0 && (S = O + 1);
      }), S > -1 && n.setSelection(N.near(n.doc.resolve(S))), n.scrollIntoView();
    }
    return !0;
  }
  const h = c.pos === a.end() ? d.contentMatchAt(0).defaultType : null, p = {
    ...eo(f, d.type.name, d.attrs),
    ...e
  }, m = {
    ...eo(f, a.node().type.name, a.node().attrs),
    ...e
  ...
  if (!Rt(n.doc, a.pos, 2))
    return !1;
  if (i) {
    const { selection: y, storedMarks: b } = r, { splittableMarks: v } = o.extensionManager, k = b || y.$to.parentOffset && y.$from.marks();
    if (n.split(a.pos, 2, g).scrollIntoView(), !k || !i)
      return !0;
    const x = k.filter((w) => v.includes(w.type.name));
    n.ensureMarks(x);
  }
  return !0;
};
...
var Xs = (t, e) => {
  ...
  return !(n.node.type === i?.type && hn(t.doc, n.pos)) || !Np(n.node.attrs.type, i?.attrs.type) || t.join(n.pos), !0;
}, Zs = (t, e) => {
  const n = gs((s) => s.type === e)(t.selection);
  if (!n)
    return !0;
  ...
  if (r === void 0)
    return !0;
  const i = t.doc.nodeAt(r);
  return !(n.node.type === i?.type && hn(t.doc, r)) || !Np(n.node.attrs.type, i?.attrs.type) || t.join(r), !0;
};
function ew(t) {
...
var tw = (t, e, n, r = {}) => ({ editor: i, tr: o, state: s, dispatch: l, chain: a, commands: c, can: u }) => {
  const { extensions: d, splittableMarks: f } = i.extensionManager, h = ye(t, s.schema), p = ye(e, s.schema), { selection: m, storedMarks: g } = s, { $from: y, $to: b } = m, v = y.blockRange(b), k = g || m.$to.parentOffset && m.$from.marks();
  if (!v)
    return !1;
  const x = gs((B) => Js(B.type.name, d))(m), w = m.from === 0 && m.to === s.doc.content.size, S = s.doc.content.content, C = S.length === 1 ? S[0] : null, O = w && C && Js(C.type.name, d) ? {
    node: C,
    pos: 0
  } : null, _ = x ?? O, I = !!x && v.depth >= 1 && v.depth - x.depth <= 1, U = !!O;
  if ((I || U) && _) {
    if (_.node.type === h)
      return w && U ? a().command(({ tr: B, dispatch: j }) => {
        const K = ew(B);
        return K ? (B.setSelection(K), j && j(B), !0) : !1;
      }).liftListItem(p).run() : c.liftListItem(p);
    if (Js(_.node.type.name, d) && h.validContent(_.node.content))
      return a().command(() => (o.setNodeMarkup(_.pos, h), !0)).command(() => Xs(o, h)).command(() => Zs(o, h)).run();
  }
  return !n || !k || !l ? a().command(() => u().wrapInList(h, r) ? !0 : c.clearNodes()).wrapInList(h, r).command(() => Xs(o, h)).command(() => Zs(o, h)).run() : a().command(() => {
    const B = u().wrapInList(h, r), j = k.filter((K) => f.includes(K.type.name));
    return o.ensureMarks(j), B ? !0 : c.clearNodes();
  }).wrapInList(h, r).command(() => Xs(o, h)).command(() => Zs(o, h)).run();
}, nw = (t, e = {}, n = {}) => ({ state: r, commands: i }) => {
  const { extendEmptyMarkRange: o = !1 } = n, s = $t(t, r.schema);
  return Bl(r, s, e) ? i.unsetMark(s, { extendEmptyMarkRange: o }) : i.setMark(s, e);
}, rw = (t, e, n = {}) => ({ state: r, commands: i }) => {
...
}, iw = (t, e = {}) => ({ state: n, commands: r }) => {
  const i = ye(t, n.schema);
  return Pt(n, i, e) ? r.lift(i) : r.wrapIn(i, e);
}, ow = () => ({ state: t, dispatch: e }) => {
  const n = t.plugins;
  for (let r = 0; r < n.length; r += 1) {
    const i = n[r];
    let o;
  ...
  return !0;
}, lw = (t, e = {}) => ({ tr: n, state: r, dispatch: i }) => {
  var o;
  const { extendEmptyMarkRange: s = !1 } = e, { selection: l } = n, a = $t(t, r.schema), { $from: c, empty: u, ranges: d } = l;
  if (!i)
    return !0;
  if (u && s) {
    let { from: f, to: h } = l;
  ...
  return n.selection.ranges.forEach((c) => {
    ...
    n.selection.empty ? r.doc.nodesBetween(u, d, (g, y) => {
      o && o === g.type && (a = !0, p = Math.max(y, u), m = Math.min(y + g.nodeSize, d), f = y, h = g);
    }) : r.doc.nodesBetween(u, d, (g, y) => {
      y < u && o && o === g.type && (a = !0, p = Math.max(y, u), m = Math.min(y + g.nodeSize, d), f = y, h = g), y >= u && y <= d && (o && o === g.type && (a = !0, i && n.setNodeMarkup(y, void 0, {
        ...g.attrs,
        ...e
      })), s && g.marks.length && g.marks.forEach((b) => {
        if (s === b.type && (a = !0, i)) {
          const v = Math.max(y, u), k = Math.min(y + g.nodeSize, d);
          n.addMark(
            v,
            k,
            s.create({
...
}, dw = "__tiptap_decorations__", Jn = new se(
  dw
), uw = (t) => ({ tr: e, dispatch: n }) => (n && e.setMeta(Jn, { type: "force", name: t }), !0), fw = (t, e = {}) => ({ state: n, dispatch: r }) => {
  const i = ye(t, n.schema);
  return _y(i, e)(n, r);
}, hw = (t, e = {}) => ({ state: n, dispatch: r }) => {
  const i = ye(t, n.schema);
  return Dy(i, e)(n, r);
...
}, Ip = typeof process < "u" && process.env.NODE_ENV !== "production";
function yw(t) {
...
function _p(t, e) {
  ...
  for (const i of t)
    i.kind === "widget" && yw(i) && r.add(i.key), n.push(i.toPMDecoration(e));
  return { decorations: n, widgetKeys: r };
}
function bw(t, e, n) {
  const { decorations: r, widgetKeys: i } = _p(
    e,
    n
  );
...
function vw({
  ...
  return t.filter((s) => Dp({ position: s.anchor, from: e, to: n, docSize: r }) ? !0 : (s.anchor === n || o.has(i) || (o.add(i), console.warn(
...
function Cw(t, e, n) {
  ...
  return { set: $p(o, n.mapping, n.doc, s), widgetKeys: s };
}
function Fd(t, e) {
...
var Mw = /* @__PURE__ */ new Set(), Ew = class {
  constructor(t) {
    ...
    }, this.editor = t.editor, this.entries = this.resolveEntries(t.entries), this.entries.forEach(({ name: e, spec: n }) => Aw(e, n)), this.plugin = this.entries.length > 0 ? this.createPlugin() : null, this.editor.on("beforeTransaction", this.handleBeforeTransaction);
  }
  destroy() {
  ...
  liveWidgetKeys() {
    var t, e;
    return (e = (t = Jn.getState(this.editor.state)) == null ? void 0 : t.widgetKeys) != null ? e : Mw;
  }
  /**
  ...
  createPlugin() {
    ...
    return new re({
      ...
      state: {
        ...
        apply: (n, r, i, o) => {
          const s = n.getMeta(Jn), l = s?.type === "force" && !s.name, a = s?.type === "force" ? s.name : void 0, c = {}, u = {}, d = /* @__PURE__ */ new Set();
          if (pw(t, () => {
            for (const { name: h, spec: p } of e) {
              ...
              if (Tw(
                ...
                if (p.update === "changedRanges" && n.docChanged && !m) {
                  ...
                  c[h] = y.set, u[h] = y.widgetKeys, d.add(h);
                } else {
                ...
                const y = Cw(h, r, n);
                c[h] = y.set, u[h] = y.widgetKeys;
              }
            }
          }), d.size === 0 && !n.docChanged)
            return r;
  ...
  rebuildRanges(t, e, n, r, i, o) {
    ...
    let u = $p(a, r.mapping, r.doc, c);
    const d = i.doc.content.size;
    for (const { from: f, to: h } of o) {
      const p = u.find(f, h).filter((b) => Dp({ position: b.from, from: f, to: h, docSize: d }));
      for (const b of p) {
        const v = Pp(b);
        v && c.delete(v);
      }
  ...
  warnDuplicateWidgetKeys(t) {
    ...
    const e = ww(t.mergedDecorationSet), n = new Set(e.map(({ key: r }) => r));
...
var Vw = {};
Ga(Vw, {
  createAtomBlockMarkdownSpec: () => Nw,
  createBlockMarkdownSpec: () => Iw,
  createInlineMarkdownSpec: () => Pw,
  parseAttributes: () => tc,
  ...
  return {
    ...
    markdownTokenizer: {
      ...
      tokenize(d, f, h) {
        ...
        const x = y.length;
        let w = "";
        const S = /^:::([\w-]*)(\s.*)?/gm, C = d.slice(x);
        for (S.lastIndex = 0; ; ) {
          const O = S.exec(C);
          if (O === null)
            break;
          const _ = O.index, I = O[1];
          if (!((p = O[2]) != null && p.endsWith(":::"))) {
            if (I)
              ...
              const U = C.slice(0, _);
              w = U.trim();
              const B = d.slice(0, x + _ + O[0].length);
              let j = [];
              if (w)
                if (l === "block")
                  for (j = h.blockTokens(U), j.forEach((K) => {
    ...
    renderMarkdown: (d, f) => {
      const h = u(d.attrs || {}), p = o(h), m = p ? ` {${p}}` : "", g = f.renderChildren(d.content || [], `
...
function Pw(t) {
  const {
    ...
    name: n,
    getContent: r,
    parseAttributes: i = _w,
    serializeAttributes: o = Dw,
    defaultAttributes: s = {},
    selfClosing: l = !1,
    allowedAttributes: a
  } = t, c = n || e, u = (f) => {
...
`;
    ...
    for (u += 1; u < l.length; ) {
      const x = l[u];
      if (x.trim() === "") {
        const S = l.slice(u + 1).findIndex((_) => _.trim() !== "");
        if (S === -1)
          break;
...
function Bp(t, e) {
  ...
  return Hi(t) && Hi(e) && Object.keys(e).forEach((r) => {
    Hi(e[r]) && Hi(t[r]) ? n[r] = Bp(t[r], e[r]) : n[r] = e[r];
  }), n;
}
function zw(t, e, n = {}) {
  const { state: r } = e, { doc: i, tr: o } = r, s = t;
  i.descendants((l, a) => {
    const c = o.mapping.map(a), u = o.mapping.map(a) + l.nodeSize;
    let d = null;
...
function Ri(t) {
  ...
  return s.forEach((f) => {
    ...
    if (p > 0) {
      const w = c.parentOffset - p;
      if (w < 0 || c.parent.textBetween(w, c.parentOffset) !== h[0].slice(0, p))
        return;
    }
    const m = a.state.tr, g = fs({
      ...
      to: i
    }, { commands: b, chain: v, can: k } = new rr({
      editor: n,
      state: g
    });
    f.handler({
  ...
  const { editor: e, rules: n } = t, r = new re({
    state: {
      ...
      apply(i, o, s) {
        ...
        return !!a && setTimeout(() => {
          let { text: u } = a;
          typeof u == "string" ? u = u : u = Za(A.from(u), s.schema);
...
function Uw(t) {
  const { editor: e, state: n, from: r, to: i, rule: o, pasteEvent: s, dropEvent: l } = t, { commands: a, chain: c, can: u } = new rr({
    editor: e,
    state: n
  }), d = [];
  return n.doc.nodesBetween(r, i, (h, p) => {
    ...
    if ((g = (m = h.type) == null ? void 0 : m.spec) != null && g.code || !(h.isText || h.isTextblock || h.isInline))
      return;
    const k = (v = (b = (y = h.content) == null ? void 0 : y.size) != null ? b : h.nodeSize) != null ? v : 0, x = Math.max(r, p), w = Math.min(i, p + k);
    if (x >= w)
      return;
    const S = h.isText ? h.text || "" : h.textBetween(x - p, w - p, void 0, "￼");
    Fw(S, o.find, s).forEach((O) => {
      if (O.index === void 0)
        return;
      const _ = x + O.index + 1, I = _ + O[0].length, U = {
...
function jw(t) {
  ...
  return n.map((u) => new re({
    ...
    appendTransaction: (d, f, h) => {
      const p = d[0], m = p.getMeta("uiEvent") === "paste" && !i, g = p.getMeta("uiEvent") === "drop" && !o, y = p.getMeta("applyPasteRules"), b = !!y;
      if (!m && !g && !b)
        return;
      if (b) {
        let { text: x } = y;
        typeof x == "string" ? x = x : x = Za(A.from(x), h.schema);
        const { from: w } = y, S = w + x.length, C = Ww(x);
        return a({
          rule: u,
          state: h,
          from: w,
...
var bs = class {
  constructor(t, e) {
    this.splittableMarks = [], this.nonClearableMarks = [], this.decorationManager = null, this.editor = e, this.baseExtensions = t, this.extensions = Ya(t), this.schema = Tp(this.extensions, e), this.setupExtensions();
  }
  /**
  ...
  get plugins() {
    const { editor: t } = this, n = _r([...this.extensions].reverse()).flatMap((i) => {
      ...
      if (zd(i, t.options.enableInputRules) && u) {
        const h = u();
        if (h && h.length) {
          const p = Bw({
            editor: t,
      ...
      if (zd(i, t.options.enablePasteRules) && d) {
        const h = d();
        if (h && h.length) {
          const p = jw({ editor: t, rules: h });
          s.push(...p);
        }
      }
      const f = D(
  ...
  createDecorationPlugin() {
    ...
    }), this.decorationManager = new Ew({ editor: e, entries: n }), this.decorationManager.plugin;
  }
  /**
  ...
  setupExtensions() {
    ...
    this.editor.extensionStorage = Object.fromEntries(
      ...
      const o = D(
        ...
        "onTransaction",
        i
      ), u = D(e, "onFocus", i), d = D(e, "onBlur", i), f = D(e, "onDestroy", i);
      o && this.editor.on("beforeCreate", o), s && this.editor.on("create", s), l && this.editor.on("update", l), a && this.editor.on("selectionUpdate", a), c && this.editor.on("transaction", c), u && this.editor.on("focus", u), d && this.editor.on("blur", d), f && this.editor.on("destroy", f);
    });
  }
};
bs.resolve = Ya;
...
Ga(Kw, {
  ...
  Tabindex: () => em,
  TextDirection: () => tm,
  focusEventsPluginKey: () => Xp
});
var J = class Wp extends ic {
  constructor() {
        ...
        props: {
          clipboardTextSerializer: () => {
            ...
            return [...i.ranges].sort((c, u) => c.$from.pos - u.$from.pos).map(
              ({ $from: c, $to: u }) => Mp(r, { from: c.pos, to: u.pos }, l)
            ).join(s ?? `
  ...
  onUpdate({ transaction: t, appendedTransactions: e }) {
    ...
    const o = () => {
      ...
      u.steps.forEach((h, p) => {
        var m, g;
        if (h instanceof Qe) {
          const y = f.slice(p).map(h.from, -1), b = f.slice(p).map(h.to), v = f.invert().map(y, -1), k = f.invert().map(b), x = y > 0 ? (m = u.doc.nodeAt(y - 1)) == null ? void 0 : m.marks.some((S) => S.eq(h.mark)) : !1, w = (g = u.doc.nodeAt(b)) == null ? void 0 : g.marks.some((S) => S.eq(h.mark));
          this.editor.emit("delete", {
            type: "mark",
            mark: h.mark,
            from: h.from,
...
}), Xp = new se("focusEvents"), Zp = J.create({
  name: "focusEvents",
  addProseMirrorPlugins() {
    const { editor: t } = this;
    return [
...
.ProseMirror-focused .ProseMirror-gapcursor {
  ...
  constructor(e = {}) {
    super(), this.css = null, this.className = "tiptap", this.editorView = null, this.isFocused = !1, this.destroyed = !1, this.isInitialized = !1, this.extensionStorage = {}, this.instanceId = Math.random().toString(36).slice(2, 9), this.hasWarnedStaleDecorationRead = !1, this.options = {
      ...
      getUpdatedPosition: Fv,
      createMappablePosition: Uv
    ...
    qw(this.schema), this.options.element && this.mount(this.options.element);
  }
  /**
   ...
   */
  injectCSS() {
    this.options.injectCSS && typeof document < "u" && (this.css = Ow(Jw, this.options.injectNonce));
  }
  /**
   ...
   */
  get state() {
    return Ip && !this.hasWarnedStaleDecorationRead && mw(this) && (this.hasWarnedStaleDecorationRead = !0, console.warn(
   ...
   */
  registerPlugin(e, n) {
    const r = Cp(n) ? n(e, [...this.state.plugins]) : [...this.state.plugins, e], i = this.state.reconfigure({ plugins: r });
  ...
  dispatchTransaction(e) {
    ...
    a && this.emit("focus", {
      ...
      // oxlint-disable-next-lineno-non-null-assertion
      transaction: l
    }), !(e.getMeta("preventUpdate") || !r.some((u) => u.docChanged) || s.doc.eq(n.doc)) && this.emit("update", {
      editor: this,
      transaction: e,
      appendedTransactions: r.slice(1)
    });
...
function hr(t) {
  return new Ci({
    ...
    handler: ({ state: e, range: n, match: r, chain: i }) => {
      ...
      u && u.type === t.type && hn(s.doc, n.from - 1) && (!t.joinPredicate || t.joinPredicate(r, u)) && s.join(n.from - 1);
    },
    undoable: t.undoable
  });
}
var Zw = (t) => "touches" in t, Yw = class {
  /**
  ...
  handleResizeStart(t, e) {
    t.preventDefault(), t.stopPropagation(), this.isResizing = !0, this.activeHandle = e, Zw(t) ? (this.startX = t.touches[0].clientX, this.startY = t.touches[0].clientY) : (this.startX = t.clientX, this.startY = t.clientY), this.startWidth = this.element.offsetWidth, this.startHeight = this.element.offsetHeight, this.startWidth > 0 && this.startHeight > 0 && (this.aspectRatio = this.startWidth / this.startHeight), this.getPos(), this.container.dataset.resizeState = "true", this.classNames.resizing && this.container.classList.add(this.classNames.resizing), document.addEventListener("mousemove", this.handleMouseMove), document.addEventListener("touchmove", this.handleTouchMove), document.addEventListener("mouseup", this.handleMouseUp), document.addEventListener("keydown", this.handleKeyDown), document.addEventListener("keyup", this.handleKeyUp);
  }
  handleResize(t, e) {
  ...
  onDragStart(t) {
    ...
    let d = 0, f = 0;
    if (this.dom !== u) {
      const b = this.dom.getBoundingClientRect(), v = u.getBoundingClientRect(), k = (i = t.offsetX) != null ? i : (r = t.nativeEvent) == null ? void 0 : r.offsetX, x = (s = t.offsetY) != null ? s : (o = t.nativeEvent) == null ? void 0 : o.offsetY;
      d = v.x - b.x + k, f = v.y - b.y + x;
    }
  ...
  stopEvent(t) {
    ...
    if ((["INPUT", "BUTTON", "SELECT", "TEXTAREA"].includes(n.tagName) || n.isContentEditable) && !s && !i)
      return !0;
    const { isEditable: a } = this.editor, { isDragging: c } = this, u = !!this.node.type.spec.draggable, d = z.isSelectable(this.node), f = t.type === "copy", h = t.type === "paste", p = t.type === "cut", m = t.type === "mousedown";
    if (!u && d && i && t.target === this.dom && t.preventDefault(), u && i && !c && t.target === this.dom)
  ...
  return new Up({
    ...
    handler: ({ state: e, range: n, match: r, pasteEvent: i }) => {
      ...
      if (l) {
        ...
        if (ec(n.from, n.to, e.doc).filter((m) => m.mark.type.excluded.find((y) => y === t.type && y !== m.mark.type)).filter((m) => m.to > d).length)
          return null;
        f < n.to && s.delete(f, n.to), d > n.from && s.delete(n.from + u, d), c = n.from + u + l.length, s.addMark(n.from + u, c, t.type.create(o || {})), r.index !== void 0 && r.input !== void 0 && r.index + r[0].length >= r.input.length || s.removeStoredMark(t.type);
      }
    }
  });
}
...
var im = te({
  ...
  constructor(t, { props: e = {}, editor: n }) {
    this.destroyed = !1, this.editor = n, this.component = Of(t), this.el = document.createElement("div"), this.props = Jr(e), this.renderedComponent = this.renderComponent();
  }
  get element() {
...
var om = {
  ...
  mount() {
    ...
    this.handleSelectionUpdate = this.handleSelectionUpdate.bind(this), this.editor.on("selectionUpdate", this.handleSelectionUpdate), this.currentPos = this.getPos(), this.node.isLeaf || (this.options.contentDOMElementTag ? this.contentDOMElement = document.createElement(this.options.contentDOMElementTag) : this.contentDOMElement = document.createElement(this.node.isInline ? "span" : "div"), this.contentDOMElement.style.whiteSpace = "inherit", this.contentDOMElement.dataset.nodeViewContentVue = ""), this.renderer = new nk(r, {
      editor: this.editor,
      props: e
    });
  }
...
const lm = "en", Wl = 200, ik = Wl - 80, Kd = 20, qd = 1e5, Gd = 16, Ni = 6, Ii = 10, _i = 2, ok = [
  "#f44336",
  "#e91e63",
  "#9c27b0",
  "#673ab7",
...
], lk = [8, 10, 12, 14, 16, 18, 20, 24, 30, 36, 48, 60, 72], Kn = "default";
...
var am = typeof global == "object" && global && global.Object === Object && global, dk = typeof self == "object" && self && self.Object === Object && self, bt = am || dk || Function("return this")(), ht = bt.Symbol, cm = Object.prototype, uk = cm.hasOwnProperty, fk = cm.toString, Ar = ht ? ht.toStringTag : void 0;
function hk(t) {
  var e = uk.call(t, Ar), n = t[Ar];
  try {
    t[Ar] = void 0;
    var r = !0;
  } catch {
...
var pk = Object.prototype, mk = pk.toString;
function gk(t) {
  return mk.call(t);
}
var yk = "[object Null]", bk = "[object Undefined]", Xd = ht ? ht.toStringTag : void 0;
function wr(t) {
  return t == null ? t === void 0 ? bk : yk : Xd && Xd in Object(t) ? hk(t) : gk(t);
}
function Vn(t) {
...
function ws(t) {
  return typeof t == "symbol" || Vn(t) && wr(t) == vk;
}
function dm(t, e) {
...
var wk = /\s/;
function kk(t) {
  for (var e = t.length; e-- && wk.test(t.charAt(e)); )
    ;
  return e;
}
var xk = /^\s+/;
function Sk(t) {
  return t && t.slice(0, kk(t) + 1).replace(xk, "");
}
function Nn(t) {
  var e = typeof t;
  return t != null && (e == "object" || e == "function");
}
var Qd = NaN, Ck = /^[-+]0x[0-9a-f]+$/i, Ak = /^0b[01]+$/i, Tk = /^0o[0-7]+$/i, Mk = parseInt;
function eu(t) {
  if (typeof t == "number")
    return t;
  if (ws(t))
  ...
  t = Sk(t);
  var n = Ak.test(t);
  return n || Tk.test(t) ? Mk(t.slice(2), n ? 2 : 8) : Ck.test(t) ? Qd : +t;
}
function oc(t) {
  return t;
}
var Ek = "[object AsyncFunction]", Lk = "[object Function]", Ok = "[object GeneratorFunction]", Hk = "[object Proxy]";
function fm(t) {
  if (!Nn(t))
    return !1;
  var e = wr(t);
  return e == Lk || e == Ok || e == Ek || e == Hk;
}
...
var Vk = Function.prototype, Nk = Vk.toString;
function Bn(t) {
  if (t != null) {
    try {
      return Nk.call(t);
...
var Ik = /[\\^$.*+?()[\]{}|]/g, _k = /^\[object .+?Constructor\]$/, Dk = Function.prototype, Pk = Object.prototype, zk = Dk.toString, $k = Pk.hasOwnProperty, Bk = RegExp(
  "^" + zk.call($k).replace(Ik, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"
);
function Fk(t) {
  if (!Nn(t) || Rk(t))
    return !1;
...
function hm(t, e) {
  var n = typeof t;
  return e = e ?? rx, !!e && (n == "number" || n != "symbol" && ix.test(t)) && t > -1 && t % 1 == 0 && t < e;
}
function pm(t, e) {
  return t === e || t !== t && e !== e;
}
...
function ox(t, e, n) {
  return e = ru(e === void 0 ? t.length - 1 : e, 0), function() {
    ...
    for (var l = Array(e + 1); ++i < e; )
      l[i] = r[i];
    return l[e] = n(s), Wk(t, this, l);
  };
}
function sx(t, e) {
  return Zk(ox(t, e, oc), t + "");
}
var lx = 9007199254740991;
function sc(t) {
  return typeof t == "number" && t > -1 && t % 1 == 0 && t <= lx;
}
function mm(t) {
  return t != null && sc(t.length) && !fm(t);
}
var ax = Object.prototype;
function cx(t) {
  var e = t && t.constructor, n = typeof e == "function" && e.prototype || ax;
  return t === n;
}
function dx(t, e) {
...
var ux = "[object Arguments]";
function iu(t) {
  return Vn(t) && wr(t) == ux;
}
var gm = Object.prototype, fx = gm.hasOwnProperty, hx = gm.propertyIsEnumerable, lc = iu(/* @__PURE__ */ function() {
  return arguments;
}()) ? iu : function(t) {
  return Vn(t) && fx.call(t, "callee") && !hx.call(t, "callee");
};
function px() {
  return !1;
}
var ym = typeof exports == "object" && exports && !exports.nodeType && exports, ou = ym && typeof module == "object" && module && !module.nodeType && module, mx = ou && ou.exports === ym, su = mx ? bt.Buffer : void 0, gx = su ? su.isBuffer : void 0, ql = gx || px, yx = "[object Arguments]", bx = "[object Array]", vx = "[object Boolean]", wx = "[object Date]", kx = "[object Error]", xx = "[object Function]", Sx = "[object Map]", Cx = "[object Number]", Ax = "[object Object]", Tx = "[object RegExp]", Mx = "[object Set]", Ex = "[object String]", Lx = "[object WeakMap]", Ox = "[object ArrayBuffer]", Hx = "[object DataView]", Rx = "[object Float32Array]", Vx = "[object Float64Array]", Nx = "[object Int8Array]", Ix = "[object Int16Array]", _x = "[object Int32Array]", Dx = "[object Uint8Array]", Px = "[object Uint8ClampedArray]", zx = "[object Uint16Array]", $x = "[object Uint32Array]", le = {};
le[Rx] = le[Vx] = le[Nx] = le[Ix] = le[_x] = le[Dx] = le[Px] = le[zx] = le[$x] = !0;
le[yx] = le[bx] = le[Ox] = le[vx] = le[Hx] = le[wx] = le[kx] = le[xx] = le[Sx] = le[Cx] = le[Ax] = le[Tx] = le[Mx] = le[Ex] = le[Lx] = !1;
function Bx(t) {
...
var vm = typeof exports == "object" && exports && !exports.nodeType && exports, Dr = vm && typeof module == "object" && module && !module.nodeType && module, Fx = Dr && Dr.exports === vm, Qs = Fx && am.process, lu = function() {
  try {
    var t = Dr && Dr.require && Dr.require("util").types;
    return t || Qs && Qs.binding && Qs.binding("util");
  } catch {
  }
}(), au = lu && lu.isTypedArray, wm = au ? bm(au) : Bx, Ux = Object.prototype, Wx = Ux.hasOwnProperty;
function jx(t, e) {
  var n = pt(t), r = !n && lc(t), i = !n && !r && ql(t), o = !n && !r && !i && wm(t), s = n || r || i || o, l = s ? dx(t.length, String) : [], a = l.length;
  for (var c in t)
    Wx.call(t, c) && !(s && // Safari 9 has enumerable `arguments.length` in strict mode.
...
var qx = Kx(Object.keys, Object), Gx = Object.prototype, Jx = Gx.hasOwnProperty;
function Xx(t) {
  if (!cx(t))
    return qx(t);
  var e = [];
  for (var n in Object(t))
    Jx.call(t, n) && n != "constructor" && e.push(n);
  return e;
}
function km(t) {
  return mm(t) ? jx(t) : Xx(t);
}
var Zx = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, Yx = /^\w*$/;
function ac(t, e) {
  if (pt(t))
    return !1;
  var n = typeof t;
  return n == "number" || n == "symbol" || n == "boolean" || t == null || ws(t) ? !0 : Yx.test(t) || !Zx.test(t) || e != null && t in Object(e);
}
...
var tS = "__lodash_hash_undefined__", nS = Object.prototype, rS = nS.hasOwnProperty;
function iS(t) {
  var e = this.__data__;
  if (li) {
    var n = e[t];
  ...
  return rS.call(e, t) ? e[t] : void 0;
}
var oS = Object.prototype, sS = oS.hasOwnProperty;
function lS(t) {
  var e = this.__data__;
  return li ? e[t] !== void 0 : sS.call(e, t);
}
var aS = "__lodash_hash_undefined__";
function cS(t, e) {
  var n = this.__data__;
  return this.size += this.has(t) ? 0 : 1, n[t] = li && e === void 0 ? aS : e, this;
}
function In(t) {
...
In.prototype.clear = Qx;
In.prototype.delete = eS;
In.prototype.get = iS;
In.prototype.has = lS;
In.prototype.set = cS;
function dS() {
...
function hS(t) {
  ...
  if (n < 0)
    return !1;
  var r = e.length - 1;
  return n == r ? e.pop() : fS.call(e, n, 1), --this.size, !0;
}
function pS(t) {
  var e = this.__data__, n = ks(e, t);
...
Bt.prototype.clear = dS;
Bt.prototype.delete = hS;
Bt.prototype.get = pS;
Bt.prototype.has = mS;
Bt.prototype.set = gS;
var ai = Fn(bt, "Map");
...
function xs(t, e) {
  var n = t.__data__;
  return bS(e) ? n[typeof e == "string" ? "string" : "hash"] : n.map;
}
function vS(t) {
...
Ft.prototype.clear = yS;
Ft.prototype.delete = vS;
Ft.prototype.get = wS;
Ft.prototype.has = kS;
Ft.prototype.set = xS;
...
var TS = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, MS = /\\(\\)?/g, ES = AS(function(t) {
  var e = [];
  return t.charCodeAt(0) === 46 && e.push(""), t.replace(TS, function(n, r, i, o) {
    e.push(i ? o.replace(MS, "$1") : r || n);
  }), e;
});
function LS(t) {
  return t == null ? "" : um(t);
...
function xm(t, e) {
  return pt(t) ? t : ac(t, e) ? [t] : ES(LS(t));
}
function Ss(t) {
...
var BS = Object.prototype, FS = BS.propertyIsEnumerable, du = Object.getOwnPropertySymbols, US = du ? function(t) {
  return t == null ? [] : (t = Object(t), zS(du(t), function(e) {
    return FS.call(t, e);
  }));
} : $S;
function WS(t, e, n) {
  var r = e(t);
  return pt(t) ? r : Cm(r, n(t));
}
function uu(t) {
  return WS(t, km, US);
}
var Gl = Fn(bt, "DataView"), Jl = Fn(bt, "Promise"), Xl = Fn(bt, "Set"), fu = "[object Map]", jS = "[object Object]", hu = "[object Promise]", pu = "[object Set]", mu = "[object WeakMap]", gu = "[object DataView]", KS = Bn(Gl), qS = Bn(ai), GS = Bn(Jl), JS = Bn(Xl), XS = Bn(Kl), Gt = wr;
(Gl && Gt(new Gl(new ArrayBuffer(1))) != gu || ai && Gt(new ai()) != fu || Jl && Gt(Jl.resolve()) != hu || Xl && Gt(new Xl()) != pu || Kl && Gt(new Kl()) != mu) && (Gt = function(t) {
  var e = wr(t), n = e == jS ? t.constructor : void 0, r = n ? Bn(n) : "";
  if (r)
    switch (r) {
      case KS:
        return gu;
...
var yu = bt.Uint8Array, ZS = "__lodash_hash_undefined__";
function YS(t) {
  return this.__data__.set(t, ZS), this;
}
function QS(t) {
  return this.__data__.has(t);
}
...
ci.prototype.add = ci.prototype.push = YS;
ci.prototype.has = QS;
function eC(t, e) {
...
function Tm(t, e, n, r, i, o) {
  var s = n & tC, l = t.length, a = e.length;
  if (l != a && !(s && a > l))
    return !1;
  var c = o.get(t), u = o.get(e);
  if (c && u)
    return c == e && u == t;
  var d = -1, f = !0, h = n & nC ? new ci() : void 0;
  for (o.set(t, e), o.set(e, t); ++d < l; ) {
    ...
    if (h) {
      if (!eC(e, function(y, b) {
        if (!Am(h, b) && (p === y || i(p, y, n, r, o)))
          return h.push(b);
      })) {
        f = !1;
        break;
...
var oC = 1, sC = 2, lC = "[object Boolean]", aC = "[object Date]", cC = "[object Error]", dC = "[object Map]", uC = "[object Number]", fC = "[object RegExp]", hC = "[object Set]", pC = "[object String]", mC = "[object Symbol]", gC = "[object ArrayBuffer]", yC = "[object DataView]", bu = ht ? ht.prototype : void 0, el = bu ? bu.valueOf : void 0;
function bC(t, e, n, r, i, o, s) {
  switch (n) {
    ...
    case hC:
      var a = r & oC;
      if (l || (l = iC), t.size != e.size && !a)
        return !1;
      var c = s.get(t);
      if (c)
        return c == e;
      r |= sC, s.set(t, e);
      var u = Tm(l(t), l(e), r, i, o, s);
      return s.delete(t), u;
    case mC:
      if (el)
...
var vC = 1, wC = Object.prototype, kC = wC.hasOwnProperty;
function xC(t, e, n, r, i, o) {
  var s = n & vC, l = uu(t), a = l.length, c = uu(e), u = c.length;
  if (a != u && !s)
    return !1;
  for (var d = a; d--; ) {
    var f = l[d];
    if (!(s ? f in e : kC.call(e, f)))
      return !1;
  }
  ...
  for (var g = s; ++d < a; ) {
    ...
    var y = t[f], b = e[f];
    if (r)
      var v = s ? r(b, y, f, e, t, o) : r(y, b, f, t, e, o);
  ...
  if (m && !g) {
    var k = t.constructor, x = e.constructor;
    k != x && "constructor" in t && "constructor" in e && !(typeof k == "function" && k instanceof k && typeof x == "function" && x instanceof x) && (m = !1);
  }
  return o.delete(t), o.delete(e), m;
}
var SC = 1, vu = "[object Arguments]", wu = "[object Array]", Di = "[object Object]", CC = Object.prototype, ku = CC.hasOwnProperty;
function AC(t, e, n, r, i, o) {
  var s = pt(t), l = pt(e), a = s ? wu : Gt(t), c = l ? wu : Gt(e);
  a = a == vu ? Di : a, c = c == vu ? Di : c;
  var u = a == Di, d = c == Di, f = a == c;
  if (f && ql(t)) {
    if (!ql(e))
      return !1;
    s = !0, u = !1;
  ...
  if (f && !u)
    return o || (o = new Nt()), s || wm(t) ? Tm(t, e, n, r, i, o) : bC(t, e, a, n, r, i, o);
  if (!(n & SC)) {
    var h = u && ku.call(t, "__wrapped__"), p = d && ku.call(e, "__wrapped__");
    if (h || p) {
      var m = h ? t.value() : t, g = p ? e.value() : e;
      return o || (o = new Nt()), i(m, g, n, r, o);
    }
  }
  return f ? (o || (o = new Nt()), xC(t, e, n, r, i, o)) : !1;
}
function Cs(t, e, n, r, i) {
  return t === e ? !0 : t == null || e == null || !Vn(t) && !Vn(e) ? t !== t && e !== e : AC(t, e, n, r, Cs, i);
}
var TC = 1, MC = 2;
function EC(t, e, n, r) {
  var i = n.length, o = i;
  ...
  for (; ++i < o; ) {
    ...
    if (s[2]) {
      ...
      var u = new Nt(), d;
      if (!(d === void 0 ? Cs(c, a, TC | MC, r, u) : d))
        return !1;
    }
  }
  return !0;
...
function OC(t) {
  var e = LC(t);
  return e.length == 1 && e[0][2] ? Em(e[0][0], e[0][1]) : function(n) {
    return n === t || EC(n, t, e);
  };
}
function HC(t, e) {
...
function RC(t, e, n) {
  ...
  return o || ++r != i ? o : (i = t == null ? 0 : t.length, !!i && sc(i) && hm(s, i) && (pt(t) || lc(t)));
}
function VC(t, e) {
  return t != null && RC(t, e, HC);
}
var NC = 1, IC = 2;
function _C(t, e) {
  return ac(t) && Mm(e) ? Em(Ss(t), e) : function(n) {
    var r = OS(n, t);
    return r === void 0 && r === e ? VC(n, t) : Cs(e, r, NC | IC);
  };
}
function DC(t) {
  return function(e) {
...
function zC(t) {
  return ac(t) ? DC(Ss(t)) : PC(t);
}
function $C(t) {
  return typeof t == "function" ? t : t == null ? oc : typeof t == "object" ? pt(t) ? _C(t[0], t[1]) : OC(t) : zC(t);
}
var tl = function() {
  return bt.Date.now();
}, BC = "Expected a function", FC = Math.max, UC = Math.min;
function WC(t, e, n) {
  var r, i, o, s, l, a, c = 0, u = !1, d = !1, f = !0;
  if (typeof t != "function")
    throw new TypeError(BC);
  e = eu(e) || 0, Nn(n) && (u = !!n.leading, d = "maxWait" in n, o = d ? FC(eu(n.maxWait) || 0, e) : o, f = "trailing" in n ? !!n.trailing : f);
  function h(w) {
    var S = r, C = i;
    return r = i = void 0, c = w, s = t.apply(C, S), s;
  }
  function p(w) {
    return c = w, l = setTimeout(y, e), u ? h(w) : s;
  }
  function m(w) {
    var S = w - a, C = w - c, O = e - S;
    return d ? UC(O, o - C) : O;
  }
  function g(w) {
    var S = w - a, C = w - c;
    return a === void 0 || S >= e || S < 0 || d && C >= o;
  }
  function y() {
    var w = tl();
    if (g(w))
  ...
  function b(w) {
    return l = void 0, f && r ? h(w) : (r = i = void 0, s);
  }
  function v() {
...
var jC = 200;
function KC(t, e, n, r) {
  var i = -1, o = nx, s = !0, l = t.length, a = [], c = e.length;
  if (!l)
    return a;
  n && (e = dm(e, bm(n))), e.length >= jC && (o = Am, s = !1, e = new ci(e));
  e:
    for (; ++i < l; ) {
...
var GC = sx(function(t, e) {
  var n = qC(e);
  return nl(n) && (n = void 0), nl(t) ? KC(t, RS(e, 1, nl), $C(n)) : [];
});
function JC(t, e) {
  return Cs(t, e);
}
...
function Pr(t, e, n) {
  ...
  return Nn(n) && (r = "leading" in n ? !!n.leading : r, i = "trailing" in n ? !!n.trailing : i), WC(t, e, {
    leading: r,
    maxWait: e,
    trailing: i
  });
...
const Zl = (t) => typeof t == "number", zr = (t) => typeof t == "string", pr = (t) => typeof t == "boolean", YC = (t) => typeof t == "function", $r = (t, e = "px") => {
  if (!t) return t;
...
const ir = /* @__PURE__ */ new WeakMap(), eA = (...t) => {
  var e;
  const n = t[0], r = (e = is()) == null ? void 0 : e.proxy;
  if (r == null)
    throw new Error("injectLocal must be called in setup");
  return ir.has(r) && n in ir.get(r) ? ir.get(r)[n] : A1(...t);
}, tA = (t, e) => {
  var n;
...
const rA = Object.prototype.toString, iA = (t) => rA.call(t) === "[object Object]", oA = () => {
}, sA = Rm ? window : void 0, lA = Rm ? window.document : void 0;
function Yl(t) {
  var e;
  const n = Hm(t);
...
function xu(...t) {
  let e, n, r, i;
  if (typeof t[0] == "string" || Array.isArray(t[0]) ? ([n, r, i] = t, e = sA) : [e, n, r, i] = t, !e)
    return oA;
  Array.isArray(n) || (n = [n]), Array.isArray(r) || (r = [r]);
  const o = [], s = () => {
    o.forEach((u) => u()), o.length = 0;
  }, l = (u, d, f, h) => (u.addEventListener(d, f, h), () => u.removeEventListener(d, f, h)), a = _t(
    () => [Yl(e), Hm(i)],
    ([u, d]) => {
      if (s(), !u)
        return;
...
function dA(t, e = {}) {
  const {
    ...
    "msFullscreenElement"
  ].find((y) => n && y in n), u = cA(() => i.value && n && s.value !== void 0 && l.value !== void 0 && a.value !== void 0), d = () => c ? n?.[c] === i.value : !1, f = () => {
    if (a.value) {
      if (n && n[a.value] != null)
        return n[a.value];
      {
  ...
  return xu(n, Su, g, !1), xu(() => Yl(i), Su, g, !1), r && Om(h), {
    isSupported: u,
    isFullscreen: o,
    enter: p,
    exit: h,
...
class vA {
  ...
  set lang(e) {
    if (!this.isLangSupported(e)) {
      Vm.warn(`Can't find the current language "${e}", Using language "${Zn.lang}" by default`);
      return;
    }
...
}, Nm = ["top", "right", "bottom", "left"], Au = ["start", "end"], Tu = /* @__PURE__ */ Nm.reduce((t, e) => t.concat(e, e + "-" + Au[0], e + "-" + Au[1]), []), mt = Math.min, tt = Math.max, ko = Math.round, It = (t) => ({
  x: t,
  y: t
}), wA = {
  left: "right",
...
const Mu = ["left", "right"], Eu = ["right", "left"], xA = ["top", "bottom"], SA = ["bottom", "top"];
function CA(t, e, n) {
  switch (t) {
    case "top":
    case "bottom":
      return n ? e ? Eu : Mu : e ? Mu : Eu;
    case "left":
    case "right":
      return e ? xA : SA;
    default:
...
function Lu(t, e, n) {
  ...
  const o = ct(e), s = fc(e), l = uc(s), a = rt(e), c = o === "y", u = r.x + r.width / 2 - i.width / 2, d = r.y + r.height / 2 - i.height / 2, f = r[l] / 2 - i[l] / 2;
  let h;
  switch (a) {
    case "top":
      h = {
...
async function MA(t, e) {
  ...
  const {
    ...
    altBoundary: f = !1,
    padding: h = 0
  } = Wt(e, t), p = hc(h), g = l[f ? d === "floating" ? "reference" : "floating" : d], y = an(await o.getClippingRect({
  ...
  } : s.reference, v = await (o.getOffsetParent == null ? void 0 : o.getOffsetParent(l.floating)), k = await (o.isElement == null ? void 0 : o.isElement(v)) && await (o.getScale == null ? void 0 : o.getScale(v)) || {
    x: 1,
    y: 1
  ...
  return {
    top: (y.top - x.top + p.top) / k.y,
    bottom: (x.bottom - y.bottom + p.bottom) / k.y,
    left: (y.left - x.left + p.left) / k.x,
    right: (x.right - y.right + p.right) / k.x
  };
}
const EA = 50, LA = async (t, e, n) => {
  const {
    placement: r = "bottom",
    strategy: i = "absolute",
    middleware: o = [],
  ...
  for (let m = 0; m < o.length; m++) {
    ...
    u = v ?? u, d = k ?? d, p[y] = {
      ...p[y],
      ...x
    }, w && h < EA && (h++, typeof w == "object" && (w.placement && (f = w.placement), w.rects && (c = w.rects === !0 ? await s.getElementRects({
      reference: t,
      floating: e,
      strategy: i
    }) : w.rects), {
  ...
  async fn(e) {
    ...
    const d = hc(u), f = {
      x: n,
      y: r
    }, h = fc(i), p = uc(h), m = await s.getDimensions(c), g = h === "y", y = g ? "top" : "left", b = g ? "bottom" : "right", v = g ? "clientHeight" : "clientWidth", k = o.reference[p] + o.reference[h] - f[h] - o.floating[p], x = f[h] - o.reference[h], w = await (s.getOffsetParent == null ? void 0 : s.getOffsetParent(c));
    let S = w ? w[v] : 0;
    (!S || !await (s.isElement == null ? void 0 : s.isElement(w))) && (S = l.floating[v] || o.floating[p]);
    const C = k / 2 - x / 2, O = S / 2 - m[p] / 2 - 1, _ = mt(d[y], O), I = mt(d[b], O), U = S - m[p] - I, B = S / 2 - m[p] / 2 + C, j = Im(_, B, U), K = !a.arrow && nt(i) != null && B !== j && o.reference[p] / 2 - (B < _ ? _ : I) - m[p] / 2 < 0, V = K ? B < _ ? B - _ : B - U : 0;
    return {
      [h]: f[h] + V,
      data: {
        [h]: j,
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      const {
        ...
        crossAxis: u = !1,
        alignment: d,
        allowedPlacements: f = Tu,
        autoAlignment: h = !0,
        ...p
      } = Wt(t, e), m = d !== void 0 || f === Tu ? HA(d || null, h, f) : f, g = ((n = s.autoPlacement) == null ? void 0 : n.index) || 0, y = m[g];
      if (y == null)
        return {};
      if (l !== y)
        return {
      ...
      const b = await a.detectOverflow(e, p), v = Dm(y, o, await (a.isRTL == null ? void 0 : a.isRTL(c.floating))), k = [b[rt(y)], b[v[0]], b[v[1]]], x = [...((r = s.autoPlacement) == null ? void 0 : r.overflows) || [], {
        placement: y,
        overflows: k
      }], w = m[g + 1];
      if (w)
      ...
      const S = x.map((_) => {
        ...
        return [_.placement, I && u ? (
          // Check along the mainAxis and main crossAxis side.
          _.overflows.slice(0, 2).reduce((U, B) => U + B, 0)
        ) : (
          // Check only the mainAxis.
          _.overflows[0]
        ), _.overflows];
      }).sort((_, I) => _[1] - I[1]), O = ((i = S.filter((_) => _[2].slice(
        0,
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      ...
      if ((n = o.arrow) != null && n.alignmentOffset)
        return {};
      const y = rt(i), b = ct(l), v = rt(l) === l, k = await (a.isRTL == null ? void 0 : a.isRTL(c.floating)), x = f || (v || !m ? [So(l)] : kA(l)), w = p !== "none";
      !f && w && x.push(...AA(l, m, p, k));
      const S = [l, ...x], C = await a.detectOverflow(e, g), O = [];
      ...
      if (_ = [..._, {
        ...
        if (K && (!(d === "alignment" ? b !== ct(K) : !1) || // We leave the current main axis only if every placement on that axis
        ...
        let V = (U = _.filter((X) => X.overflows[0] <= 0).sort((X, P) => X.overflows[1] - P.overflows[1])[0]) == null ? void 0 : U.placement;
        if (!V)
          switch (h) {
            case "bestFit": {
              var B;
              const X = (B = _.filter((P) => {
                if (w) {
                ...
                return !0;
              }).map((P) => [P.placement, P.overflows.filter((G) => G > 0).reduce((G, Ie) => G + Ie, 0)]).sort((P, G) => P[1] - G[1])[0]) == null ? void 0 : B[0];
              X && (V = X);
              break;
            }
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      const {
        ...
        x: a,
        y: c
      } = Wt(t, e), u = Array.from(await (o.getClientRects == null ? void 0 : o.getClientRects(r.reference)) || []);
      if (!u.length)
        return {};
      const d = IA(u), f = an(Pm(u)), h = hc(l);
      function p() {
        if (d.length === 2 && (d[0].left > d[1].right || d[1].left > d[0].right) && a != null && c != null)
          return d.find((g) => a > g.left - h.left && a < g.right + h.right && c > g.top - h.top && c < g.bottom + h.bottom) || f;
        if (d.length >= 2) {
          if (ct(n) === "y") {
            const w = d[0], S = d[d.length - 1], C = rt(n) === "top", O = w.top, _ = S.bottom, I = C ? w.left : S.left, U = C ? w.right : S.right;
            return an({
              x: I,
              y: O,
              width: U - I,
          ...
          const g = rt(n) === "left", y = tt(...d.map((w) => w.right)), b = mt(...d.map((w) => w.left)), v = d.filter((w) => g ? w.left === b : w.right === y), k = v[0].top, x = v[v.length - 1].bottom;
          return an({
            x: b,
            y: k,
            width: y - b,
...
async function PA(t, e) {
  const {
    ...
    platform: r,
    elements: i
  } = t, o = await (r.isRTL == null ? void 0 : r.isRTL(i.floating)), s = rt(n), l = nt(n), a = ct(n) === "y", c = DA.has(s) ? -1 : 1, u = o && a ? -1 : 1, d = Wt(e, t);
  let {
    mainAxis: f,
    crossAxis: h,
    alignmentAxis: p
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      const {
        ...
        x: n,
        y: r
      }, d = await o.detectOverflow(e, c), f = ct(i), h = _m(f);
      let p = u[h], m = u[f];
      const g = (b, v) => Im(v + d[b === "y" ? "top" : "left"], v, v - d[b === "y" ? "bottom" : "right"]);
      s && (p = g(h, p)), l && (m = g(f, m));
      const y = a.fn({
        ...e,
        [h]: p,
  ...
  return t === void 0 && (t = {}), {
    ...
    async fn(e) {
      const {
        ...
        ...l
      } = Wt(t, e), a = await i.detectOverflow(e, l), c = rt(n), u = nt(n), d = ct(n) === "y", {
        width: f,
        height: h
      } = r.floating;
      let p, m;
      c === "top" || c === "bottom" ? (p = c, m = u === (await (i.isRTL == null ? void 0 : i.isRTL(o.floating)) ? "start" : "end") ? "left" : "right") : (m = c, p = u === "end" ? "top" : "bottom");
      const g = h - a.top - a.bottom, y = f - a.left - a.right, b = mt(h - a[p], g), v = mt(f - a[m], y), k = e.middlewareData.shift, x = !k;
      let w = b, S = v;
      k != null && k.enabled.x && (S = y), k != null && k.enabled.y && (w = g), x && !u && (d ? S = f - 2 * tt(a.left, a.right) : w = h - 2 * tt(a.top, a.bottom)), await s({
        ...e,
        availableWidth: S,
        availableHeight: w
      });
...
function kr(t) {
  return zm(t) ? (t.nodeName || "").toLowerCase() : "#document";
}
function We(t) {
  var e;
...
function mn(t) {
  var e;
  return (e = (zm(t) ? t.ownerDocument : t.document) || window.document) == null ? void 0 : e.documentElement;
}
function zm(t) {
...
const UA = /transform|translate|scale|rotate|perspective|filter/, WA = /paint|layout|strict|content/, yn = (t) => !!t && t !== "none";
let rl;
function pc(t) {
  const e = gt(t) ? yt(t) : t;
  return yn(e.transform) || yn(e.translate) || yn(e.scale) || yn(e.rotate) || yn(e.perspective) || !mc() && (yn(e.backdropFilter) || yn(e.filter)) || UA.test(e.willChange || "") || WA.test(e.contain || "");
}
function jA(t) {
  let e = _n(t);
  for (; gn(e) && !di(e); ) {
...
function $m(t) {
  const e = _n(t);
  return di(e) ? (t.ownerDocument || t).body : gn(e) && Ts(e) ? e : $m(e);
}
function Bm(t, e, n) {
  var r;
  e === void 0 && (e = []);
  const i = $m(t), o = i === ((r = t.ownerDocument) == null ? void 0 : r.body), s = We(i);
  return o ? (ea(s), e.concat(s, s.visualViewport || [], Ts(i) ? i : [], [])) : e.concat(i, Bm(i, []));
}
function ea(t) {
...
const KA = /* @__PURE__ */ It(0);
function Wm(t) {
  const e = We(t);
  return !mc() || !e.visualViewport ? KA : {
...
function ui(t, e, n, r) {
  ...
  const i = t.getBoundingClientRect(), o = Um(t);
  let s = It(1);
  e && (r ? gt(r) && (s = or(r)) : s = or(t));
  const l = qA(o, n, r) ? Wm(o) : It(0);
  let a = (i.left + l.x) / s.x, c = (i.top + l.y) / s.y, u = i.width / s.x, d = i.height / s.y;
  if (o && r) {
    const f = We(o), h = gt(r) ? We(r) : r;
    let p = f, m = ea(p);
    for (; m && h !== p; ) {
      const g = or(m), y = m.getBoundingClientRect(), b = yt(m), v = y.left + (m.clientLeft + parseFloat(b.paddingLeft)) * g.x, k = y.top + (m.clientTop + parseFloat(b.paddingTop)) * g.y;
      a *= g.x, c *= g.y, u *= g.x, d *= g.y, a += v, c += k, p = We(m), m = ea(p);
    }
  }
  return an({
    width: u,
...
function GA(t) {
  ...
  const u = It(0), d = gn(r);
  if ((d || !o) && ((kr(r) !== "body" || Ts(s)) && (a = Es(r)), d)) {
    const h = ui(r);
    c = or(r), u.x = h.x + r.clientLeft, u.y = h.y + r.clientTop;
  }
  const f = s && !d && !o ? jm(s, a) : It(0);
  return {
    width: n.width * c.x,
    height: n.height * c.y,
...
function YA(t, e, n) {
  ...
  let l = o.clientWidth, a = o.clientHeight, c = 0, u = 0;
  if (s) {
    const f = !mc() || e === "fixed";
    r ? f || (c = -s.offsetLeft, u = -s.offsetTop) : (l = s.width, a = s.height, f && (c = s.offsetLeft, u = s.offsetTop));
  }
  if (Ls(o) <= 0) {
...
function eT(t, e) {
  ...
  if (n)
    return n;
  let r = Bm(t, []).filter((l) => gt(l) && kr(l) !== "body"), i = null;
  const o = yt(t).position === "fixed";
  let s = o ? _n(t) : t;
  for (; gt(s) && !di(s); ) {
    const l = yt(s), a = pc(s), c = i ? i.position : o ? "fixed" : "";
    !a && (c === "fixed" || c === "absolute" && l.position === "static") ? r = r.filter((d) => d !== s) : i = l, s = _n(s);
  }
  return e.set(t, r), r;
}
function tT(t) {
  ...
  const s = [...n === "clippingAncestors" ? Ms(e) ? [] : eT(e, this._c) : [].concat(n), r], l = Vu(e, s[0], i);
  let a = l.top, c = l.right, u = l.bottom, d = l.left;
  for (let f = 1; f < s.length; f++) {
    const h = Vu(e, s[f], i);
    a = tt(h.top, a), c = mt(h.right, c), u = mt(h.bottom, u), d = tt(h.left, d);
  }
  return {
    width: c - d,
    height: u - a,
...
function rT(t, e, n) {
  ...
  !r && i && (a.x = Ls(i));
  const c = i && !r && !o ? jm(i, l) : It(0), u = s.left + l.scrollLeft - a.x - c.x, d = s.top + l.scrollTop - a.y - c.y;
  return {
    x: u,
    y: d,
    width: s.width,
...
function Km(t, e) {
  ...
  for (; r && FA(r) && il(r); )
    r = Nu(r, e);
  return r && di(r) && il(r) && !pc(r) ? n : r || jA(t) || n;
}
const iT = async function(t) {
  const e = this.getOffsetParent || Km, n = this.getDimensions, r = await n(t.floating);
  return {
...
const sT = {
  ...
  isElement: gt,
  isRTL: oT
}, qm = zA, Gm = RA, Jm = $A, Xm = VA, Zm = BA, Ym = NA, Qm = OA, eg = _A, tg = (t, e, n) => {
    ...
    for (let p = 0; ; p++) {
      ...
      for (let v = 0; v < y; v++) {
        ...
        for (let x = 0; x < g; x++) {
          ...
          const w = b && b[x];
          if (w) {
            const S = (k + x) % e * 2, C = s[S];
            C == null || C != w && s[S + 1] == 1 ? (s[S] = w, s[S + 1] = 1) : C == w && s[S + 1]++;
          }
        }
      }
      i += g, u += m.nodeSize;
...
function cT(t, e, n) {
  ...
  for (let i = 0; i < t.map.length; i++) {
    ...
    for (let c = 0; c < a.colspan; c++) {
      ...
      u != null && (!a.colwidth || a.colwidth[c] != u) && ((l || (l = dT(a)))[c] = u);
    }
...
var oe = class Tt extends $ {
  constructor(e, n = e) {
    const r = e.node(-1), i = pe.get(r), o = e.start(-1), s = i.rectBetween(e.pos - o, n.pos - o), l = e.node(0), a = i.cellsInRect(s).filter((u) => u != n.pos - o);
    a.unshift(n.pos - o);
    const c = a.map((u) => {
      const d = r.nodeAt(u);
      if (!d) throw new RangeError(`No cell with offset ${u} found`);
      const f = o + u + 1;
      return new mh(l.resolve(f), l.resolve(f + d.content.size));
    });
  ...
  getBookmark() {
    return new mT(this.$anchorCell.pos, this.$headCell.pos);
  }
};
...
function vT(t, e, n) {
  ...
  } else r instanceof N && yT(r) ? o = N.create(i, r.from) : r instanceof N && bT(r) && (o = N.create(i, r.$from.start(), r.$from.end()));
  return o && (e || (e = t.tr)).setSelection(o), e;
}
const wT = new se("fix-tables");
function og(t, e, n, r) {
  ...
  e: for (let s = 0, l = 0; s < o; s++) {
    ...
    r(a, n), l < i && t.child(l).sameMarkup(a) ? og(t.child(l), a, n + 1, r) : a.nodesBetween(0, a.content.size, r, n + 1), n += a.nodeSize;
  }
}
function sg(t, e) {
  let n;
  const r = (i, o) => {
    i.type.spec.tableRole == "table" && (n = kT(t, i, o, n));
  };
  return e ? e.doc != t.doc && og(e.doc, t.doc, 0, r) : t.doc.descendants(r), n;
}
function kT(t, e, n, r) {
  const i = pe.get(e);
  ...
  for (let a = 0; a < i.problems.length; a++) {
    ...
    if (c.type == "collision") {
      ...
      r.setNodeMarkup(r.mapping.map(n + 1 + c.pos), null, Pn(d, d.colspan - c.n, c.n));
  ...
  return r.setMeta(wT, { fixTables: !0 });
}
function vt(t) {
...
function lg(t, { map: e, tableStart: n, table: r }, i) {
  let o = i > 0 ? -1 : 0;
  pT(e, r, i + o) && (o = i == 0 || i == e.width ? null : 0);
  for (let s = 0; s < e.height; s++) {
    const l = s * e.width + i;
    if (i > 0 && i < e.width && e.map[l - 1] == e.map[l]) {
      const a = e.map[l], c = r.nodeAt(a);
      t.setNodeMarkup(t.mapping.map(n + a), null, rg(c.attrs, i - e.colCount(a))), s += c.attrs.rowspan - 1;
    } else {
...
function CT(t, { map: e, table: n, tableStart: r }, i) {
  const o = t.mapping.maps.length;
  for (let s = 0; s < e.height; ) {
    const l = s * e.width + i, a = e.map[l], c = n.nodeAt(a), u = c.attrs;
    if (i > 0 && e.map[l - 1] == a || i < e.width - 1 && e.map[l + 1] == a) t.setNodeMarkup(t.mapping.slice(o).map(r + a), null, Pn(u, i - e.colCount(a)));
    else {
...
function AT(t, e) {
  ...
  if (e) {
    ...
    for (let i = n.right - 1; CT(r, n, i), i != n.left; i--) {
...
function ag(t, { map: e, tableStart: n, table: r }, i) {
  ...
  const s = [];
  let l = i > 0 ? -1 : 0;
  TT(e, r, i + l) && (l = i == 0 || i == e.height ? null : 0);
...
function HT({ width: t, height: e, map: n }, r) {
...
function _u(t, e) {
  ...
  if (e) {
    ...
    if (o.setNodeMarkup(a + r.tableStart, null, {
      ...rg(c.attrs, c.attrs.colspan, r.right - r.left - c.attrs.colspan),
      rowspan: r.bottom - r.top
    }), l.size > 0) {
      const u = a + 1 + c.content.size, d = Iu(c) ? a + 1 : u;
...
function Du(t, e) {
  const n = He(t.schema);
  return RT(({ node: r }) => n[r.type.spec.tableRole])(t, e);
}
function RT(t) {
  return (e, n) => {
    const r = e.selection;
    ...
    if (n) {
      ...
      for (let h = u.top; h < u.bottom; h++) {
        ...
        for (let m = u.left, g = 0; m < u.right; m++, g++)
          m == u.left && h == u.top || d.insert(f = d.mapping.map(p + u.tableStart, 1), t({
            node: i,
            row: h,
            col: m
          }).createAndFill(a[g]));
...
function fi(t, e) {
  return e = e || { useDeprecatedLogic: !1 }, e.useDeprecatedLogic ? NT(t) : function(n, r) {
    if (!ot(n)) return !1;
    if (r) {
      const i = He(n.schema), o = vt(n), s = n.tr, l = Pu("row", o, i), a = Pu("column", o, i), c = (t === "column" ? l : t === "row" && a) ? 1 : 0, u = t == "column" ? {
        left: 0,
        top: c,
        right: 1,
        bottom: o.map.height
        ...
        right: o.map.width,
        bottom: 1
      } : o, d = t == "column" ? a ? i.cell : i.header_cell : t == "row" ? l ? i.cell : i.header_cell : i.cell;
...
const IT = fi("cell", { useDeprecatedLogic: !0 });
function _T(t, e) {
  if (e < 0) {
...
function zu(t) {
  return function(e, n) {
    ...
    if (n) {
      ...
      n(e.tr.setSelection(N.between(i, hT(i))).scrollIntoView());
    }
    return !0;
  };
}
...
function Pi(t, e) {
  ...
  if (e) {
    ...
    n.forEachCell((o, s) => {
      o.content.eq(i) || r.replace(r.mapping.map(s + 1), r.mapping.map(s + o.nodeSize - 1), new L(i, 0, 0));
    }), r.docChanged && e(r);
  }
  return !0;
}
function PT(t) {
  ...
  if (o == "row") for (let a = 0; a < e.childCount; a++) {
    ...
    (u || d) && (c = ia(He(s).row, new L(c, u, d)).content), l.push(c);
  }
  else if (o == "cell" || o == "header_cell") l.push(n || r ? ia(He(s).row, new L(e, n, r)).content : e);
  else return null;
  return zT(s, l);
}
function zT(t, e) {
...
function $T({ width: t, height: e, rows: n }, r, i) {
  if (t != r) {
    const o = [], s = [];
    for (let l = 0; l < n.length; l++) {
      ...
      for (let u = o[l] || 0, d = 0; u < r; d++) {
        ...
        u + f.attrs.colspan > r && (f = f.type.createChecked(Pn(f.attrs, f.attrs.colspan, u + f.attrs.colspan - r), f.content)), c.push(f), u += f.attrs.colspan;
...
function Fu(t, e, n, r, i) {
  ...
  let s = pe.get(o);
  const { top: l, left: a } = r, c = a + i.width, u = l + i.height, d = t.tr;
  let f = 0;
  function h() {
    if (o = n ? d.doc.nodeAt(n - 1) : d.doc, !o) throw new Error("No table found");
    s = pe.get(o), f = d.mapping.maps.length;
  }
  BT(d, s, o, n, c, u, f) && h(), $u(d, s, o, n, a, c, l, f) && h(), $u(d, s, o, n, a, c, u, f) && h(), Bu(d, s, o, n, l, u, a, f) && h(), Bu(d, s, o, n, l, u, c, f) && h();
  for (let p = l; p < u; p++) {
    const m = s.positionAt(p, a, o), g = s.positionAt(p, c, o);
    d.replace(d.mapping.slice(f).map(m + n), d.mapping.slice(f).map(g + n), new L(i.rows[p - l], 0, 0));
  }
  h(), d.setSelection(new oe(d.doc.resolve(n + s.positionAt(l, a, o)), d.doc.resolve(n + s.positionAt(u - 1, c - 1, o)))), e(d);
}
const FT = qa({
...
function WT(t, e, n) {
  ...
  if (i instanceof oe) {
    ...
    return r = $T(r, l.right - l.left, l.bottom - l.top), Fu(t.state, t.dispatch, s, l, r), !0;
  } else if (r) {
    const o = Os(t.state), s = o.start(-1);
    return Fu(t.state, t.dispatch, s, pe.get(o.node(-1)).findCell(o.pos - s), r), !0;
  } else return !1;
}
function jT(t, e) {
  var n;
  if (e.button != 0 || e.ctrlKey || e.metaKey) return;
  const r = Uu(t, e.target);
  let i;
  ...
  function l(a) {
    ...
    else if (Uu(t, c.target) != r && (d = ol(t, e), !d))
      return s();
    d && o(d, c);
  }
...
function qT({ handleWidth: t = 5, cellMinWidth: e = 25, defaultCellMinWidth: n = 100, View: r = KT, lastColumnResizable: i = !0 } = {}) {
  const o = new re({
    key: Fe,
    state: {
      init(s, l) {
        ...
        return r && c && (c[u] = (d, f) => new r(d, n, f)), new GT(-1, !1);
      },
      apply(s, l) {
        return l.apply(s);
      }
    ...
    props: {
      ...
      decorations: (s) => {
        const l = Fe.getState(s);
        if (l && l.activeHandle > -1) return nM(s, l.activeHandle);
      },
      nodeViews: {}
    }
  });
...
function JT(t, e, n, r) {
  ...
  if (i && !i.dragging) {
    ...
    if (o) {
      ...
      e.clientX - l <= n ? s = Wu(t, e, "left", n) : a - e.clientX <= n && (s = Wu(t, e, "right", n));
    }
    if (s != i.activeHandle) {
      if (!r && s !== -1) {
        const l = t.state.doc.resolve(s), a = l.node(-1), c = pe.get(a), u = l.start(-1);
...
function XT(t) {
  ...
  e && e.activeHandle > -1 && !e.dragging && dg(t, -1);
}
function ZT(t, e, n, r) {
  var i;
  ...
  const l = t.state.doc.nodeAt(s.activeHandle), a = YT(t, s.activeHandle, l.attrs);
  ...
  function c(d) {
    ...
    f?.dragging && (eM(t, f.activeHandle, ju(f.dragging, d, n)), t.dispatch(t.state.tr.setMeta(Fe, { setDragging: null })));
  }
  function u(d) {
    if (!d.which) return c(d);
    const f = Fe.getState(t.state);
    if (f && f.dragging) {
      const h = ju(f.dragging, d, n);
      Ku(t, f.activeHandle, h, r);
    }
  }
  return Ku(t, s.activeHandle, a, r), o.addEventListener("mouseup", c), o.addEventListener("mousemove", u), e.preventDefault(), !0;
}
function YT(t, e, { colspan: n, colwidth: r }) {
...
function eM(t, e, n) {
  ...
  for (let c = 0; c < o.height; c++) {
    ...
    const p = f.colwidth ? f.colwidth.slice() : tM(f.colspan);
    p[h] = n, a.setNodeMarkup(s + d, null, {
      ...f,
      colwidth: p
    });
  }
...
function nM(t, e) {
  ...
  for (let c = 0; c < o.height; c++) {
    ...
    if ((l == o.width - 1 || o.map[u] != o.map[u + 1]) && (c == 0 || o.map[u] != o.map[u - o.width])) {
      ...
      h.className = "column-resize-handle", !((a = Fe.getState(t)) === null || a === void 0) && a.dragging && n.push(ve.node(s + d, s + d + i.nodeAt(d).nodeSize, { class: "column-resize-dragging" })), n.push(ve.widget(f, h));
    }
  }
...
function rM({ allowTableNodeSelection: t = !1 } = {}) {
  return new re({
    ...
    props: {
      decorations: gT,
      handleDOMEvents: { mousedown: jT },
      createSelectionBetween(e) {
        return Yt.getState(e.state) != null ? e.state.selection : null;
      },
      handleTripleClick: UT,
      handleKeyDown: FT,
      handlePaste: WT
    },
    appendTransaction(e, n, r) {
      return vT(r, sg(r, n), t);
    }
  });
}
function iM(t, e) {
...
var oM = class {
  constructor({
    ...
    this.preventHide = !1, this.isVisible = !1, this.scrollTarget = window, this.floatingUIOptions = {
      ...
      const { doc: m, selection: g } = f, { empty: y } = g, b = !m.textBetween(h, p).length && ps(f.selection), v = this.element.contains(document.activeElement);
      return !(!(d.hasFocus() || v) || y || b || !this.editor.isEditable);
      ...
      d?.relatedTarget && ((f = this.element.parentNode) != null && f.contains(d.relatedTarget)) || d?.relatedTarget !== this.editor.view.dom && this.hide();
    }, this.handleDebouncedUpdate = (d, f) => {
      const h = !f?.selection.eq(d.state.selection), p = !f?.doc.eq(d.state.doc);
    ...
    var u;
    this.editor = t, this.element = e, this.view = n, this.pluginKey = r, this.updateDelay = i, this.resizeDelay = o, this.appendTo = l, this.scrollTarget = (u = c?.scrollTarget) != null ? u : window, this.getReferencedVirtualElement = a, this.floatingUIOptions = {
  ...
  get middlewares() {
    ...
    ), this.floatingUIOptions.arrow && t.push(Qm(this.floatingUIOptions.arrow)), this.floatingUIOptions.size && t.push(
      Zm(
  ...
  get virtualElement() {
    ...
    if (!((n = (e = this.view) == null ? void 0 : e.dom) != null && n.parentNode))
      return;
    const o = Vp(this.view, r.from, r.to);
    let s = {
    ...
    if (r instanceof oe) {
      ...
      if (!d || !f)
        return;
      const h = d === f ? d.getBoundingClientRect() : iM(
  ...
  setup(t, { slots: e, attrs: n }) {
    ...
    return Aa(() => {
      ...
      h && (h.style.visibility = "hidden", h.style.position = "absolute", h.remove(), Hf(() => {
        s.registerPlugin(
          sM({
            editor: s,
            element: h,
  ...
  constructor({
    ...
    this.preventHide = !1, this.isVisible = !1, this.scrollTarget = window, this.shouldShow = ({ view: u, state: d }) => {
      const { selection: f } = d, { $anchor: h, empty: p } = f, m = h.depth === 1, g = h.parent.isTextblock && !h.parent.type.spec.code && !h.parent.textContent && h.parent.childCount === 0 && !this.getTextContent(h.parent);
  ...
  getTextContent(t) {
    return Ep(t, { textSerializers: Qa(this.editor.schema) });
  }
  get middlewares() {
    const t = [];
    return this.floatingUIOptions.flip && t.push(
  ...
  updatePosition() {
    ...
    if (!((e = (t = this.view) == null ? void 0 : t.dom) != null && e.parentNode))
      return;
    const { selection: n } = this.editor.state, r = Vp(this.view, n.from, n.to);
    tg({
...
te({
  ...
  setup(t, { slots: e, attrs: n }) {
    ...
    return Aa(() => {
      const { editor: s, updateDelay: l, resizeDelay: a, options: c, appendTo: u, shouldShow: d } = t, f = i.value;
...
const dM = /* @__PURE__ */ te({
  ...
  setup(t) {
    const e = t, { t: n } = Ut(), r = W(() => {
      const l = e.editor.state.selection, a = s(), c = l.node?.type.name === "image", u = l.node?.type.name === "video", d = l instanceof N;
      if (a) return "link";
      if (c) return "image";
      if (u) return "video";
      if (d) return "text";
    }), i = W(() => {
      const { extensions: l = [] } = e.editor.extensionManager, a = l.find((d) => d.name === "base-kit");
      if (!a) return {};
    ...
    return (l, a) => {
      const c = gi, u = gr, d = mi, f = mr;
      return Rf((R(), F(T(lM), { editor: l.editor }, {
        default: E(() => [
          H(f, { class: "vuetify-pro-tiptap-editor__menu-bubble" }, {
            default: E(() => [
              H(d, { class: "d-flex pa-0" }, {
                default: E(() => [
                  H(u, {
                    density: "compact",
                    flat: "",
                    ...
                    default: E(() => [
                      (R(!0), de(Le, null, Ze(o.value, (h, p) => (R(), de(Le, { key: p }, [
                        h.type === "divider" ? (R(), F(c, {
                          key: 0,
                          vertical: "",
                          class: "mx-1 me-2"
                        })) : (R(), F(Xr(h.component), er({
                          key: 1,
                          ref_for: !0
                        }, h.componentProps, {
                          editor: l.editor,
                          ...
                          Ze(h.componentSlots, (m, g, y) => ({
                            name: `${g}`,
                            fn: E((b) => [
                              (R(), F(Xr(m), er({ ref_for: !0 }, b?.props), null, 16))
                            ])
                          }))
  ...
  setup(t) {
    const e = t, { t: n } = Ut(), r = W(() => {
      const o = [...e.editor.extensionManager.extensions].sort((l, a) => {
        const c = l.options.sort ?? -1, u = a.options.sort ?? -1;
        return c - u;
      });
      let s = [];
      for (const l of o) {
        const { button: a, divider: c = !1, spacer: u = !1 } = l.options;
        if (!a || !YC(a)) continue;
        const d = a({
          editor: e.editor,
          extension: l,
        ...
        if (Array.isArray(d)) {
          const f = d.map((h, p) => ({
            button: h,
            divider: p === d.length - 1 ? c : !1,
            spacer: p === 0 ? u : !1
          }));
          s = [...s, ...f];
          continue;
        }
        s.push({ button: d, divider: c, spacer: u });
      }
      return s;
    });
    return (i, o) => {
      const s = yi, l = gi, a = gr;
      return R(), F(a, er(i.$attrs, {
        density: "compact",
        flat: "",
        height: "auto",
        class: "py-1 ps-1"
        ...
        default: E(() => [
          (R(!0), de(Le, null, Ze(r.value, (c, u) => (R(), de(Le, { key: u }, [
            c.spacer ? (R(), F(s, { key: 0 })) : $e("", !0),
            (R(), F(Xr(c.button.component), er({ ref_for: !0 }, c.button.componentProps, {
              editor: i.editor,
              disabled: i.disabled || c.button.componentProps?.disabled
            }), Ta({ _: 2 }, [
              Ze(c.button.componentSlots, (d, f, h) => ({
                name: `${f}`,
                fn: E((p) => [
                  (R(), F(Xr(d), er({ ref_for: !0 }, p?.props), null, 16))
                ])
              }))
            ]), 1040, ["editor", "disabled"])),
            c.divider ? (R(), F(l, {
...
}), fM = { class: "text-overline me-4" }, hM = { class: "text-overline" }, _H = /* @__PURE__ */ te({
  ...
  setup(t, { expose: e, emit: n }) {
    const r = t, i = n, o = E1(), s = Ma(), { state: l, isFullscreen: a } = uA(), { markdownThemeStyle: c } = Lm(
      W(() => r.markdownTheme),
      (v) => {
        i("update:markdownTheme", v);
      }
    ), u = W(() => {
      const v = GC(r.extensions, l.extensions, "name");
      return [...l.extensions.map((x, w) => {
        const S = r.extensions.find((C) => C.name === x.name);
        return S ? x.configure(S.options) : x;
      }), ...v].map((x, w) => x.configure({ sort: w }));
    }), d = new ek({
      content: r.modelValue,
      editorProps: {
        handleKeyDown: Pr(function(v, k) {
          return k.key === "Enter" && o.enter && !k.shiftKey ? (i("enter"), !0) : !1;
        }, Wl)
      },
      onUpdate: Pr(({ editor: v }) => {
        const k = g(v, r.output);
        i("update:modelValue", k), i("change", { editor: v, output: k });
      }, Wl),
      extensions: T(u),
      autofocus: !1,
      editable: !r.disabled,
      injectCSS: !0
    }), { t: f } = Ut(), h = W(() => pr(r.dark) ? r.dark : pr(s.current.value.dark) ? s.current.value.dark : !1), p = W(() => [{
      __dark: T(h),
      ...T(c)
    }, r.editorClass]), m = W(() => {
      const v = $r(r.maxWidth), k = {
        maxWidth: v,
        width: v ? "100%" : void 0,
        margin: v ? "0 auto" : void 0,
        backgroundColor: T(h) ? "#1E1E1E" : "#FFFFFF"
      };
      if (T(a)) return { height: "100%", overflowY: "auto", ...k };
      const x = $r(r.minHeight), w = $r(r.maxHeight);
      return {
        minHeight: x,
        maxHeight: w,
        overflowY: "auto",
    ...
    function g(v, k) {
      return r.removeDefaultWrapper ? k === "html" ? v.isEmpty ? "" : v.getHTML() : k === "json" ? v.isEmpty ? {} : v.getJSON() : k === "text" ? v.isEmpty ? "" : v.getText() : "" : k === "html" ? v.getHTML() : k === "json" ? v.getJSON() : k === "text" ? v.getText() : "";
    }
    const y = Pr((v) => {
      if (!d) return;
      const k = g(d, r.output);
      if (JC(k, v)) return;
      const { from: x, to: w } = d.state.selection;
      d.commands.setContent(v, { emitUpdate: !1 }), d.commands.setTextSelection({ from: x, to: w });
    }, ik), b = (v) => d?.setEditable(!v);
    return _t(() => r.modelValue, y), _t(() => r.disabled, b), L1(() => d?.destroy()), e({ editor: d }), (v, k) => {
      const x = g1, w = gi, S = yi, C = gr, O = mr, _ = m1, I = Tf;
      return T(d) ? (R(), de("div", {
        key: 0,
                ...
                H(O, er({
                  ...
                  default: E(() => [
                    v.label && !T(a) ? (R(), de(Le, { key: 0 }, [
                      H(x, {
                        class: dt(h.value ? "bg-grey-darken-3" : "bg-grey-lighten-3")
                      }, {
                        default: E(() => [
                          Dt(Ae(v.label), 1)
                        ]),
                    ...
                    v.hideToolbar ? $e("", !0) : (R(), F(uM, {
                      key: 1,
                      class: "vuetify-pro-tiptap-editor__toolbar",
                      editor: T(d),
                      disabled: v.disableToolbar
                    }, null, 8, ["editor", "disabled"])),
                    ut(v.$slots, "editor", Nc(Ic({ editor: T(d), props: { class: "vuetify-pro-tiptap-editor__content", "data-testid": "value" } })), () => [
                      H(T(tk), {
                        class: dt(["vuetify-pro-tiptap-editor__content", p.value]),
                        style: tr(m.value),
                        editor: T(d),
                        "data-testid": "value"
                      }, null, 8, ["class", "style", "editor"])
                    ]),
                    ut(v.$slots, "bottom", Nc(Ic({ editor: T(d) })), () => [
                      H(C, {
                        class: "px-4",
                        density: "compact",
                        flat: ""
                        ...
                        default: E(() => [
                          H(S),
                          T(QC)(T(d), "characterCount") ? (R(), de(Le, { key: 0 }, [
                            De("span", fM, Ae(T(d).storage.characterCount.words()) + " " + Ae(T(f)("editor.words")), 1),
                            De("span", hM, Ae(T(d).storage.characterCount.characters()) + " " + Ae(T(f)("editor.characters")), 1)
                          ], 64)) : $e("", !0)
                        ]),
                        _: 1
                      })
...
function mM(t, e) {
  ...
  const n = Hv(e), r = tn.fromJSON(n, t);
  return pM(r, n);
}
function gM(t) {
  return t && t.__esModule && Object.prototype.hasOwnProperty.call(t, "default") ? t.default : t;
}
var Bi = { exports: {} }, ce = {}, Fi = { exports: {} }, bn = {}, qu;
function ug() {
  if (qu) return bn;
  qu = 1;
  function t() {
...
function bM() {
  ...
  return i.prototype.process = function(o) {
    ...
    var s = this, l = s.options, a = l.whiteList, c = l.onAttr, u = l.onIgnoreAttr, d = l.safeAttrValue, f = e(o, function(h, p, m, g, y) {
      var b = a[m], v = !1;
      if (b === !0 ? v = b : typeof b == "function" ? v = b(g) : b instanceof RegExp && (v = b.test(g)), v !== !0 && (v = !1), g = d(m, g), !!g) {
        var k = {
          position: p,
          sourcePosition: h,
          source: y,
...
function hg() {
  ...
  function u(V, X, P, G) {
    if (P = _(P), X === "href" || X === "src") {
      ...
      if (v.lastIndex = 0, v.test(P) || (k.lastIndex = 0, k.test(P) && (b.lastIndex = 0, b.test(P))))
        return "";
      G !== !1 && (G = G || i, P = G.process(P));
    }
    return P = I(P), P;
  }
  var d = /</g, f = />/g, h = /"/g, p = /&quot;/g, m = /&#([a-zA-Z0-9]*);?/gim, g = /&colon;?/gim, y = /&newline;?/gim, b = /((j\s*a\s*v\s*a|v\s*b|l\s*i\s*v\s*e)\s*s\s*c\s*r\s*i\s*p\s*t\s*|m\s*o\s*c\s*h\s*a):/gi, v = /e\s*x\s*p\s*r\s*e\s*s\s*s\s*i\s*o\s*n\s*\(.*/gi, k = /u\s*r\s*l\s*\(.*/gi;
  function x(V) {
    return V.replace(h, "&quot;");
  }
  function w(V) {
  ...
  function _(V) {
    return V = w(V), V = S(V), V = C(V), V = O(V), V;
  }
  function I(V) {
  ...
  function B(V, X) {
    ...
    return {
      onIgnoreTag: function(ze, xr, kt) {
        if (G(ze))
          if (kt.isClosing) {
            var Sr = "[/removed]", p1 = kt.position + Sr.length;
            return Ie.push([
              wt !== !1 ? wt : kt.position,
              p1
            ]), wt = !1, Sr;
  ...
  return ce.whiteList = r(), ce.getDefaultWhiteList = r, ce.onTag = o, ce.onIgnoreTag = s, ce.onTagAttr = l, ce.onIgnoreTagAttr = a, ce.safeAttrValue = u, ce.escapeHtml = c, ce.escapeQuote = x, ce.unescapeQuote = w, ce.escapeHtmlEntities = S, ce.escapeDangerHtml5Entities = C, ce.clearNonPrintableCharacter = O, ce.friendlyAttrValue = _, ce.escapeAttrValue = I, ce.onIgnoreTagStripAll = U, ce.StripTagBody = B, ce.stripCommentTag = j, ce.stripBlankChar = K, ce.attributeWrapSign = '"', ce.cssFilter = i, ce.getDefaultCSSWhiteList = e, ce;
}
var Ui = {}, ef;
function pg() {
  if (ef) return Ui;
  ...
  var t = yc();
  function e(d) {
    var f = t.spaceIndex(d), h;
    return f === -1 ? h = d.slice(1, -1) : h = d.slice(1, f + 1), h = t.trim(h).toLowerCase(), h.slice(0, 1) === "/" && (h = h.slice(1)), h.slice(-1) === "/" && (h = h.slice(0, -1)), h;
  }
  function n(d) {
    return d.slice(0, 2) === "</";
  }
  function r(d, f, h) {
    var p = "", m = 0, g = !1, y = !1, b = 0, v = d.length, k = "", x = "";
    e: for (b = 0; b < v; b++) {
      var w = d.charAt(b);
      if (g === !1) {
        if (w === "<") {
        ...
        if (w === "<") {
          p += h(d.slice(m, b)), g = b, m = b;
          continue;
        }
        if (w === ">" || b === v - 1) {
          p += h(d.slice(m, g)), x = d.slice(g, b + 1), k = e(x), p += f(
            g,
            p.length,
            k,
            x,
        ...
        if (w === '"' || w === "'")
          for (var S = 1, C = d.charAt(b - S); C.trim() === "" || C === "="; ) {
            if (C === "=") {
              y = w;
              continue e;
            }
    ...
    return m < v && (p += h(d.substr(m))), p;
  }
  var i = /[^a-zA-Z0-9\\_:.-]/gim;
  function o(d, f) {
    var h = 0, p = 0, m = [], g = !1, y = d.length;
    function b(S, C) {
    ...
    for (var v = 0; v < y; v++) {
      var k = d.charAt(v), x, w;
      if (g === !1 && k === "=") {
        g = d.slice(h, v), h = v + 1, p = d.charAt(h) === '"' || d.charAt(h) === "'" ? h : l(d, v + 1);
        continue;
      }
      if (g !== !1 && v === p) {
        if (w = d.indexOf(k, v + 1), w === -1)
          break;
        x = t.trim(d.slice(p + 1, w)), b(g, x), g = !1, v = w, h = v + 1;
        continue;
      }
      if (/\s|\n|\t/.test(k))
        if (d = d.replace(/\s|\n|\t/g, " "), g === !1)
          if (w = s(d, v), w === -1) {
            x = t.trim(d.slice(h, v)), b(x), g = !1, h = v + 1;
            continue;
          } else {
            v = w - 1;
            continue;
          }
        else if (w = a(d, v - 1), w === -1) {
          x = t.trim(d.slice(h, v)), x = u(x), b(g, x), g = !1, h = v + 1;
          continue;
        } else
          continue;
    }
    return h < d.length && (g === !1 ? b(d.slice(h)) : b(g, u(t.trim(d.slice(h))))), t.trim(m.join(" "));
  }
  function s(d, f) {
    for (; f < d.length; f++) {
      var h = d[f];
  ...
  function u(d) {
    return c(d) ? d.substr(1, d.length - 2) : d;
  }
...
function vM() {
  if (tf) return dl;
  tf = 1;
  var t = sa().FilterCSS, e = hg(), n = pg(), r = n.parseTag, i = n.parseAttr, o = yc();
  function s(d) {
    return d == null;
  }
  function l(d) {
  ...
  function c(d) {
    var f = {};
    for (var h in d)
      Array.isArray(d[h]) ? f[h.toLowerCase()] = d[h].map(function(p) {
        return p.toLowerCase();
      }) : f[h.toLowerCase()] = d[h];
    return f;
  }
  function u(d) {
    d = a(d || {}), d.stripIgnoreTag && (d.onIgnoreTag && console.error(
      'Notes: cannot use these two options "stripIgnoreTag" and "onIgnoreTag" at the same time'
    ), d.onIgnoreTag = e.onIgnoreTagStripAll), d.whiteList || d.allowList ? d.whiteList = c(d.whiteList || d.allowList) : d.whiteList = e.whiteList, this.attributeWrapSign = d.singleQuotedAttributeValue === !0 ? "'" : e.attributeWrapSign, d.onTag = d.onTag || e.onTag, d.onTagAttr = d.onTagAttr || e.onTagAttr, d.onIgnoreTag = d.onIgnoreTag || e.onIgnoreTag, d.onIgnoreTagAttr = d.onIgnoreTagAttr || e.onIgnoreTagAttr, d.safeAttrValue = d.safeAttrValue || e.safeAttrValue, d.escapeHtml = d.escapeHtml || e.escapeHtml, this.options = d, d.css === !1 ? this.cssFilter = !1 : (d.css = d.css || {}, this.cssFilter = new t(d.css));
  }
  return u.prototype.process = function(d) {
    if (d = d || "", d = d.toString(), !d) return "";
    var f = this, h = f.options, p = h.whiteList, m = h.onTag, g = h.onIgnoreTag, y = h.onTagAttr, b = h.onIgnoreTagAttr, v = h.safeAttrValue, k = h.escapeHtml, x = f.attributeWrapSign, w = f.cssFilter;
    h.stripBlankChar && (d = e.stripBlankChar(d)), h.allowCommentTag || (d = e.stripCommentTag(d));
    var S = !1;
    ...
    var C = r(
      ...
      function(O, _, I, U, B) {
        ...
        if (j.isWhite) {
          if (j.isClosing)
            return "</" + I + ">";
          var V = l(U), X = p[I], P = i(V.html, function(G, Ie) {
            var wt = o.indexOf(X, G) !== -1, ze = y(I, G, Ie, wt);
            return s(ze) ? wt ? (Ie = v(I, G, Ie, w), Ie ? G + "=" + x + Ie + x : G) : (ze = b(I, G, Ie, wt), s(ze) ? void 0 : ze) : ze;
          });
          return U = "<" + I, P && (U += " " + P), V.closing && (U += " /"), U += ">", U;
        } else
          return K = g(I, U, j), s(K) ? k(U) : K;
      },
      k
    );
...
const xM = /* @__PURE__ */ gM(kM), SM = {
  ...
  props: {
    ...
    xssOptions: { default: () => SM },
    extensions: { default: () => [] }
  },
  setup(t) {
    const e = t, { state: n } = vs(), r = Ma(), { markdownThemeStyle: i } = Lm(W(() => e.markdownTheme)), o = W(() => [...n.extensions, ...e.extensions]), s = W(() => pr(e.dark) ? e.dark : pr(r.current.value.dark) ? r.current.value.dark : !1), l = W(() => ({
      __dark: T(s),
      dense: e.dense,
      view: !0,
      ...T(i)
    })), a = W(() => zr(e.value) ? e.value : mM(e.value, T(o))), c = W(() => {
      if (e.xss === !1)
        return T(a);
      const u = T(a).replace("https://youtu.be/", "https://www.youtube.com/watch?v=").replace("watch?v=", "embed/").replace("https://vimeo.com/", "https://player.vimeo.com/video/"), d = e.xssOptions;
      return xM(u, { whiteList: d, css: !1 });
    });
    return (u, d) => (R(), de("div", {
  ...
  dragover(e) {
    ...
    if (n && !o) {
      ...
      if (this.editorView.dragging && this.editorView.dragging.slice) {
        let l = dh(this.editorView.state.doc, s, this.editorView.dragging.slice);
        l != null && (s = l);
      }
...
function MM(t) {
  for (let e = t.depth; e >= 0; e--) {
    ...
    for (let i = r.child(n - 1); ; i = i.lastChild) {
      if (i.childCount == 0 && !i.inlineContent || mg(i.type))
        return !0;
      if (i.inlineContent)
        return !1;
    }
...
function LM() {
  return new re({
    props: {
      ...
      handleClick: HM,
      handleKeyDown: OM,
      handleDOMEvents: { beforeinput: RM }
    }
  });
}
const OM = qa({
...
function RM(t, e) {
  ...
  let o = t.state.tr.replace(n.pos, n.pos, new L(i, 0, 0));
...
ke.from = function(e) {
  return e instanceof ke ? e : e && e.length ? new gg(e) : ke.empty;
};
var gg = /* @__PURE__ */ function(t) {
  function e(r) {
...
class Ye {
  ...
  popEvent(e, n) {
    ...
    return this.items.forEach((d, f) => {
      ...
      if (i) {
        ...
        s.maybeStep(d.step);
      if (d.selection)
        return l = i ? d.selection.map(i.slice(o)) : d.selection, a = new Ye(this.items.slice(0, r).append(u.reverse().concat(c)), this.eventCount - 1), !1;
  ...
  addTransform(e, n, r, i) {
    ...
    for (let u = 0; u < e.steps.length; u++) {
      let d = e.steps[u].invert(e.docs[u]), f = new st(e.mapping.maps[u], d, n), h;
      (h = a && a.merge(f)) && (f = h, u ? o.pop() : l = l.slice(0, l.length - 1)), o.push(f), n && (s++, n = void 0), i || (a = f);
    }
    let c = s - r.depth;
    return c > DM && (l = _M(l, c), s -= c), new Ye(l.append(o), s);
  }
  remapping(e, n) {
    let r = new ei();
  ...
  rebased(e, n) {
    ...
    let u = this.items.slice(0, i).append(c).append(r), d = new Ye(u, l);
    return d.emptyItemCount() > IM && (d = d.compress(this.items.length - r.length)), d;
  }
  emptyItemCount() {
    let e = 0;
...
function PM(t, e, n, r) {
  ...
  n.getMeta(BM) && (t = new Jt(t.done, t.undone, null, 0, -1));
  let s = n.getMeta("appendedTransaction");
  if (n.steps.length == 0)
    return t;
  if (s && s.getMeta(Ln))
    return s.getMeta(Ln).redo ? new Jt(t.done.addTransform(n, void 0, r, io(e)), t.undone, rf(n.mapping.maps), t.prevTime, t.prevComposition) : new Jt(t.done, t.undone.addTransform(n, void 0, r, io(e)), null, t.prevTime, t.prevComposition);
  if (n.getMeta("addToHistory") !== !1 && !(s && s.getMeta("addToHistory") === !1)) {
    let l = n.getMeta("composition"), a = t.prevTime == 0 || !s && t.prevComposition != l && (t.prevTime < (n.time || 0) - r.newGroupDelay || !zM(n, t.prevRanges)), c = s ? ul(t.prevRanges, n.mapping) : rf(n.mapping.maps);
...
const Ln = new se("history"), BM = new se("closeHistory");
function FM(t = {}) {
  return t = {
    depth: t.depth || 100,
    ...
    props: {
      handleDOMEvents: {
        beforeinput(e, n) {
          let r = n.inputType, i = r == "historyUndo" ? bg : r == "historyRedo" ? vg : null;
      ...
      new re({
        ...
        filterTransaction: (e, n) => {
          ...
          if (i > r && o > r && o > i || !e.getMeta("paste"))
            return !1;
          const l = e.selection.$head.pos, a = o - r, c = l - a, u = l;
...
}), wg = "placeholder", sf = new se("tiptap__placeholder");
function kg(t) {
  const {
    editor: e,
    placeholder: n,
  ...
  return s && u.push(c), ve.node(i, i + o.nodeSize, {
    class: u.join(" "),
...
function Sg({
  ...
  return r.nodesBetween(o, s, (u, d) => {
    const f = l >= d && l <= d + u.nodeSize, h = !u.isLeaf && Si(u);
...
function Cg({
  ...
  if (e.showOnlyCurrent && !e.includeChildren) {
    const u = r.resolve(s), d = u.depth > 0 ? u.node(1) : u.nodeAfter, f = u.depth > 0 ? u.before(1) : s;
    if (d && d.type.isTextblock && Si(d)) {
      const h = s >= f && s <= f + d.nodeSize;
      l.push(
        kg({
          editor: t,
          isEmptyDoc: a,
...
function YM({
  ...
  let l = t;
  for (const a of e) {
    const { from: c, to: u } = ZM(a.from, a.to, o), d = l.find(c, u).filter((h) => h.from >= c && h.to <= u);
  ...
  return {
    ...
    apply(r, i, o, s) {
      if (!r.docChanged && !r.selectionSet)
        return i;
      const l = i.map(r.mapping, r.doc), a = XM(r, o, s);
      return YM({
        decorations: l,
        ranges: a,
        editor: t,
...
function tE({ editor: t, options: e }) {
  const n = e.dataAttribute ? `data-${eE(e.dataAttribute)}` : `data-${wg}`, r = e.showOnlyCurrent && !e.includeChildren;
  return new re({
    key: sf,
    ...r ? {} : {
      state: QM({ editor: t, options: e, dataAttribute: n })
    },
    props: {
      decorations: r ? ({ doc: i, selection: o }) => Cg({ editor: t, options: e, dataAttribute: n, doc: i, selection: o }) : (i) => {
        var o;
        return e.showOnlyWhenEditable && !t.isEditable ? Z.empty : (o = sf.getState(i)) != null ? o : Z.empty;
      }
    }
  });
}
var nE = J.create({
  ...
  addProseMirrorPlugins() {
    return [tE({ editor: this.editor, options: this.options })];
  }
});
function la(t, e) {
  return !t.selection.empty && !Op(t.selection) && e.isEditable;
}
function rE(t, e) {
    ...
    return [
      new re({
        ...
        props: {
          ...
          handleDOMEvents: {
            blur(n) {
              return la(n.state, t) && iE(), !1;
            },
            focus(n) {
              return la(n.state, t) && requestAnimationFrame(() => {
                !t.isDestroyed && n.hasFocus() && oE(n);
              }), !1;
            }
          }
        }
    ...
    return [
      new re({
        ...
        appendTransaction: (i, o, s) => {
          const { doc: l, tr: a, schema: c } = s, u = e.getState(s), d = l.content.size, f = c.nodes[n];
          if (!i.some((h) => h.getMeta(sE)) && u)
...
var lE = J.create({
  ...
  addCommands() {
    return {
      undo: () => ({ state: t, dispatch: e }) => bg(t, e),
      redo: () => ({ state: t, dispatch: e }) => vg(t, e)
    };
  },
  addProseMirrorPlugins() {
    return [FM(this.options)];
  },
  addKeyboardShortcuts() {
    return {
...
}), uE = Object.defineProperty, fE = (t, e) => {
  for (var n in e)
    uE(t, n, { get: e[n], enumerable: !0 });
}, hE = "listItem", af = "textStyle", cf = /^\s*([-+*])\s$/, Ag = be.create({
  name: "bulletList",
  addOptions() {
    return {
...
`) : "",
  ...
  addCommands() {
    return {
      toggleBulletList: () => ({ commands: t, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(hE, this.editor.getAttributes(af)).run() : t.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
  ...
  addInputRules() {
    ...
    return (this.options.keepMarks || this.options.keepAttributes) && (t = hr({
      ...
      getAttributes: () => this.editor.getAttributes(af),
      editor: this.editor
    })), [t];
  }
}), pE = (t, e, n) => {
  ...
  if (a.forEach((h) => {
    ...
    return null;
  const d = t.doc.resolve(i.after()).nodeAfter;
  if (!d || !n.includes(d.type.name))
    return null;
  const f = [];
  return d.forEach((h) => {
    f.push(h);
  ...
  if (!i)
    return !1;
  const { selection: o } = t, { nestedList: s, nestedListPos: l, insertPos: a, items: c } = i, u = t.tr;
  u.delete(l, l + s.nodeSize);
  const d = u.mapping.map(a);
  return u.insert(d, A.from(c)), u.setSelection(o.map(u.doc, u.mapping)), e && e(u), !0;
}, gE = (t, e, n) => mE(t.state, t.view.dispatch, e, n), Tg = (t, e) => J.create({
  name: `${t}BranchingDeleteKeymap`,
  priority: 101,
  addKeyboardShortcuts() {
    const n = () => gE(this.editor, t, e);
    return {
      Delete: n,
      "Mod-Delete": n
    };
  ...
  [4, "iv"],
  [1, "i"]
], ji = "abcdefghijklmnopqrstuvwxyz", yE = "[a-zA-Z]{1,2}", Eg = String.raw`\d+|[ivxlcdmIVXLCDM]+|${yE}`;
function Hs(t) {
  let e = t, n = "";
  for (const [r, i] of Mg)
    for (; e >= r; )
  ...
  renderMarkdown: (t, e, n) => rc(
    ...
    (r) => {
      ...
      if (r.parentType === "orderedList") {
        const a = ((o = (i = r.meta) == null ? void 0 : i.parentAttrs) == null ? void 0 : o.start) || 1, c = (l = (s = r.meta) == null ? void 0 : s.parentAttrs) == null ? void 0 : l.type, u = a - 1 + (r.index || 0);
        return CE(c, u, ". ");
      }
      return "- ";
    },
...
var Vs = (t, e) => {
  ...
  if (t.state.selection.from !== t.state.selection.to)
    return !1;
  if (!Pt(t.state, e) && Hg(t.state, e, n)) {
    const { $anchor: o } = t.state.selection, s = t.state.doc.resolve(o.before() - 1), l = [];
    s.node().descendants((u, d) => {
      u.type.name === e && l.push({ node: u, pos: d });
    });
    const a = l.at(-1);
    if (!a)
      return !1;
  ...
  if (!Pt(t.state, e) || !zv(t.state, e))
    return !1;
  const { selection: n } = t.state, { $from: r, $to: i } = n;
  return !n.empty && r.sameParent(i) ? !1 : Rg(e, t.state) ? t.chain().focus(t.state.selection.from + 4).lift(e).joinBackward().run() : Vg(e, t.state) ? t.chain().joinForward().joinBackward().run() : t.commands.joinItemForward();
}, Ng = (t, e, n) => {
  ...
  if (!l.canReplace(l.childCount, l.childCount, A.from(a)))
    return !1;
  const c = o.before(), u = o.after(), d = c - 2;
  return t.commands.command(({ tr: f, dispatch: h }) => (h && (f.delete(c, u).insert(d, A.from(a)), f.setSelection(N.create(f.doc, d + 1)), f.scrollIntoView()), !0));
}, EE = (t, e) => {
  var n;
    ...
    return {
      ...
      Tab: ({ editor: t }) => {
        for (const { itemName: e, wrapperNames: n } of this.options.listTypes)
          if (t.state.schema.nodes[e] !== void 0 && Ng(t, e, n))
            return !0;
        return !1;
      }
    };
...
function NE(t) {
  const e = t.trimStart();
  return Yn.bulletItem.test(e) || VE(e) || Yn.heading.test(e) || // dash breaks are excluded: "---" directly below paragraph text is a
...
function DE(t) {
  ...
  for (; n < t.length; ) {
    ...
    if (!o)
      break;
    const [, s, l, a, c] = o, u = s.length, d = parseInt(l, 10), f = isNaN(d) ? Rs(l) : void 0, h = isNaN(d) ? wc(l) : d, p = [c];
    let m = n + 1;
    const g = [i];
    let y = !1;
    for (; m < t.length; ) {
      ...
      if (b.trim() === "")
        ...
        const k = b.length - b.trimStart().length, x = u + l.length + 1;
        g.push(b), p.push(b.slice(Math.min(k, x))), m += 1;
      } else {
        if (y || IE(b))
          break;
...
function Ig(t, e, n) {
  ...
  for (; i < t.length; ) {
    const o = t[i];
    if (o.indent === e) {
      const { paragraphLines: s, blockLines: l } = _E(o.contentLines), a = s.join(`
`).trim(), c = [];
      a && c.push({
        type: "paragraph",
        raw: a,
...
`).trim();
      ...
      for (; d < t.length && t[d].indent > e; )
        f.push(t[d]), d += 1;
      if (f.length > 0) {
        const h = Math.min(...f.map((m) => m.indent)), p = Ig(f, h, n);
        c.push({
          type: "list",
          ordered: !0,
          start: f[0].number,
...
var BE = "listItem", df = "textStyle", uf = /^(\d+)\.\s$/;
function ff(t) {
...
var _g = be.create({
  ...
  parseMarkdown: (t, e) => {
    if (t.type !== "list" || !t.ordered)
      return [];
    const n = t.start || 1, r = t.typeMarker, i = t.items ? $E(t.items, e) : [], o = {};
...
`), [s, l] = DE(o);
      if (s.length === 0)
        return;
      const a = Ig(s, s[0].indent, n);
      if (a.length === 0)
        return;
      const c = ((r = s[0]) == null ? void 0 : r.number) || 1, u = (i = s[0]) == null ? void 0 : i.type;
      return {
        type: "list",
        ordered: !0,
        start: c,
...
`)
  ...
  addCommands() {
    return {
      toggleOrderedList: () => ({ commands: t, chain: e }) => this.options.keepAttributes ? e().toggleList(this.name, this.options.itemTypeName, this.options.keepMarks).updateAttributes(BE, this.editor.getAttributes(df)).run() : t.toggleList(this.name, this.options.itemTypeName, this.options.keepMarks)
    };
  },
  addKeyboardShortcuts() {
    return {
  ...
  addInputRules() {
    ...
    return (this.options.keepMarks || this.options.keepAttributes) && (e = hr({
      ...
      keepMarks: this.options.keepMarks,
      keepAttributes: this.options.keepAttributes,
      getAttributes: (n) => ({ start: +n[1], ...this.editor.getAttributes(df) }),
      joinPredicate: t,
      editor: this.editor
    })), [e];
  }
}), FE = /^\s*(\[([( |x])?\])\s$/, UE = "position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0", WE = (t, e, n) => {
  var r;
  ...
  addNodeView() {
    return ({ node: t, HTMLAttributes: e, getPos: n, editor: r }) => {
      ...
      s.style.cssText = UE;
      const c = (d) => {
        const f = WE(d, d.attrs.checked, this.options.a11y);
        l.setAttribute("aria-label", f), s.textContent = f;
      };
      c(t), o.contentEditable = "false", l.type = "checkbox", l.addEventListener("mousedown", (d) => d.preventDefault()), l.addEventListener("change", (d) => {
        ...
        i.setAttribute(d, f);
      }), i.dataset.checked = t.attrs.checked, l.checked = t.attrs.checked, o.append(l, s), i.append(o, a), Object.entries(e).forEach(([d, f]) => {
        i.setAttribute(d, f);
      });
      ...
      return {
        ...
        update: (d) => {
          ...
          const f = r.extensionManager.attributes, h = fr(d, f), p = new Set(Object.keys(h)), m = this.options.HTMLAttributes;
          return u.forEach((g) => {
...
J.create({
  ...
  addExtensions() {
    const t = [];
    return this.options.bulletList !== !1 && t.push(Ag.configure(this.options.bulletList)), this.options.listItem !== !1 && t.push(Og.configure(this.options.listItem)), this.options.listKeymap !== !1 && t.push(HE.configure(this.options.listKeymap)), this.options.orderedList !== !1 && t.push(_g.configure(this.options.orderedList)), this.options.taskItem !== !1 && t.push(Dg.configure(this.options.taskItem)), this.options.taskList !== !1 && t.push(Pg.configure(this.options.taskList)), t;
  }
});
var jE = be.create({
  name: "text",
  ...
  const n = [];
  return !t.children.length || e > KE || Array.from(t.children).forEach((r) => {
    r.tagName === "SPAN" ? n.push(r) : r.children.length && n.push(...zg(r, e + 1));
  }), n;
}, qE = (t) => {
    ...
    return [
      {
        tag: "span",
        consuming: !1,
        getAttrs: (t) => t.hasAttribute("style") ? (this.options.mergeNestedSpanStyles && qE(t), {}) : !1
      }
    ];
  },
  renderHTML({ HTMLAttributes: t }) {
...
J.create({
  ...
  addExtensions() {
    const t = [];
    return this.options.backgroundColor !== !1 && t.push(GE.configure(this.options.backgroundColor)), this.options.color !== !1 && t.push(Bg.configure(this.options.color)), this.options.fontFamily !== !1 && t.push(Fg.configure(this.options.fontFamily)), this.options.fontSize !== !1 && t.push(JE.configure(this.options.fontSize)), this.options.lineHeight !== !1 && t.push(XE.configure(this.options.lineHeight)), this.options.textStyle !== !1 && t.push($g.configure(this.options.textStyle)), t;
  }
});
var ZE = "M19,12H17V15H14V17H19V12M7,9H10V7H5V12H7V9M21,3H3A2,2 0 0,0 1,5V19A2,2 0 0,0 3,21H21A2,2 0 0,0 23,19V5A2,2 0 0,0 21,3M21,19H3V5H21V19Z", YE = "M21,7L9,19L3.5,13.5L4.91,12.09L9,16.17L19.59,5.59L21,7Z", QE = "M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2Z", e2 = "M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z", t2 = "M19 3H5C3.9 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V5C21 3.9 20.1 3 19 3M11 8H9V10C9 11.1 8.1 12 7 12C8.1 12 9 12.9 9 14V16H11V18H9C7.9 18 7 17.1 7 16V15C7 13.9 6.1 13 5 13V11C6.1 11 7 10.1 7 9V8C7 6.9 7.9 6 9 6H11V8M19 13C17.9 13 17 13.9 17 15V16C17 17.1 16.1 18 15 18H13V16H15V14C15 12.9 15.9 12 17 12C15.9 12 15 11.1 15 10V8H13V6H15C16.1 6 17 6.9 17 8V9C17 10.1 17.9 11 19 11V13Z", n2 = "M14.6,16.6L19.2,12L14.6,7.4L16,6L22,12L16,18L14.6,16.6M9.4,16.6L4.8,12L9.4,7.4L8,6L2,12L8,18L9.4,16.6Z", r2 = "M19,4H15.5L14.5,3H9.5L8.5,4H5V6H19M6,19A2,2 0 0,0 8,21H16A2,2 0 0,0 18,19V7H6V19Z", i2 = "M13.09 20H6L12 14L13.88 15.88C14.5 14.9 15.36 14.1 16.4 13.6L18 12V13.09C18.33 13.04 18.66 13 19 13C19.34 13 19.67 13.04 20 13.09V8L14 2H6C4.89 2 4 2.89 4 4V20C4 21.1 4.89 22 6 22H13.81C13.46 21.39 13.21 20.72 13.09 20M13 3.5L18.5 9H13V3.5M8 9C9.11 9 10 9.9 10 11S9.11 13 8 13 6 12.11 6 11 6.9 9 8 9M20 15V18H23V20H20V23H18V20H15V18H18V15H20Z", hf = "M3,3H21V5H3V3M7,7H17V9H7V7M3,11H21V13H3V11M7,15H17V17H7V15M3,19H21V21H3V19Z", o2 = "M3,3H21V5H3V3M3,7H21V9H3V7M3,11H21V13H3V11M3,15H21V17H3V15M3,19H21V21H3V19Z", s2 = "M3,3H21V5H3V3M3,7H15V9H3V7M3,11H21V13H3V11M3,15H15V17H3V15M3,19H21V21H3V19Z", l2 = "M3,3H21V5H3V3M9,7H21V9H9V7M3,11H21V13H3V11M9,15H21V17H9V15M3,19H21V21H3V19Z", a2 = "M13.5,15.5H10V12.5H13.5A1.5,1.5 0 0,1 15,14A1.5,1.5 0 0,1 13.5,15.5M10,6.5H13A1.5,1.5 0 0,1 14.5,8A1.5,1.5 0 0,1 13,9.5H10M15.6,10.79C16.57,10.11 17.25,9 17.25,8C17.25,5.74 15.5,4 13.25,4H7V18H14.04C16.14,18 17.75,16.3 17.75,14.21C17.75,12.69 16.89,11.39 15.6,10.79Z", c2 = "M6,5V5.18L8.82,8H11.22L10.5,9.68L12.6,11.78L14.21,8H20V5H6M3.27,5L2,6.27L8.97,13.24L6.5,19H9.5L11.07,15.34L16.73,21L18,19.73L3.55,5.27L3.27,5Z", d2 = "M4,17L6.75,14.25L6.72,14.23C6.14,13.64 6.14,12.69 6.72,12.11L11.46,7.37L15.7,11.61L10.96,16.35C10.39,16.93 9.46,16.93 8.87,16.37L8.24,17H4M15.91,2.91C16.5,2.33 17.45,2.33 18.03,2.91L20.16,5.03C20.74,5.62 20.74,6.57 20.16,7.16L16.86,10.45L12.62,6.21L15.91,2.91Z", u2 = "M3,7H9V13H3V7M3,3H21V5H3V3M21,7V9H11V7H21M21,11V13H11V11H21M3,15H17V17H3V15M3,19H21V21H3V19Z", f2 = "M3,7H9V13H3V7M3,3H21V5H3V3M21,11V13H11V11H21M3,15H17V17H3V15M3,19H21V21H3V19Z", h2 = "M15,7H21V13H15V7M3,3H21V5H3V3M13,7V9H3V7H13M9,11V13H3V11H9M3,15H17V17H3V15M3,19H21V21H3V19Z", p2 = "M17,8H20V20H21V21H17V20H18V17H14L12.5,20H14V21H10V20H11L17,8M18,9L14.5,16H18V9M5,3H10C11.11,3 12,3.89 12,5V16H9V11H6V16H3V5C3,3.89 3.89,3 5,3M6,5V9H9V5H6Z", m2 = "M3,4H5V10H9V4H11V18H9V12H5V18H3V4M14,18V16H16V6.31L13.5,7.75V5.44L16,4H18V16H20V18H14Z", g2 = "M3,4H5V10H9V4H11V18H9V12H5V18H3V4M21,18H15A2,2 0 0,1 13,16C13,15.47 13.2,15 13.54,14.64L18.41,9.41C18.78,9.05 19,8.55 19,8A2,2 0 0,0 17,6A2,2 0 0,0 15,8H13A4,4 0 0,1 17,4A4,4 0 0,1 21,8C21,9.1 20.55,10.1 19.83,10.83L15,16H21V18Z", y2 = "M3,4H5V10H9V4H11V18H9V12H5V18H3V4M15,4H19A2,2 0 0,1 21,6V16A2,2 0 0,1 19,18H15A2,2 0 0,1 13,16V15H15V16H19V12H15V10H19V6H15V7H13V6A2,2 0 0,1 15,4Z", b2 = "M3,4H5V10H9V4H11V18H9V12H5V18H3V4M18,18V13H13V11L18,4H20V11H21V13H20V18H18M18,11V7.42L15.45,11H18Z", v2 = "M3,4H5V10H9V4H11V18H9V12H5V18H3V4M15,4H20V6H15V10H17A4,4 0 0,1 21,14A4,4 0 0,1 17,18H15A2,2 0 0,1 13,16V15H15V16H17A2,2 0 0,0 19,14A2,2 0 0,0 17,12H15A2,2 0 0,1 13,10V6A2,2 0 0,1 15,4Z", w2 = "M3,4H5V10H9V4H11V18H9V12H5V18H3V4M15,4H19A2,2 0 0,1 21,6V7H19V6H15V10H19A2,2 0 0,1 21,12V16A2,2 0 0,1 19,18H15A2,2 0 0,1 13,16V6A2,2 0 0,1 15,4M15,12V16H19V12H15Z", k2 = "M3,4H5V10H9V4H11V18H9V12H5V18H3V4M13,8H15.31L15.63,5H17.63L17.31,8H19.31L19.63,5H21.63L21.31,8H23V10H21.1L20.9,12H23V14H20.69L20.37,17H18.37L18.69,14H16.69L16.37,17H14.37L14.69,14H13V12H14.9L15.1,10H13V8M17.1,10L16.9,12H18.9L19.1,10H17.1Z", x2 = "M11,13H21V11H11M11,9H21V7H11M3,3V5H21V3M3,21H21V19H3M3,12L7,16V8M11,17H21V15H11V17Z", S2 = "M11,13H21V11H11M11,9H21V7H11M3,3V5H21V3M11,17H21V15H11M3,8V16L7,12M3,21H21V19H3V21Z", C2 = "M10,4V7H12.21L8.79,15H6V18H14V15H11.79L15.21,7H18V4H10Z", A2 = "M7,5H21V7H7V5M7,13V11H21V13H7M4,4.5A1.5,1.5 0 0,1 5.5,6A1.5,1.5 0 0,1 4,7.5A1.5,1.5 0 0,1 2.5,6A1.5,1.5 0 0,1 4,4.5M4,10.5A1.5,1.5 0 0,1 5.5,12A1.5,1.5 0 0,1 4,13.5A1.5,1.5 0 0,1 2.5,12A1.5,1.5 0 0,1 4,10.5M7,19V17H21V19H7M4,16.5A1.5,1.5 0 0,1 5.5,18A1.5,1.5 0 0,1 4,19.5A1.5,1.5 0 0,1 2.5,18A1.5,1.5 0 0,1 4,16.5Z", T2 = "M21,19V17H8V19H21M21,13V11H8V13H21M8,7H21V5H8V7M4,5V7H6V5H4M3,5A1,1 0 0,1 4,4H6A1,1 0 0,1 7,5V7A1,1 0 0,1 6,8H4A1,1 0 0,1 3,7V5M4,11V13H6V11H4M3,11A1,1 0 0,1 4,10H6A1,1 0 0,1 7,11V13A1,1 0 0,1 6,14H4A1,1 0 0,1 3,13V11M4,17V19H6V17H4M3,17A1,1 0 0,1 4,16H6A1,1 0 0,1 7,17V19A1,1 0 0,1 6,20H4A1,1 0 0,1 3,19V17Z", M2 = "M7,13V11H21V13H7M7,19V17H21V19H7M7,7V5H21V7H7M3,8V5H2V4H4V8H3M2,17V16H5V20H2V19H4V18.5H3V17.5H4V17H2M4.25,10A0.75,0.75 0 0,1 5,10.75C5,10.95 4.92,11.14 4.79,11.27L3.12,13H5V14H2V13.08L4,11H2V10H4.25Z", E2 = "M13,4A4,4 0 0,1 17,8A4,4 0 0,1 13,12H11V18H9V4H13M13,10A2,2 0 0,0 15,8A2,2 0 0,0 13,6H11V10H13Z", L2 = "M10,7L8,11H11V17H5V11L7,7H10M18,7L16,11H19V17H13V11L15,7H18Z", O2 = "M2 4V7H7V19H10V7H15V4H2M21 9H12V12H15V19H18V12H21V9Z", H2 = "M3,14H21V12H3M5,4V7H10V10H14V7H19V4M10,19H14V16H10V19Z", R2 = "M16,7.41L11.41,12L16,16.59L14.59,18L10,13.41L5.41,18L4,16.59L8.59,12L4,7.41L5.41,6L10,10.59L14.59,6L16,7.41M21.85,21.03H16.97V20.03L17.86,19.23C18.62,18.58 19.18,18.04 19.56,17.6C19.93,17.16 20.12,16.75 20.13,16.36C20.14,16.08 20.05,15.85 19.86,15.66C19.68,15.5 19.39,15.38 19,15.38C18.69,15.38 18.42,15.44 18.16,15.56L17.5,15.94L17.05,14.77C17.32,14.56 17.64,14.38 18.03,14.24C18.42,14.1 18.85,14 19.32,14C20.1,14.04 20.7,14.25 21.1,14.66C21.5,15.07 21.72,15.59 21.72,16.23C21.71,16.79 21.53,17.31 21.18,17.78C20.84,18.25 20.42,18.7 19.91,19.14L19.27,19.66V19.68H21.85V21.03Z", V2 = "M16,7.41L11.41,12L16,16.59L14.59,18L10,13.41L5.41,18L4,16.59L8.59,12L4,7.41L5.41,6L10,10.59L14.59,6L16,7.41M21.85,9H16.97V8L17.86,7.18C18.62,6.54 19.18,6 19.56,5.55C19.93,5.11 20.12,4.7 20.13,4.32C20.14,4.04 20.05,3.8 19.86,3.62C19.68,3.43 19.39,3.34 19,3.33C18.69,3.34 18.42,3.4 18.16,3.5L17.5,3.89L17.05,2.72C17.32,2.5 17.64,2.33 18.03,2.19C18.42,2.05 18.85,2 19.32,2C20.1,2 20.7,2.2 21.1,2.61C21.5,3 21.72,3.54 21.72,4.18C21.71,4.74 21.53,5.26 21.18,5.73C20.84,6.21 20.42,6.66 19.91,7.09L19.27,7.61V7.63H21.85V9Z", N2 = "M5,21H19V19H5V21M12,17A6,6 0 0,0 18,11V3H15.5V11A3.5,3.5 0 0,1 12,14.5A3.5,3.5 0 0,1 8.5,11V3H6V11A6,6 0 0,0 12,17Z", I2 = "M5,5H10V7H7V10H5V5M14,5H19V10H17V7H14V5M17,14H19V19H14V17H17V14M10,17V19H5V14H7V17H10Z", _2 = "M14,14H19V16H16V19H14V14M5,14H10V19H8V16H5V14M8,5H10V10H5V8H8V5M19,8V10H14V5H16V8H19Z", D2 = "M18 15V18H15V20H18V23H20V20H23V18H20V15H18M13.3 21H5C3.9 21 3 20.1 3 19V5C3 3.9 3.9 3 5 3H19C20.1 3 21 3.9 21 5V13.3C20.4 13.1 19.7 13 19 13C17.9 13 16.8 13.3 15.9 13.9L14.5 12L11 16.5L8.5 13.5L5 18H13.1C13 18.3 13 18.7 13 19C13 19.7 13.1 20.4 13.3 21Z", P2 = "M12,17.56L16.07,16.43L16.62,10.33H9.38L9.2,8.3H16.8L17,6.31H7L7.56,12.32H14.45L14.22,14.9L12,15.5L9.78,14.9L9.64,13.24H7.64L7.93,16.43L12,17.56M4.07,3H19.93L18.5,19.2L12,21L5.5,19.2L4.07,3Z", z2 = "M2,5.27L3.28,4L20,20.72L18.73,22L13.9,17.17L11.29,19.78C9.34,21.73 6.17,21.73 4.22,19.78C2.27,17.83 2.27,14.66 4.22,12.71L5.71,11.22C5.7,12.04 5.83,12.86 6.11,13.65L5.64,14.12C4.46,15.29 4.46,17.19 5.64,18.36C6.81,19.54 8.71,19.54 9.88,18.36L12.5,15.76L10.88,14.15C10.87,14.39 10.77,14.64 10.59,14.83C10.2,15.22 9.56,15.22 9.17,14.83C8.12,13.77 7.63,12.37 7.72,11L2,5.27M12.71,4.22C14.66,2.27 17.83,2.27 19.78,4.22C21.73,6.17 21.73,9.34 19.78,11.29L18.29,12.78C18.3,11.96 18.17,11.14 17.89,10.36L18.36,9.88C19.54,8.71 19.54,6.81 18.36,5.64C17.19,4.46 15.29,4.46 14.12,5.64L10.79,8.97L9.38,7.55L12.71,4.22M13.41,9.17C13.8,8.78 14.44,8.78 14.83,9.17C16.2,10.54 16.61,12.5 16.06,14.23L14.28,12.46C14.23,11.78 13.94,11.11 13.41,10.59C13,10.2 13,9.56 13.41,9.17Z", pf = "M10.6 13.4A1 1 0 0 1 9.2 14.8A4.8 4.8 0 0 1 9.2 7.8L12.7 4.2A5.1 5.1 0 0 1 19.8 4.2A5.1 5.1 0 0 1 19.8 11.3L18.3 12.8A6.4 6.4 0 0 0 17.9 10.4L18.4 9.9A3.2 3.2 0 0 0 18.4 5.6A3.2 3.2 0 0 0 14.1 5.6L10.6 9.2A2.9 2.9 0 0 0 10.6 13.4M23 18V20H20V23H18V20H15V18H18V15H20V18M16.2 13.7A4.8 4.8 0 0 0 14.8 9.2A1 1 0 0 0 13.4 10.6A2.9 2.9 0 0 1 13.4 14.8L9.9 18.4A3.2 3.2 0 0 1 5.6 18.4A3.2 3.2 0 0 1 5.6 14.1L6.1 13.7A7.3 7.3 0 0 1 5.7 11.2L4.2 12.7A5.1 5.1 0 0 0 4.2 19.8A5.1 5.1 0 0 0 11.3 19.8L13.1 18A6 6 0 0 1 16.2 13.7Z", $2 = "M19,13H5V11H19V13Z", B2 = "M14,3V5H17.59L7.76,14.83L9.17,16.24L19,6.41V10H21V3M19,19H5V5H12V3H5C3.89,3 3,3.9 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V12H19V19Z", F2 = "M17.5,12A1.5,1.5 0 0,1 16,10.5A1.5,1.5 0 0,1 17.5,9A1.5,1.5 0 0,1 19,10.5A1.5,1.5 0 0,1 17.5,12M14.5,8A1.5,1.5 0 0,1 13,6.5A1.5,1.5 0 0,1 14.5,5A1.5,1.5 0 0,1 16,6.5A1.5,1.5 0 0,1 14.5,8M9.5,8A1.5,1.5 0 0,1 8,6.5A1.5,1.5 0 0,1 9.5,5A1.5,1.5 0 0,1 11,6.5A1.5,1.5 0 0,1 9.5,8M6.5,12A1.5,1.5 0 0,1 5,10.5A1.5,1.5 0 0,1 6.5,9A1.5,1.5 0 0,1 8,10.5A1.5,1.5 0 0,1 6.5,12M12,3A9,9 0 0,0 3,12A9,9 0 0,0 12,21A1.5,1.5 0 0,0 13.5,19.5C13.5,19.11 13.35,18.76 13.11,18.5C12.88,18.23 12.73,17.88 12.73,17.5A1.5,1.5 0 0,1 14.23,16H16A5,5 0 0,0 21,11C21,6.58 16.97,3 12,3Z", U2 = "M18.4,10.6C16.55,9 14.15,8 11.5,8C6.85,8 2.92,11.03 1.54,15.22L3.9,16C4.95,12.81 7.95,10.5 11.5,10.5C13.45,10.5 15.23,11.22 16.62,12.38L13,16H22V7L18.4,10.6Z", W2 = "M9 7V17H15V15H11V7H9Z", j2 = "M9 7C7.9 7 7 7.9 7 9V17H9V9H11V16H13V9H15V17H17V9C17 7.9 16.11 7 15 7H9Z", K2 = "M11 7C9.9 7 9 7.9 9 9V11C9 12.11 9.9 13 11 13H13V15H9V17H13C14.11 17 15 16.11 15 15V13C15 11.9 14.11 11 13 11H11V9H15V7H11Z", q2 = "M5,4H19A2,2 0 0,1 21,6V18A2,2 0 0,1 19,20H5A2,2 0 0,1 3,18V6A2,2 0 0,1 5,4M5,8V12H11V8H5M13,8V12H19V8H13M5,14V18H11V14H5M13,14V18H19V14H13Z", G2 = "M11,2A2,2 0 0,1 13,4V20A2,2 0 0,1 11,22H2V2H11M4,10V14H11V10H4M4,16V20H11V16H4M4,4V8H11V4H4M15,11H18V8H20V11H23V13H20V16H18V13H15V11Z", J2 = "M13,2A2,2 0 0,0 11,4V20A2,2 0 0,0 13,22H22V2H13M20,10V14H13V10H20M20,16V20H13V16H20M20,4V8H13V4H20M9,11H6V8H4V11H1V13H4V16H6V13H9V11Z", X2 = "M4,2H11A2,2 0 0,1 13,4V20A2,2 0 0,1 11,22H4A2,2 0 0,1 2,20V4A2,2 0 0,1 4,2M4,10V14H11V10H4M4,16V20H11V16H4M4,4V8H11V4H4M17.59,12L15,9.41L16.41,8L19,10.59L21.59,8L23,9.41L20.41,12L23,14.59L21.59,16L19,13.41L16.41,16L15,14.59L17.59,12Z", Z2 = "M5,10H3V4H11V6H5V10M19,18H13V20H21V14H19V18M5,18V14H3V20H11V18H5M21,4H13V6H19V10H21V4M8,13V15L11,12L8,9V11H3V13H8M16,11V9L13,12L16,15V13H21V11H16Z", Y2 = "M18,14H20V17H23V19H20V22H18V19H15V17H18V14M4,3H18A2,2 0 0,1 20,5V12.08C18.45,11.82 16.92,12.18 15.68,13H12V17H13.08C12.97,17.68 12.97,18.35 13.08,19H4A2,2 0 0,1 2,17V5A2,2 0 0,1 4,3M4,7V11H10V7H4M12,7V11H18V7H12M4,13V17H10V13H4Z", Q2 = "M15.46,15.88L16.88,14.46L19,16.59L21.12,14.46L22.54,15.88L20.41,18L22.54,20.12L21.12,21.54L19,19.41L16.88,21.54L15.46,20.12L17.59,18L15.46,15.88M4,3H18A2,2 0 0,1 20,5V12.08C18.45,11.82 16.92,12.18 15.68,13H12V17H13.08C12.97,17.68 12.97,18.35 13.08,19H4A2,2 0 0,1 2,17V5A2,2 0 0,1 4,3M4,7V11H10V7H4M12,7V11H18V7H12M4,13V17H10V13H4Z", eL = "M22,10A2,2 0 0,1 20,12H4A2,2 0 0,1 2,10V3H4V5H8V3H10V5H14V3H16V5H20V3H22V10M4,10H8V7H4V10M10,10H14V7H10V10M20,10V7H16V10H20M11,14H13V17H16V19H13V22H11V19H8V17H11V14Z", tL = "M22,14A2,2 0 0,0 20,12H4A2,2 0 0,0 2,14V21H4V19H8V21H10V19H14V21H16V19H20V21H22V14M4,14H8V17H4V14M10,14H14V17H10V14M20,14V17H16V14H20M11,10H13V7H16V5H13V2H11V5H8V7H11V10Z", nL = "M9.41,13L12,15.59L14.59,13L16,14.41L13.41,17L16,19.59L14.59,21L12,18.41L9.41,21L8,19.59L10.59,17L8,14.41L9.41,13M22,9A2,2 0 0,1 20,11H4A2,2 0 0,1 2,9V6A2,2 0 0,1 4,4H20A2,2 0 0,1 22,6V9M4,9H8V6H4V9M10,9H14V6H10V9M16,9H20V6H16V9Z", rL = "M21,6V8H3V6H21M3,18H12V16H3V18M3,13H21V11H3V13Z", iL = "M12.5,8C9.85,8 7.45,9 5.6,10.6L2,7V16H11L7.38,12.38C8.77,11.22 10.54,10.5 12.5,10.5C16.04,10.5 19.05,12.81 20.1,16L22.47,15.22C21.08,11.03 17.15,8 12.5,8Z", oL = "M17,10.5V7A1,1 0 0,0 16,6H4A1,1 0 0,0 3,7V17A1,1 0 0,0 4,18H16A1,1 0 0,0 17,17V13.5L21,17.5V6.5L17,10.5M14,13H11V16H9V13H6V11H9V8H11V11H14V13Z", sL = "M12,20A6,6 0 0,1 6,14C6,10 12,3.25 12,3.25C12,3.25 18,10 18,14A6,6 0 0,1 12,20Z";
const lL = {
  bold: a2,
  italic: C2,
  underline: N2,
  ...
  tablePlus: Y2,
  tableRemove: Q2,
  tableColumnPlusAfter: G2,
  tableColumnPlusBefore: J2,
  tableColumnRemove: X2,
  tableRowPlusAfter: eL,
  tableRowPlusBefore: tL,
  tableRowRemove: nL,
  tableMergeCells: Z2,
  check: YE
};
...
const ee = /* @__PURE__ */ te({
...
], fL = (t, e, { editor: n, extension: r, t: i }) => {
  ...
  for (const l of Object.keys(t)) {
    ...
    u?.type === "divider" && c.pop(), d?.type === "divider" && c.shift(), s[l] = c;
  }
  return s;
};
var Ki = "&nbsp;", hl = " ", hL = be.create({
  name: "paragraph",
  priority: 1e3,
  addOptions() {
    return {
...
function Me(t, e, n) {
  let r;
  n && n.length > 0 ? r = n : r = mf(), console.log(`Adding common attributes to ${e}:`, {
    local: n,
    global: mf(),
    final: r,
    globalInitialized: gL()
  });
  const i = t ? { ...t } : {};
  return r.forEach((o) => {
    i[o] || (i[o] = {
...
const yL = /* @__PURE__ */ hL.extend({
  ...
  addExtensions() {
    ...
    ), this.options.document !== !1 && t.push(aE.configure()), this.options.text !== !1 && t.push(jE.configure()), this.options.gapcursor !== !1 && t.push(KM.configure()), this.options.dropcursor !== !1 && t.push(WM.configure(this.options.dropcursor)), this.options.characterCount !== !1 && t.push(UM.configure(this.options.characterCount)), this.options.paragraph !== !1 && t.push(yL.configure(this.options.paragraph)), this.options.hardBreak !== !1 && t.push(dE.configure(this.options.hardBreak)), this.options.listItem !== !1 && t.push(Og.configure(this.options.listItem)), this.options.textStyle !== !1 && t.push($g.configure(this.options.textStyle)), t;
  }
});
function bL(t, e, n) {
  if (t === "slot")
...
var To = (t, e) => bL(t, e), vL = (t, e) => {
  ...
  return t.commands.command(({ tr: h, dispatch: p }) => {
    if (!p)
      return !0;
    const m = o.parent.content, g = new L(m, 0, 0);
  ...
  renderMarkdown: (t, e) => {
    ...
    return t.content.forEach((i, o) => {
      var s, l;
      const u = ((l = (s = e.renderChild) == null ? void 0 : s.call(e, i, o)) != null ? l : e.renderChildren([i])).split(`
`).map((d) => d.trim() === "" ? n : `${n} ${d}`);
      r.push(u.join(`
`));
    }), r.join(`
...
`);
  ...
  addKeyboardShortcuts() {
    return {
      ...
      Backspace: () => vL(this.editor, this.type)
    };
  },
  addInputRules() {
    return [
...
var xL = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))$/, SL = /(?:^|\s)(\*\*(?!\s+\*\*)((?:[^*]+))\*\*(?!\s+\*\*))/g, CL = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))$/, AL = /(?:^|\s)(__(?!\s+__)((?:[^_]+))__(?!\s+__))/g, TL = it.create({
  name: "bold",
  addOptions() {
    return {
      HTMLAttributes: {}
...
`);
      ...
      "Shift-Tab": ({ editor: t }) => {
        ...
        return o.parent.type !== this.type ? !1 : s ? t.commands.command(({ tr: l }) => {
          var a;
          const { pos: c } = o, u = o.start(), d = o.end(), h = r.doc.textBetween(u, d, `
`, `
`).split(`
`);
          let p = 0, m = 0;
          ...
          const b = ((a = h[p].match(/^ */)) == null ? void 0 : a[0]) || "", v = Math.min(b.length, n);
          if (v === 0)
            return !0;
          let k = u;
          for (let w = 0; w < p; w += 1)
            k += h[w].length + 1;
          return l.delete(k, k + v), c - k <= v && l.setSelection(N.create(l.doc, k)), !0;
...
const WH = /* @__PURE__ */ RL.extend({
  ...
  setup(t, { emit: e }) {
    ...
    return (l, a) => {
      const c = un, u = yr, d = ka, f = y1, h = wa, p = ts;
      return R(), F(p, {
        modelValue: o.value,
          ...
          H(h, null, {
            default: E(() => [
              H(f, {
                ...
                default: E(() => [
                  (R(!0), de(Le, null, Ze(T(ok), (m) => (R(), F(u, {
                    key: m,
                    flat: "",
                    icon: "",
                    density: "compact",
  ...
  setup(t) {
    ...
    return (i, o) => {
      const s = un, l = Lf, a = Ef, c = gi, u = wa, d = ts;
      return R(), F(ee, {
        icon: r.value.icon,
  ...
  setup(t) {
    const e = t, { t: n } = Ut(), { state: r, toggleFullscreen: i } = dc(), { isFullscreen: o, enter: s, exit: l } = dA();
    _t(o, (d) => {
      !d && r.isFullscreen && e.useWindow && u();
    });
    const a = W(() => {
    ...
    function u(d = !1) {
      i(), r.isFullscreen ? (document.documentElement.classList.add("overflow-y-hidden"), d && s()) : (document.documentElement.classList.remove("overflow-y-hidden"), d && l());
    }
    return (d, f) => {
      const h = un, p = Mf, m = yr;
      return R(), F(m, {
        class: dt(["rounded me-1 ms-0", {
        ...
        color: d.color,
        icon: "",
        onClick: f[0] || (f[0] = (g) => u(d.useWindow))
      }, {
        default: E(() => [
...
var _L = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))$/, DL = /(?:^|\s)(==(?!\s+==)((?:[^=]+))==(?!\s+==))/g, PL = it.create({
  name: "highlight",
  addOptions() {
    return {
      multicolor: !1,
  ...
  addCommands() {
    return {
      setHorizontalRule: () => ({ chain: t, state: e }) => {
        if (!Lw(e, e.schema.nodes[this.name]))
          return !1;
        const { selection: n } = e, { $to: r } = n, i = t();
        return Op(n) ? i.insertContentAt(r.pos, {
          type: this.name
          ...
          if (l) {
            ...
            if (a.nodeAfter)
              ...
              const u = o.schema.nodes[this.options.nextNodeType] || a.parent.type.contentMatch.defaultType, d = u?.create();
              d && (s.insert(c, d), s.setSelection(N.create(s.doc, c + 1)));
            }
            s.scrollIntoView();
          }
          return !0;
...
function BL(t) {
  ...
  return r.style.width = `${l}px`, r.style.height = `${a}px`, r.style.minHeight = `${a}px`, r.style.transition = "none", n.appendChild(r), setTimeout(() => {
    ...
    try {
      ...
      const u = t.state.tr;
      u.setMeta("preventUpdate", !1), u.setMeta("addToHistory", !1), t.view.dispatch(u), t.options.onUpdate && t.options.onUpdate({
        editor: t,
        transaction: u,
...
function jL(t) {
  try {
    ...
    n && (n.style.setProperty(
      ...
      `${o}px`
    ), n.classList.add("tiptap-preserve-dimensions")), UL(t);
    const l = BL(t);
    if (l) {
...
function KL(t) {
  try {
    ...
    t.storage.htmlView.overlayElement && (t.storage.htmlView.overlayElement.remove(), t.storage.htmlView.overlayElement = null), WL(t);
    const n = t.view.dom;
...
const QH = /* @__PURE__ */ J.create({
  ...
  addOptions() {
    return {
      ...
      allowedAttributes: [],
      button: ({ editor: t, t: e, extension: n }) => (n.options.allowedAttributes && mL(n.options.allowedAttributes), {
        component: ee,
        componentProps: {
          action: () => {
...
var qL = /(?:^|\s)(!\[(.+|:?)]\((\S+)(?:(?:\s+)["'](\S+)["'])?\))$/, GL = be.create({
  ...
  addNodeView() {
    ...
    return ({ node: o, getPos: s, HTMLAttributes: l, editor: a }) => {
      ...
      c.draggable = !1;
      const u = ne(this.options.HTMLAttributes, l);
      Object.entries(u).forEach(([y, b]) => {
        if (b != null)
          switch (y) {
            case "src":
            case "width":
      ...
      const h = (y) => {
        ...
        const b = a.extensionManager.attributes.filter(
          (k) => k.type === y.type.name
        ), v = fr(y, b);
        return Object.keys(d).forEach((k) => {
          !i.has(k) && !(k in v) && c.removeAttribute(k);
        }), Object.entries(v).forEach(([k, x]) => {
          i.has(k) || (x != null ? c.setAttribute(k, x) : c.removeAttribute(k));
        }), f(v.src), d = v, !0;
      }, p = new Yw({
        element: c,
        editor: a,
...
const JL = /* @__PURE__ */ te({
  ...
  setup(t, { emit: e }) {
    const n = t, r = e, i = Y(!1), o = W({
      ...
      try {
        ...
        Vm.error(`Failed to execute upload file: ${c}`);
      } finally {
        i.value = !1;
      }
    };
    return (l, a) => {
      const c = b1, u = ka, d = rs, f = ns;
      return R(), F(f, { disabled: i.value }, {
        default: E(() => [
          H(c, {
      ...
      return R(), F(c, null, {
        default: E(() => [
          H(l, {
            ...
            "onUpdate:modelValue": s[0] || (s[0] = (u) => i.value.src = u),
          ...
          H(l, {
            ...
            "onUpdate:modelValue": s[1] || (s[1] = (u) => i.value.alt = u),
            label: o.t("editor.image.dialog.form.alt"),
            "prepend-icon": T(ue)("text")
          }, null, 8, ["modelValue", "label", "prepend-icon"]),
          H(a, {
            modelValue: i.value.lockAspectRatio,
            "onUpdate:modelValue": s[2] || (s[2] = (u) => i.value.lockAspectRatio = u),
...
}), ZL = { class: "headline" }, YL = /* @__PURE__ */ te({
  __name: "ImageDialog",
  props: {
    value: { default: () => ({}) },
    editor: {},
  ...
  setup(t) {
    ...
    async function a() {
      const { src: u, lockAspectRatio: d, height: f } = T(o);
      u && (e.editor.chain().focus().setImage({
        ...T(o),
        src: u,
        height: d ? void 0 : f
      }).run(), c());
    ...
    return _t(
      ...
      const f = yi, h = un, p = yr, m = gr, g = w1, y = v1, b = x1, v = k1, k = mi, x = Sa, w = mr, S = xa;
      return R(), F(S, {
        modelValue: r.value,
          ...
          H(w, null, {
            default: E(() => [
              H(m, {
                ...
                default: E(() => [
                  De("span", ZL, Ae(T(n)("editor.image.dialog.title")), 1),
                  H(f),
                  H(p, {
                    class: "mx-0",
                    icon: "",
              ...
              H(y, {
                ...
                default: E(() => [
                  (R(!0), de(Le, null, Ze(s.value, (C, O) => (R(), F(g, {
                    key: O,
                    value: O
                  }, {
                    default: E(() => [
              ...
              H(k, null, {
                default: E(() => [
                  H(v, {
                    ...
                    default: E(() => [
                      (R(!0), de(Le, null, Ze(s.value, (C, O) => (R(), F(b, {
                        key: O,
                        value: O
                      }, {
                        default: E(() => [
  ...
  setup(t) {
    const e = t, n = {
      ...
      const { src: w, alt: S, width: C, height: O } = e.node.attrs, _ = Zl(C) ? `${C}px` : C, I = Zl(O) ? `${O}px` : O;
      return {
        src: w || void 0,
        alt: S || void 0,
        style: {
    ...
    }), c = W(() => e.node.attrs.display || void 0), u = W(() => e.node.attrs.lockAspectRatio ?? !0), d = W(() => typeof T(c) == "string" ? ["image-view", `image-view--${T(c)}`] : ["image-view"]), f = W(() => {
      const {
        style: { width: w }
      } = T(a);
    ...
    function p() {
      const { editor: w, getPos: S } = e, C = S();
      C !== void 0 && w.commands.setNodeSelection(C);
    }
    const m = Pr(function() {
      const { editor: w } = e, { width: S } = getComputedStyle(w.view.dom);
      r.value.width = Number.parseInt(S, 10);
    }, Gd);
    function g(w, S) {
      w.preventDefault(), w.stopPropagation(), l.value.x = w.clientX, l.value.y = w.clientY;
      const C = T(i).width, O = T(i).height, _ = C / O;
      let I = Number(e.node.attrs.width), U = Number(e.node.attrs.height);
      const B = T(r).width;
      I && !U ? (I = I > B ? B : I, U = Math.round(I / _)) : U && !I ? (I = Math.round(U * _), I = I > B ? B : I) : !I && !U ? (I = C > B ? B : C, U = Math.round(I / _)) : I = I > B ? B : I, l.value.w = I, l.value.h = U, l.value.dir = S, s.value = !0, v();
    }
    const y = Pr(function(w) {
      if (w.preventDefault(), w.stopPropagation(), !T(s)) return;
      const { x: S, y: C, w: O, h: _, dir: I } = T(l), U = (w.clientX - S) * (/l/.test(I) ? -1 : 1), B = (w.clientY - C) * (/t/.test(I) ? -1 : 1), j = ZC(O + U, Kd, T(r).width), K = T(u) ? null : Math.max(_ + B, Kd);
      e.updateAttributes({
        width: j,
        height: K
      });
    ...
    function b(w) {
      w.preventDefault(), w.stopPropagation(), T(s) && (s.value = !1, l.value = {
        x: 0,
        y: 0,
        w: 0,
        h: 0,
    ...
    return $n((w) => {
      T(x).observe(e.editor.view.dom), w(() => {
        T(x).disconnect();
      });
    }), (w, S) => (R(), F(T(im), {
      as: "span",
      ...
      default: E(() => [
        De("div", {
          ...
          w.editor.view.editable ? Rf((R(), de("div", eO, [
...
var iO = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))$/, oO = /(?:^|\s)(\*(?!\s+\*)((?:[^*]+))\*(?!\s+\*))/g, sO = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))$/, lO = /(?:^|\s)(_(?!\s+_)((?:[^_]+))_(?!\s+_))/g, aO = it.create({
  name: "italic",
  addOptions() {
    return {
      HTMLAttributes: {}
...
}), cO = "ö", dO = "ελ1υ2бг1ел3дети4ею2католик6ом3мкд2он1сква6онлайн5рг3рус2ф2сайт3рб3укр3қаз3հայ3ישראל5קום3ابوظبي5رامكو5لاردن4بحرين5جزائر5سعودية6عليان5مغرب5مارات5یران5بارت2زار4يتك3ھارت5تونس4سودان3رية5شبكة4عراق2ب2مان4فلسطين6قطر3كاثوليك6وم3مصر2ليسيا5وريتانيا7قع4همراه5پاکستان7ڀارت4कॉम3नेट3भारत0म्3ोत5संगठन5বাংলা5ভারত2ৰত4ਭਾਰਤ4ભારત4ଭାରତ4இந்தியா6லங்கை6சிங்கப்பூர்11భారత్5ಭಾರತ4ഭാരതം5ලංකා4คอม3ไทย3ລາວ3გე2みんな3アマゾン4クラウド4グーグル4コム2ストア3セール3ファッション6ポイント4世界2中信1国1國1文网3亚马逊3企业2佛山2信息2健康2八卦2公司1益2台湾1灣2商城1店1标2嘉里0大酒店5在线2大拿2天主教3娱乐2家電2广东2微博2慈善2我爱你3手机2招聘2政务1府2新加坡2闻2时尚2書籍2机构2淡马锡3游戏2澳門2点看2移动2组织机构4网址1店1站1络2联通2谷歌2购物2通販2集团2電訊盈科4飞利浦3食品2餐厅2香格里拉3港2닷넷1컴2삼성2한국2", ua = "numeric", fa = "ascii", ha = "alpha", Ur = "asciinumeric", Hr = "alphanumeric", pa = "domain", jg = "emoji", uO = "scheme", fO = "slashscheme", ml = "whitespace";
function hO(t, e) {
  return t in e || (e[t] = []), e[t];
}
function Sn(t, e, n) {
  e[ua] && (e[Ur] = !0, e[Hr] = !0), e[fa] && (e[Ur] = !0, e[ha] = !0), e[Ur] && (e[Hr] = !0), e[ha] && (e[Hr] = !0), e[Hr] && (e[pa] = !0), e[jg] && (e[pa] = !0);
  for (const r in e) {
    const i = hO(r, n);
    ...
    if (l ? (s = new _e(), Object.assign(s.j, l.j), s.jr.push.apply(s.jr, l.jr), s.jd = l.jd, s.t = l.t) : s = new _e(), o) {
      if (r)
        if (s.t && typeof s.t == "string") {
          const a = Object.assign(pO(s.t, r), n);
          Sn(o, a, r);
        } else n && Sn(o, n, r);
      s.t = o;
    }
...
const q = (t, e, n, r, i) => t.ta(e, n, r, i), fe = (t, e, n, r, i) => t.tr(e, n, r, i), gf = (t, e, n, r, i) => t.ts(e, n, r, i), M = (t, e, n, r, i) => t.tt(e, n, r, i), Mt = "WORD", ma = "UWORD", Kg = "ASCIINUMERICAL", qg = "ALPHANUMERICAL", hi = "LOCALHOST", ga = "TLD", ya = "UTLD", oo = "SCHEME", Qn = "SLASH_SCHEME", Cc = "NUM", ba = "WS", Ac = "NL", Wr = "OPENBRACE", jr = "CLOSEBRACE", Mo = "OPENBRACKET", Eo = "CLOSEBRACKET", Lo = "OPENPAREN", Oo = "CLOSEPAREN", Ho = "OPENANGLEBRACKET", Ro = "CLOSEANGLEBRACKET", Vo = "FULLWIDTHLEFTPAREN", No = "FULLWIDTHRIGHTPAREN", Io = "LEFTCORNERBRACKET", _o = "RIGHTCORNERBRACKET", Do = "LEFTWHITECORNERBRACKET", Po = "RIGHTWHITECORNERBRACKET", zo = "FULLWIDTHLESSTHAN", $o = "FULLWIDTHGREATERTHAN", Bo = "AMPERSAND", Fo = "APOSTROPHE", Uo = "ASTERISK", Xt = "AT", Wo = "BACKSLASH", jo = "BACKTICK", Ko = "CARET", Cn = "COLON", Tc = "COMMA", qo = "DOLLAR", lt = "DOT", Go = "EQUALS", Mc = "EXCLAMATION", Ke = "HYPHEN", Kr = "PERCENT", Jo = "PIPE", Xo = "PLUS", Zo = "POUND", qr = "QUERY", Ec = "QUOTE", Gg = "FULLWIDTHMIDDLEDOT", Lc = "SEMI", at = "SLASH", Gr = "TILDE", Yo = "UNDERSCORE", Jg = "EMOJI", Qo = "SYM";
...
const St = /[a-z]/, Tr = new RegExp("\\p{L}", "u"), gl = new RegExp("\\p{Emoji}", "u"), Ct = /\d/, yl = /\s/, yf = "\r", bl = `
`, mO = "️", gO = "‍", vl = "￼";
let qi = null, Gi = null;
function yO(t = []) {
  const e = {};
  ...
  M(n, vl, u), M(c, bl, a), M(c, vl, u), fe(c, yl, u), M(u, yf), M(u, bl), fe(u, yl, u), M(u, vl, u);
  const d = fe(n, gl, Jg, {
    [jg]: !0
  });
  M(d, "#"), fe(d, gl, d), M(d, mO, d);
  const f = M(d, gO);
  M(f, "#"), fe(f, gl, d);
  ...
  for (let m = 0; m < t.length; m++) {
    ...
    g.indexOf("-") >= 0 ? b[pa] = !0 : St.test(g) ? Ct.test(g) ? b[Ur] = !0 : b[fa] = !0 : b[ua] = !0, gf(n, g, g, b);
  }
  return gf(n, "localhost", hi, {
    ascii: !0
  }), n.jd = new _e(Qo), {
    start: n,
...
function Zg(t, e) {
  const n = bO(e.replace(/[A-Z]/g, (l) => l.toLowerCase())), r = n.length, i = [];
  let o = 0, s = 0;
  for (; s < r; ) {
    let l = t, a = null, c = 0, u = null, d = -1, f = -1;
    for (; s < r && (a = l.go(n[s])); )
      l = a, l.accepts() ? (d = 0, f = 0, u = l) : d >= 0 && (d += n[s].length, f++), c += n[s].length, o += n[s].length, s++;
    o -= d, s -= f, c -= d, i.push({
      t: u.t,
      // token type/name
      v: e.slice(o - c, o),
...
Yg.prototype = {
  ...
  */
   ...
   */
  render(t) {
    const e = this, n = this.toHref(t.get("defaultProtocol")), r = t.get("formatHref", n, this), i = t.get("tagName", n, e), o = this.toFormattedString(t), s = {}, l = t.get("className", n, e), a = t.get("target", n, e), c = t.get("rel", n, e), u = t.getObj("attributes", n, e), d = t.getObj("events", n, e);
...
function kO({
  ...
  const u = M(o, lt);
  q(u, r, o), q(u, t.domain, o);
  const d = je();
  q(c, t.domain, d), q(d, t.domain, d);
  const f = M(d, lt);
  q(f, t.domain, d);
  const h = je(vO);
  q(f, t.tld, h), q(f, t.utld, h), M(c, hi, h);
  const p = M(d, Ke);
  M(p, Ke, p), q(p, t.domain, d), q(h, t.domain, d), M(h, lt, f), M(h, Ke, p);
  ...
  const b = M(y, Cn), v = je(Ji);
  q(b, t.numeric, v);
  const k = je(Ji), x = je();
  q(k, e, k), q(k, n, x), q(x, e, k), q(x, n, x), M(y, at, k), M(v, at, k);
  const w = M(l, Cn), S = M(a, Cn), C = M(S, at), O = M(C, at);
  q(l, t.domain, s), M(l, lt, g), M(l, Ke, m), q(a, t.domain, s), M(a, lt, g), M(a, Ke, m), q(w, t.domain, k), M(w, at, k), M(w, qr, k), q(O, t.domain, k), q(O, e, k), M(O, at, k);
  const _ = [
    [Wr, jr],
    // {}
    [Mo, Eo],
  ...
  for (let I = 0; I < _.length; I++) {
    const [U, B] = _[I], j = M(k, U);
    M(x, U, j);
    const K = je(Ji);
    q(j, e, K);
    const V = je();
    q(j, n, V), M(j, B, k), q(K, e, K), q(K, n, V), q(V, e, K), q(V, n, V), M(K, B, k), M(V, B, k);
  }
  return M(i, hi, y), M(i, Ac, wO), {
    start: i,
    tokens: Xg
  };
}
function xO(t, e, n) {
  ...
  for (; i < r; ) {
    ...
    if (f < 0)
      ...
      s.length > 0 && (o.push(wl(wf, e, s)), s = []), i -= f, u -= f;
      const h = d.t, p = n.slice(i - u, i);
      o.push(wl(h, e, p));
    }
  }
  return s.length > 0 && o.push(wl(wf, e, s)), o;
}
function wl(t, e, n) {
  const r = n[0].s, i = n[n.length - 1].e, o = e.slice(r, i);
  return new t(o, n);
}
const SO = typeof console < "u" && console && console.warn || (() => {
}), CO = "until manual call of linkify.init(). Register all schemes and plugins before invoking linkify the first time.", ae = {
  scanner: null,
  parser: null,
  tokenQueue: [],
  pluginQueue: [],
...
function kf(t, e = !1) {
  if (ae.initialized && SO(`linkifyjs: already initialized - will not register custom scheme "${t}" ${CO}`), !/^[0-9a-z]+(-[0-9a-z]+)*$/.test(t))
...
function TO() {
  ae.scanner = yO(ae.customSchemes);
  for (let t = 0; t < ae.tokenQueue.length; t++)
    ae.tokenQueue[t][1]({
      scanner: ae.scanner
    });
  ae.parser = kO(ae.scanner.tokens);
...
function Hc(t) {
  return ae.initialized || TO(), xO(ae.parser.start, t, Zg(ae.scanner.start, t));
}
Hc.scan = Zg;
...
var Rc = "[\0-   ᠎ -\u2029 　]", MO = new RegExp(Rc), EO = new RegExp(`${Rc}$`), LO = new RegExp(Rc, "g");
function OO(t) {
  ...
  return new re({
    ...
    appendTransaction: (e, n, r) => {
      ...
      if (ys(l).forEach(({ newRange: c }) => {
        ...
        if (d && f) {
          const h = f.split(MO).filter(Boolean);
          if (h.length <= 0)
            return !1;
    ...
    props: {
      handleClick: (e, n, r) => {
        ...
        if (t.enableClickSelection && (l = t.editor.commands.extendMarkRange(t.type.name)), t.openOnClick) {
          const a = Lp(e.state, t.type.name), c = (i = s.href) != null ? i : a.href, u = (o = s.target) != null ? o : a.target;
...
function t1(t, e, n) {
  var r, i;
  const [, o, s] = e;
  return (e.index ? t[e.index - 1] : void 0) === "!" || e1(t, (r = e.index) != null ? r : 0) || IO(t, (i = e.index) != null ? i : 0) ? !1 : !!o.trim() && n(s);
}
function n1(t) {
  var e, n;
...
function DO(t) {
  const e = dn({
    find: (n) => {
      const r = VO.exec(n);
      return !r || !t1(n, r, t.isAllowedHref) ? null : n1(r);
    },
    type: t.type,
    getAttributes: r1
  });
...
function PO(t) {
  const e = zt({
    find: (n) => {
      var r, i;
      const o = [];
      for (const l of n.matchAll(NO))
        t1(n, l, t.isAllowedHref) && o.push(n1(l));
  ...
  return new re({
    ...
    props: {
      handlePaste: (e, n, r) => {
        ...
        const c = Qg(a, { defaultProtocol: t.defaultProtocol }).find(
...
const BO = { class: "headline" }, FO = /* @__PURE__ */ te({
  __name: "LinkDialog",
  props: {
  ...
  setup(t) {
    const e = t, { t: n } = Ut(), r = () => ({
      ...
      target: "_blank",
      rel: ""
    }), i = Y(r()), o = Y(), { evalHrefRules: s } = i1(["hrefRules"], e), l = Y(!1), a = W(() => {
      const { href: d, target: f, rel: h } = i.value;
      return d ? e.value === d && e.target === f && e.rel === h : !0;
    });
    async function c() {
      const { valid: d } = await o.value.validate();
      if (!d) return;
      const { href: f, target: h, rel: p } = i.value;
      f && e.editor.chain().focus().extendMarkRange("link").setLink({ href: f, target: h, rel: p }).run(), u();
    }
    function u() {
    ...
    return _t(l, (d) => {
      ...
      const h = yi, p = un, m = yr, g = gr, y = Nf("vx-field"), b = rs, v = mi, k = Sa, x = ns, w = mr, S = xa;
      return R(), F(S, {
        modelValue: l.value,
          ...
          H(w, null, {
            default: E(() => [
              H(g, {
                ...
                default: E(() => [
                  De("span", BO, Ae(T(n)("editor.link.dialog.title")), 1),
                  H(h),
                  H(m, {
                    class: "mx-0",
                    icon: "",
              ...
              H(x, {
                ref_key: "form",
                ref: o,
                onSubmit: f[3] || (f[3] = If((C) => c(), ["prevent"]))
              }, {
                default: E(() => [
                  H(v, null, {
                    default: E(() => [
...
var WO = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))$/, jO = /(?:^|\s)(~~(?!\s+~~)((?:[^~]+))~~(?!\s+~~))/g, KO = it.create({
  name: "strike",
  addOptions() {
    return {
      HTMLAttributes: {}
...
const lR = /* @__PURE__ */ J.create({
  ...
  addExtensions() {
    const t = [];
    return this.options.subscript !== !1 && t.push(qO.configure(this.options.subscript)), this.options.superscript !== !1 && t.push(GO.configure(this.options.superscript)), t;
  }
});
function es(t) {
...
function s1(t) {
  ...
  return e ? e.split(",").map((n) => parseInt(n, 10)) : ZO(t);
}
var YO = /[ \t\r\n\f]+/g;
function l1(t) {
  var e;
  return t.children.length > 0 ? !1 : ((e = t.textContent) != null ? e : "").replace(YO, "") === "";
}
function a1(t) {
    ...
    return [
      {
        ...
        tag: "td",
        getAttrs: (t) => l1(t) ? {} : !1,
        getContent: (t, e) => a1(e.nodes[this.name])
      },
      { tag: "td" }
    ];
  },
    ...
    for (let f = 0, h = 0; f < u.childCount; f += 1) {
      ...
      for (let g = 0; g < p; g += 1, h += 1) {
        ...
        if (l += y || r, y || (a = !1), c) {
          ...
          const v = document.createElement("col"), [k, x] = va(r, y);
          v.style.setProperty(k, x), e.appendChild(v);
        }
      }
    }
  for (; c; ) {
...
var QO = class {
  constructor(t, e, n, r = {}) {
    ...
    t.attrs.style && (this.table.style.cssText = t.attrs.style), this.colgroup = this.table.appendChild(document.createElement("colgroup")), xf(t, this.colgroup, this.table, e), this.contentDOM = this.table.appendChild(document.createElement("tbody"));
  }
  update(t) {
    return t.type !== this.node.type ? !1 : (this.node = t, xf(t, this.colgroup, this.table, this.cellMinWidth), !0);
  }
  ignoreMutation(t) {
...
function sH(t) {
  return t.split(`
`).map((e) => !e.includes("|") || !e.includes("`") ? e : oH(e)).join(`
`);
}
function lH(t) {
...
function aH(t, e, n = {}) {
  var r;
  const i = (r = n.cellLineSeparator) != null ? r : iH;
  ...
  t.content.forEach((m) => {
    ...
    m.content && m.content.forEach((y) => {
      ...
      const v = lH(
        b.split(i).join(`
`).replace(/[ \t]*\r?\n[ \t]*/g, "<br>")
      ), k = y.type === "tableHeader", x = XO(y.attrs);
      g.push({ text: v, isHeader: k, align: x });
    }), o.push(g);
  });
  ...
  const a = (m, g) => m + " ".repeat(Math.max(0, g - m.length)), c = o[0], u = c.some((m) => m.isHeader), d = Array.from({
    length: s
  }).fill(null);
  o.forEach((m) => {
    var g;
    for (let y = 0; y < s; y += 1)
      !d[y] && ((g = m[y]) != null && g.align) && (d[y] = m[y].align);
  });
  let f = `
`;
...
var cH = aH, f1 = be.create({
  ...
  renderHTML({ node: t, HTMLAttributes: e }) {
    const { colgroup: n, tableWidth: r, tableMinWidth: i } = eH(t, this.options.cellMinWidth), o = e.style;
    function s() {
  ...
  parseMarkdown: (t, e) => {
    ...
    return t.rows && t.rows.forEach((i) => {
      ...
      i.forEach((s, l) => {
        var a;
        const c = es((a = r[l]) != null ? a : s.align), u = c ? { align: c } : {};
        o.push(
...
`);
  ...
  addCommands() {
    return {
      ...
      addColumnAfter: () => ({ state: t, dispatch: e }) => ST(t, e),
      ...
      addRowBefore: () => ({ state: t, dispatch: e }) => MT(t, e),
      ...
      mergeCells: () => ({ state: t, dispatch: e }) => _u(t, e),
      splitCell: () => ({ state: t, dispatch: e }) => Du(t, e),
      toggleHeaderColumn: () => ({ state: t, dispatch: e }) => fi("column")(t, e),
      toggleHeaderRow: () => ({ state: t, dispatch: e }) => fi("row")(t, e),
      toggleHeaderCell: () => ({ state: t, dispatch: e }) => IT(t, e),
      mergeOrSplit: () => ({ state: t, dispatch: e }) => _u(t, e) ? !0 : Du(t, e),
      setCellAttribute: (t, e) => ({ state: n, dispatch: r }) => VT(t, e)(n, r),
      goToNextCell: () => ({ state: t, dispatch: e }) => zu(1)(t, e),
      goToPreviousCell: () => ({ state: t, dispatch: e }) => zu(-1)(t, e),
      fixTables: () => ({ state: t, dispatch: e }) => (e && sg(t), !0),
...
J.create({
  ...
  addExtensions() {
    const t = [];
    return this.options.table !== !1 && t.push(f1.configure(this.options.table)), this.options.tableCell !== !1 && t.push(c1.configure(this.options.tableCell)), this.options.tableHeader !== !1 && t.push(d1.configure(this.options.tableHeader)), this.options.tableRow !== !1 && t.push(u1.configure(this.options.tableRow)), t;
  }
});
const dH = /(android|bb\d+|meego).+mobile|armv7l|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|midp|mmp|mobile.+firefox|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series[46]0|samsungbrowser.*mobile|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i, uH = /CrOS/, fH = /android|ipad|playbook|silk/i;
function Af(t = {}) {
  let e = t.ua || typeof navigator < "u" && navigator.userAgent;
  return e && typeof e == "object" && e.headers && typeof e.headers["user-agent"] == "string" && (e = e.headers["user-agent"]), typeof e != "string" ? !1 : !!(dH.test(e) && !uH.test(e) || t.tablet && fH.test(e) || t.tablet && t.featureDetect && navigator && navigator.maxTouchPoints > 1 && e.includes("Macintosh") && e.includes("Safari"));
}
const hH = ["onMouseover", "onMousedown"], pH = /* @__PURE__ */ te({
  ...
  setup(t, { emit: e }) {
    ...
    function a(d, f) {
      d === s.rows && (s.rows = Math.min(d + 1, Ii)), f === s.cols && (s.cols = Math.min(f + 1, Ii)), l.rows = d, l.cols = f;
    }
    function c(d, f) {
      n("create-table", { rows: d, cols: f, withHeaderRow: T(o) }), u();
    }
    function u() {
      i.value = !1, o.value = !0, s.rows = Ni, s.cols = Ni, l.rows = _i, l.cols = _i;
    }
    return (d, f) => {
      const h = rs, p = mi, m = S1, g = mr, y = ts;
      return R(), F(y, {
        modelValue: i.value,
              ...
              H(p, { class: "d-flex flex-column flex-wrap justify-space-between pa-2" }, {
                default: E(() => [
                  (R(!0), de(Le, null, Ze(s.rows, (b) => (R(), de("div", {
                    ...
                    (R(!0), de(Le, null, Ze(s.cols, (v) => (R(), de("div", {
                      key: "c" + v,
                      class: dt([{
                        "table-grid-size-editor__cell--selected": v <= l.cols && b <= l.rows
                      }, "pa-1"]),
                      onMouseover: (k) => a(b, v),
                      onMousedown: (k) => c(b, v)
                    }, [...f[2] || (f[2] = [
  ...
  setup(t) {
    ...
    return (l, a) => {
      const c = un, u = Lf, d = Ef, f = gi, h = wa, p = ts;
      return R(), F(p, {
        modelValue: r.value,
              ...
              (R(!0), de(Le, null, Ze(i.value, (m, g) => (R(), de(Le, null, [
                m.key === "insert-table" ? (R(), F(d, {
                  ...
                  default: E(() => [
                    ...
                    m.key === "insert-table" ? (R(), F(pH, {
                      key: g,
                      onCreateTable: s
                    })) : $e("", !0)
                  ]),
                  _: 2
                }, 1032, ["disabled"])) : m.type === "item" ? (R(), F(d, {
                  key: "item-" + g,
                  disabled: m.disabled,
                  onClick: (y) => o(m.key)
                }, {
  ...
  addExtensions() {
    return [
      u1.configure(this.options.tableRow),
      d1.configure(this.options.tableHeader),
      c1.configure(this.options.tableCell)
    ];
  }
}), cR = /* @__PURE__ */ Pg.extend({
  addAttributes() {
    return Me(
      this.parent?.(),
      "taskList",
  ...
  addExtensions() {
    return [Dg.configure(this.options.taskItem)];
  }
});
var yH = J.create({
  name: "textAlign",
...
const uR = /* @__PURE__ */ bH.extend({
...
}), vH = { class: "headline" }, wH = /* @__PURE__ */ te({
  __name: "VideoDialog",
  props: {
    value: { default: void 0 },
    editor: {},
  ...
  setup(t) {
    const e = t, { t: n } = Ut(), r = Y(""), i = Y(!1), o = Y(), { evalHrefRules: s } = i1(["hrefRules"], e), l = W(() => e.value === r.value || !T(r));
    async function a() {
      const { valid: u } = await o.value.validate();
      u && (T(r) && e.editor.chain().focus().setVideo({ src: r.value }).run(), c());
    }
    function c() {
    ...
    return $n(() => {
      ...
      const f = yi, h = un, p = yr, m = gr, g = Nf("vx-field"), y = mi, b = Sa, v = ns, k = mr, x = xa;
      return R(), F(x, {
        modelValue: i.value,
          ...
          H(k, null, {
            default: E(() => [
              H(m, {
                ...
                default: E(() => [
                  De("span", vH, Ae(T(n)("editor.video.dialog.title")), 1),
                  H(f),
                  H(p, {
                    class: "mx-0",
                    icon: "",
  ...
  for (const [r, i] of e)
    n[r] = i;
  return n;
}, kH = {}, xH = { style: { display: "flex", "align-items": "center", "justify-content": "center", background: "rgb(221 221 221)" } };
function SH(t, e) {
  return R(), de("div", xH, [...e[0] || (e[0] = [
    De("svg", {
      t: "1738756119280",
      class: "icon",
...
const CH = /* @__PURE__ */ h1(kH, [["render", SH]]), AH = { class: "iframe-container" }, TH = ["src", "width", "height", "frameborder", "allowfullscreen"], MH = /* @__PURE__ */ te({
    ...
    return (o, s) => (R(), F(T(im), {
      ...
      default: E(() => [
        De("div", {
          ...
          De("div", AH, [
            n.value || !e.HTMLAttributes.src ? (R(), F(CH, {
              key: 0,
...
}), EH = /* @__PURE__ */ h1(MH, [["__scopeId", "data-v-fd153073"]]), LH = /* @__PURE__ */ te({
...
const fR = /* @__PURE__ */ be.create({
  ...
  r && Ql.setLang(r), Object.keys(o).forEach((l) => n.component(l, o[l])), ck({
    defaultLang: r,
...
export {
  ...
  _H as VuetifyTiptap,
  DH as VuetifyViewer,
  hR as createVuetifyProTipTap,
  hA as de,
  uL as defaultBubbleList,
  pA as en,
  mA as it,
  Ql as locale,
  gA as nl,
